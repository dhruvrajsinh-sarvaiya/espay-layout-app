...
{
    public class NewTransactionV1BK : ITransactionProcessV1
    {
        ...
        public async Task<BizResponse> CombineAllInitTransactionAsync()
        {
            ...
            try
            {
                ...
                //enWalletTrnType.Dr_Trade //Rita 16-1-19 changes enums as wallet team change enums
