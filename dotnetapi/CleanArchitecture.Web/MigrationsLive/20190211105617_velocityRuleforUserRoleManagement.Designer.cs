...
namespace CleanArchitecture.Web.Migrations
{
    ...
    [Migration("20190211105617_velocityRuleforUserRoleManagement")]
    partial class velocityRuleforUserRoleManagement
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CleanArchitecture.Core.Entities.Backoffice.RoleManagement.FeildMaster", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("CleanArchitecture.Core.Entities.Backoffice.RoleManagement.UserAssignFeildRights<long>", b =>
                {
                    b.Property<long>("FeildID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<string>("FeildName");

                    b.Property<long?>("UserAssignSubModule<long>SubModuleID");

                    b.HasKey("FeildID");

                    b.HasIndex("UserAssignSubModule<long>SubModuleID");

                    b.ToTable("UserAssignFeildRights<long>");
                });

            modelBuilder.Entity("CleanArchitecture.Core.Entities.Backoffice.RoleManagement.UserAssignModule<long>", b =>
                {
                    b.Property<long>("ModuleID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("UserAssignModule<long>");
                });

            modelBuilder.Entity("CleanArchitecture.Core.Entities.Backoffice.RoleManagement.UserAssignSubModule<long>", b =>
                {
                    b.Property<long>("SubModuleID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<long?>("UserAssignModule<long>ModuleID");

                    b.Property<short>("View");

                    b.HasKey("SubModuleID");

                    b.HasIndex("UserAssignModule<long>ModuleID");

                    b.ToTable("UserAssignSubModule<long>");
                });

            modelBuilder.Entity("CleanArchitecture.Core.Entities.Backoffice.RoleManagement.UserAssignToolRights<long>", b =>
                {
                    ...
                    b.ToTable("UserAssignToolRights<long>");
                });
            ...
            modelBuilder.Entity("CleanArchitecture.Core.Entities.NewWallet.MarginWalletTopupRequest", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("MarginWalletTopupRequest");
                });
            ...
            modelBuilder.Entity("CleanArchitecture.Core.Entities.Backoffice.RoleManagement.UserAssignFeildRights<long>", b =>
                {
                    b.HasOne("CleanArchitecture.Core.Entities.Backoffice.RoleManagement.UserAssignSubModule<long>")
                        .WithMany("Feilds")
                        .HasForeignKey("UserAssignSubModule<long>SubModuleID");
                });
            ...
            modelBuilder.Entity("CleanArchitecture.Core.Entities.Backoffice.RoleManagement.UserAssignSubModule<long>", b =>
                {
                    b.HasOne("CleanArchitecture.Core.Entities.Backoffice.RoleManagement.UserAssignModule<long>")
                        .WithMany("SubModules")
                        .HasForeignKey("UserAssignModule<long>ModuleID");
                });
