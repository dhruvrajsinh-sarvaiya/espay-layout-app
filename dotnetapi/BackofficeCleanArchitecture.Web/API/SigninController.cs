...
namespace BackofficeCleanArchitecture.Web.API
{
    ...
    public class SigninController : BaseController
    {
        ...
        [AllowAnonymous]
        [ApiExplorerSettings(IgnoreApi = true)]
        public async Task<IActionResult> Login(CleanArchitecture.Core.ViewModels.AccountViewModels.LoginViewModel model)
        {
        ...
        //                //bool checkvaliddevice = _IdeviceIdService.CheckValidDeviceV1(user.Id, model.DeviceId,HttpContext.Connection.RemoteIpAddress.ToString());
        //                bool checkvaliddevice = _IdeviceIdService.CheckValidDevice(user.Id, model.DeviceId);
        ...
        //                    AuthorizeDeviceModel.Expirytime = DateTime.UtcNow + TimeSpan.FromMinutes(Convert.ToInt32(_configuration["DefaultValidateAuthorizedDevice"]));
