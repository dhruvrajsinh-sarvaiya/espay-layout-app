...
namespace CleanArchitecture.Infrastructure.Services.Transaction
{
    public class CancelOrderProcessV1 : ICancelOrderProcessV1
    {
        ...
        public CancelOrderProcessV1(ICommonRepository<TradeBuyRequest> TradeBuyRequest, EFCommonRepository<TradeTransactionQueue> TradeTransactionRepository,
            ...
            IOKExLPService oKExLPService, IHuobiLPService huobiLPService)
        {
            ...
            _oKExLPService = oKExLPService; //Add new variable assign for OKEX API by Pushpraj as on 17-06-2019
        }     
        ...
        public async Task<BizResponse> CancellationProcessAPIV1(BizResponse _Resp, TransactionQueue TransactionQueueObj, TradeTransactionQueue TradeTransactionQueueObj, string accessToken)
        {
            short ISPartialSettled = 0;
            CancelOrderPrice = 0; CancelOrderQty = 0;
            TradeBuyerListV1 BuyerListObj = new TradeBuyerListV1();
        ...
        public async Task<LPCancelOrdedrResponse> LiquidityTradeCancelProcess(long TrnNo, TradeTransactionQueue tradeTransactionObj)
        {
            ...
            try
            {
                ...
                var LPProvidetail = _ServiceProviderDetail.GetSingle(e => e.Id == TrnData.SerProID);
                ...
                switch (LPProvidetail.AppTypeID)
                {
                    case (long)enAppType.Binance:
                        ...
                        foreach (var symbol in BinanceExchangeInfoResult.Symbols)
                        {
                            ...
                            if (symbol.Name == pair)
                            {
                                ...
                                {
                                    _Res.TrnNo = TrnNo;
                                    _Res.ReturnMsg = BinanceResult.Error.Message;
                    ...
                    case (long)enAppType.Bittrex:
                        ...
                        //});
                        _binanceLPService._client.SetApiCredentials(ServiceProConfiguration.APIKey, ServiceProConfiguration.SecretKey);
                        WebCallResult<object> BittrexResult = _bitrexLPService.CancelOrderAsync(new Guid(LPOredrID)).Result;
                        //BittrexCancelOrderResponse BittrexResult = await _bitrexLPService.CancelOrderAsync(new Guid(LPOredrID));
                        APIResponse = JsonConvert.SerializeObject(BittrexResult);
                        if (BittrexResult.Success)
                        {
                            _Res.TrnNo = TrnNo;
                            _Res.TrnRefNo = ((CancelOrderResult)BittrexResult.Data).uuid;
                            //_Res.TrnRefNo = JsonConvert.DeserializeObject<BittrexCancelOrderResponse>(JsonConvert.SerializeObject(BittrexResult).ToString()).result.uuid.ToString();
                            _Res.ReturnCode = enResponseCodeService.Success;
                            goto SuccessTrade;
                        }
                        else
                        {
                            _Res.TrnNo = TrnNo;
                            _Res.ReturnMsg = BittrexResult.Error.Message;
                            //_Res.ReturnMsg = BittrexResult.message;
                            _Res.ReturnCode = enResponseCodeService.Fail;
                            _Res.ErrorCode = enErrorCode.API_Respose_Fail;
                            return _Res;
                        }
                    ...
                    case (long)enAppType.Coinbase:
                        ...
                        {
                            _Res.ReturnMsg = CoinbaseResult.ErrorMsg;
                            _Res.ErrorCode = enErrorCode.API_Respose_Fail;
                            _Res.ReturnCode = enResponseCodeService.Fail;
                            _Res.TrnNo = TrnNo;
                            return _Res;
                    ...
                    case (long)enAppType.TradeSatoshi:
                        ...
                        {
                            _Res.ReturnMsg = TradeSatoshiResult.message;
                            _Res.ErrorCode = enErrorCode.API_Respose_Fail;
                            _Res.ReturnCode = enResponseCodeService.Fail;
                            _Res.TrnNo = TrnNo;
                            return _Res;
                    ...
                    case (long)enAppType.UpBit:
                        ...
                        break;
                    //Add new case for OKEX API by Pushpraj as on 17-06-2019
