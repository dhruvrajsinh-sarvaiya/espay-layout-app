...
namespace CleanArchitecture.Infrastructure.Data.Transaction
{
    public class SettlementRepositoryAPI: ISettlementRepositoryAPI<BizResponse>
    {
        ...
        public SettlementRepositoryAPI(CleanArchitectureContext dbContext, IWalletService WalletService, ISignalRService ISignalRService,
            ...
            try
            {
                ...
                if (SettlementQty1 < CurrentTradeBuyerListObj.RemainQty)//Partial Settlement
                {
                   ...
                   // WalletDrCrResponse CreditWalletResult = new WalletDrCrResponse();
                    ...
                    if (SettlementQty1==1)//await WalletResult == false
                    {   
