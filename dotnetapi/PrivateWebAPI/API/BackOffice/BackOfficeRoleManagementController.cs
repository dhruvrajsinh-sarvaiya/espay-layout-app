    ...
    public class BackofficeRoleManagementController : BaseController
    {
        ...
        public async Task<IActionResult> CreateUserRole([FromBody]CreateRoleReq Req)
        {
            ...
            try
            {
                ...
                {
                    Response = await _roleManagementServices.CreateRole(Req, user.Id);
                }
                return Ok(Response);
            }
            catch (Exception ex)
        ...
        public async Task<IActionResult> UpdateUserRole([FromBody]CreateRoleReq Req)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    Response = await _roleManagementServices.UpdateRoleDetail(Req, Convert.ToInt64(Req.RoleId), user.Id);
                }
                return Ok(Response);
            }
            catch (Exception ex)
        ...
        public async Task<IActionResult> ChangeRoleStatus([FromBody]ChangeRoleStatusReq Request)
        {
            ...
            try
            {
                ...
                {
                    Response = await _roleManagementServices.ChangeUserRoleStatus(Request.RoleId, Request.Status, user.Id);
                }
                return Ok(Response);
            }
            catch (Exception ex)
        ...
        public async Task<IActionResult> AssignRole(long RoleId, long UserId)
        {
            ...
            try
            {
                ...
                {
                    Response = await _roleManagementServices.AssignRoleDetail(RoleId, UserId, user.Id);
                }
                return Ok(Response);
            }
            catch (Exception ex)
        ...
        public async Task<IActionResult> RemoveAndAssignRole(long RoleId, long UserId)
        {
            ...
            try
            {
                ...
                {
                    Response = await _roleManagementServices.AssignRoleDetail(RoleId, UserId, user.Id, true);
                }
                return Ok(Response);
            }
            catch (Exception ex)
        ...
        public async Task<IActionResult> CreatePermissionGroup([FromBody]CreatePermissionGrpReq Req)
        {
            ...
            try
            {
                ...
                {
                    Response = await _roleManagementServices.CreatePermissionGroup(Req, user.Id);
                }
                return Ok(Response);
            }
            catch (Exception ex)
        ...
        public async Task<IActionResult> UpdatePermissionGroup([FromBody]CreatePermissionGrpReq req)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    Response = await _roleManagementServices.UpdatePermissionGroup(Convert.ToInt64(req.PermissionGroupID), req, user.Id);
                }
                return Ok(Response);
            }
            catch (Exception ex)
        ...
        public async Task<IActionResult> ChangePermissionGroupStatus([FromBody]ChangePermissionGroupStatusReq req)
        {
            ...
            try
            {
                ...
                {
                    Response = await _roleManagementServices.ChangePermissionGroupStatus(req.PermissionGroupID, req.Status, user.Id);
                }
                return Ok(Response);
            }
            catch (Exception ex)
        ...
        public async Task<IActionResult> CreateUser([FromBody]CreateUserReq Req)
        {
            ...
            try
            {
                ...
                {
                    Response = await _roleManagementServices.CreateNewUser(Req, user.Id);
                }
                return Ok(Response);
            }
            catch (Exception ex)
        ...
        public async Task<IActionResult> EditUser([FromBody]EditUserReq Req)
        {
            ...
            try
            {
                ...
                {
                    Response = await _roleManagementServices.EditUserDetail(Req, user.Id);
                }
                return Ok(Response);
            }
            catch (Exception ex)
        ...
        public async Task<IActionResult> ReInviteUser(ReInviteUserViewModel Request)
        {
            ...
            {
                if (CurrentUser == null)
                    return BadRequest(new RegisterResponse { ReturnCode = enResponseCode.Fail, ReturnMsg = EnResponseMessage.StandardLoginfailed, ErrorCode = enErrorCode.StandardLoginfailed });
                else
                {
