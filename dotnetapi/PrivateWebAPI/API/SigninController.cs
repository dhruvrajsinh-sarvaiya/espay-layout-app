    ...
    public class SigninController : BaseController
    {
                    ...
                    if (user != null)
                    {
                        ...
                        //if (status)
                        {
                            ...
                            if (checkvaliddevice)
                            {
                                ...
                                return Ok(new VerifySuccResponse { ReturnCode = enResponseCode.Success, ReturnMsg = EnResponseMessage.StandardLoginSuccess, Thememode = user.Thememode });
                            }
                            else
                            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (user.IsEnabled) // added by nirav savariya check user is enable on 28-1-2019 
                    {
                        ...
                        if (checkvaliddevice)
                        {
                            ...
                            // added by nirav savariya for Thememode for user base showing mode for Thememode=0(false) means Day mode and Thememode=1(true) on 1-10-2019 03-20 PM
                            return Ok(new StandardSuccessLoginResponse { ReturnCode = enResponseCode.Success, ReturnMsg = EnResponseMessage.StandardLoginSuccess, Thememode = user.Thememode });
                        }
                        else
                        {
                            string[] DeviceDetails = null;
        ...
        public async Task<IActionResult> StandardLoginV1(StandardLoginViewModel model)
        {
            try
            {
                ...
                if (!user.IsEnabled && !user.EmailConfirmed) // for verify pending
                    return Ok(new RegisterResponse { ReturnCode = enResponseCode.Fail, ReturnMsg = EnResponseMessage.SignUpTempUserNameVerifyPending, ErrorCode = enErrorCode.Status4036VerifyPending });
        ...
        public async Task<IActionResult> LoginWithEmail(LoginWithEmailViewModel model)
        {
            try
            {
                ...
                {
                    if (!user.IsEnabled && !user.EmailConfirmed) // added by nirav savariya for check user exits and verify pending on 29-1-2019
                                ...
                                if (model.OTP == tempotp.OTP)
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        if (checkvaliddevice)
                                        {
                                            ...
                                            // added by nirav savariya for Thememode for user base showing mode for Thememode=0(false) means Day mode and Thememode=1(true) on 1-10-2019 03-20 PM
                                            return Ok(new OTPEmailVerificationResponse { ReturnCode = enResponseCode.Success, ReturnMsg = EnResponseMessage.StandardLoginSuccess, Thememode = checkmail.Thememode });
                                        }
                                        else
                                        {
                                            string[] DeviceDetails = null;
                            ...
                            if (tempotp?.ExpirTime >= DateTime.UtcNow)
                            {
                                if (model.OTP == tempotp.OTP)
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        HttpContext.Items["UserId"] = result.Id;
                                        // added by nirav savariya for Thememode for user base showing mode for Thememode=0(false) means Day mode and Thememode=1(true) on 1-10-2019 03-20 PM
                                        return Ok(new OTPMobileVerificationResponse { ReturnCode = enResponseCode.Success, ReturnMsg = EnResponseMessage.StandardLoginSuccess, Thememode = result.Thememode });
                                    }
                                }
