...
class ApiConfiguration extends Component {
  ...
  render() {
    const columns = [
      ...
      {
        name: <IntlMessages id="apiconfiguration.list.form.label.apiprovider" />,
        options: { sort: true, filter: true }
      },
      {
      ...
      {
        name: <IntlMessages id="apiconfiguration.list.form.label.minamtwithdraw" />,
        options: { sort: true, filter: true }
      },
      {
    ...
    return (
      <div className="mb-10">
        ...
        <PageTitleBar
          title={<IntlMessages id="sidebar.apiconfiguration.title" />}
