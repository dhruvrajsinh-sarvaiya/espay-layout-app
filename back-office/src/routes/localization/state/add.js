...
class AddState extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (nextProps.data !== undefined && nextProps.data.responseCode === 1) {
    ...
    if (nextProps.countryData !== undefined && nextProps.countryData.responseCode == 0) {
      this.setState({
        countryAll: nextProps.countryData.data
      });
    }

    if (nextProps.localebit !== undefined && nextProps.localebit != '' && nextProps.localebit == 1 && (nextProps.data.responseCode != 9 && nextProps.data.responseCode != 1)) {
...
const mapStateToProps = ({ state, country, languages }) => {
  ...
  if (state.localebit !== undefined && state.localebit != '') {
