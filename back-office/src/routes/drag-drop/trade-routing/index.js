...
export default class TradeRouting extends Component {
    state = {
        items: getItems(10),
    ...
    onDragEnd = result => {
        ...
        if (source.droppableId === destination.droppableId) {
            ...
            this.setState({
                items: results.droppable,
                selected: results.droppable2
            });
        }
    };
    ...
    render() {
        return (
			...
			<PageTitleBar title={<IntlMessages id="sidebar.tradeRouting" />} match={this.props.match} />
			<DragDropContext onDragEnd={this.onDragEnd}>
			<div className="row">
			   <div className="col-sm-12 col-xs-12 col-md-6 col-lg-6">
					<JbsCollapsibleCard heading="Routing One">
			   ...
			   <div className="col-sm-12 col-xs-12 col-md-6 col-lg-6">
					<JbsCollapsibleCard heading="Routing Two">
