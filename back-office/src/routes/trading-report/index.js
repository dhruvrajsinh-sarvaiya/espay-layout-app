...
const TradingReport = ({ match }) => (
  <div className="dashboard-wrapper">
    <Switch>
      <Redirect exact from={`${match.url}/trading-report`} to={`${match.url}`} />
      ...
      <Route path={`${match.url}/Liquidity-API-Manager`} component={LiquidityAPIManager} />
      <Route path={`${match.url}/Exchange-Feed-Configuration`} component={ExchangeFeedConfiguration} />
      <Route path={`${match.url}/daemon-configure`} component={DaemonConfigure} />
      <Route path={`${match.url}/tradeRecon`} component={TradeRecon} />
      <Route path={`${match.url}/bugReport`} component={BugReport} />
      <Route path={`${match.url}/apiConfigurationWithdraw`} component={ApiConfiguration} />
      <Route path={`${match.url}/manageMarkets`} component={ManageMarkets} />
      <Route path={`${match.url}/liquidity-provider`} component={AsyncLiquidityProviderComponent} />
