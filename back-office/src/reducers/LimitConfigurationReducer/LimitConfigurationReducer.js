...
export default (state, action) => {
    ...
    switch (action.type) {
        ...
        case GET_LIMIT_CONFIGURATION:
            return {
                ...state, loading: true, ListData: [], DeleteData: {}, Data: {}
            };
        case GET_LIMIT_CONFIGURATION_SUCCESS:
            return {
                ...state, loading: false, ListData: action.payload.Details,
            };
        case GET_LIMIT_CONFIGURATION_FAILURE:
            return {
                ...state, loading: false, ListData: action.payload,
            };
        //Add Limit Configuration
        case ADD_LIMIT_CONFIGURATION:
            return {
                ...state, loading: true, DeleteData: {}, Data: {}
            };
