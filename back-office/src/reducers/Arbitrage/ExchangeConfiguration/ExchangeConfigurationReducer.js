...
export default (state, action) => {
  ...
  switch (action.type) {
    ...
    case UPDATE_ARBITRAGE_EXCHANGE_CONFIGURATION_SUCCESS:
      return {...state,updateExchangeConfigurationApiList: action.payload,updateLoading: false,updateError: []};
    ...
    case GET_ARBITRAGE_EXCHANGE_PROVIDER_SUCCESS:
      return {...state,arbitrageExchangeProviderList: action.payload,loading: false };
    ...
    case ADD_ARBITRAGE_EXCHANGE_PROVIDER_SUCCESS:
      return {...state,addArbitrageExchangeProviderList: action.payload,loading: false };
    ...
    case UPDATE_ARBITRAGE_EXCHANGE_PROVIDER_SUCCESS:
      return {...state,updateArbitrageExchangeProviderList: action.payload,loading: false };
    ...
    case DELETE_ARBITRAGE_EXCHANGE_PROVIDER_SUCCESS:
      return {...state,deleteArbitrageExchangeProviderList: action.payload,loading: false };
