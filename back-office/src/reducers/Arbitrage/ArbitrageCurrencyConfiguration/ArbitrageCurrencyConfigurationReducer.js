 ...
 *   Date : 06-06-2019
 *   Component: Arbitrage Currency Configuration reducer
 */
import {
...
export default (state, action) => {
    ...
    switch (action.type) {
        ...
        //arbitrage Currency 
        //Update action
        case GET_ARBITRAGE_CURRENCY:
            return { ...state, ArbitrageCurrencyloading: true, ArbitrageCurrencyList: "", };

        case GET_ARBITRAGE_CURRENCY_SUCCESS:
            return {
                ...state,
                ArbitrageCurrencyloading: false,
                ArbitrageCurrencyList: action.payload.ArbitrageWalletTypeMasters,
            };

        case GET_ARBITRAGE_CURRENCY_FAILURE:
            return {
                ...state,
                ArbitrageCurrencyloading: false,
