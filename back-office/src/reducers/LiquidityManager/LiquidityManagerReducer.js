...
export default (state, action) => {
  ...
  switch (action.type) {
    ...
    case GET_LIQUIDITY_PROVIDER_SUCCESS:
      return {...state,liquidityProviderList: action.payload,loading: false};
    ...
    case ADD_LIQUIDITY_PROVIDER_SUCCESS:
      return {...state,addliquidityProviderList: action.payload,loading: false};
    ...
    case UPDATE_LIQUIDITY_PROVIDER_SUCCESS:
      return {...state,updateliquidityProviderList: action.payload,loading: false};
    ...
    case DELETE_LIQUIDITY_PROVIDER_SUCCESS:
      return {...state,deleteliquidityProviderList: action.payload,loading: false };
