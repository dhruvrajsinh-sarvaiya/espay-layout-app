...
export default (state, action) => {
    ...
    switch (action.type) {
        ...
        case GET_LIST_BLOCK_UNBLOCK_USER_ADDRESS_SUCCESS:
            return {...state,loading: false,BlockUnblockList: action.payload.Data};
        case GET_LIST_BLOCK_UNBLOCK_USER_ADDRESS_FAILURE:
            return {...state,loading: false,BlockUnblockList: []};
        //Block/Unblock...
        case GET_BLOCK_UNBLOCK_USER_ADDRESS_SUCCESS:
        case GET_BLOCK_UNBLOCK_USER_ADDRESS_FAILURE:
            return {...state,loading: false,BlockUnblock: action.payload };
        //destroy black fund
        case DESTROY_BLACKFUND_SUCCESS:
        case DESTROY_BLACKFUND_FAILURE:
            return {...state,loading: false,BlackFund: action.payload };
        default:
            return { ...state };
    }
};
