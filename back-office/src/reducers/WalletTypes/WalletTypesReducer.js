...
export default (state, action) => {
    ...
    switch (action.type) {
        case GET_WALLET_TYPE_MASTER:
            return { ...state, deleteStatus: {}, addWalletTypeMasterData: {}, updateWalletTypeMaster: {}, getWalletTypeById: {}, Loading: true };

        case GET_WALLET_TYPE_MASTERL_SUCCESS:
            return { ...state, Loading: false, walletTypesData: action.payload, addWalletTypeMasterData: {}, deleteStatus: {} };

        case GET_WALLET_TYPE_MASTER_FAILURE:
            return { ...state, Loading: false, deleteStatus: {}, addWalletTypeMasterData: {}, updateWalletTypeMaster: {} };

        case GET_WALLET_TYPE_MASTER_BY_ID:
        case DELETE_WALLET_TYPE_MASTER:
        case ADD_WALLET_TYPE_MASTER:
            return { ...state, Loading: true, addWalletTypeMasterData: {}, updateWalletTypeMaster: {}, getWalletTypeById: {} };

        case GET_WALLET_TYPE_MASTER_BY_ID_SUCCESS:
            return { ...state, Loading: false, getWalletTypeById: action.payload };

        case GET_WALLET_TYPE_MASTER_BY_ID_FAILURE:
            return { ...state, Loading: false, getWalletTypeById: {} };
        ...
        case UPDATE_WALLET_TYPE_MASTER:
            return { ...state, Loading: true, getWalletTypeById: {}, addWalletTypeMasterData: {}, updateWalletTypeMaster: {} };
