...
module.exports = function validateFaqCategoryInput(data) {
  ...
  Object.keys(data.locale).forEach((lg, index) => {
    ...
    if (!(data.locale[lg].category_name) || (data.locale[lg].category_name) === undefined || (data.locale[lg].category_name) === "" || data.locale[lg].category_name.length == 0 || validator.isEmpty(data.locale[lg].category_name + '')) {
