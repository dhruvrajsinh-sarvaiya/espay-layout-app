...
module.exports = function validateHelpModuleInput(data) {
  ...
  Object.keys(data.locale).forEach((lg, index) => {
    ...
    if (!(data.locale[lg].module_name) || (data.locale[lg].module_name) === undefined || (data.locale[lg].module_name) == "" || data.locale[lg].module_name.length == 0 || validator.isEmpty(data.locale[lg].module_name + '')) {
    ...
    if (!(data.locale[lg].description) || (data.locale[lg].description) === undefined || (data.locale[lg].description) == "" || data.locale[lg].description.length == 0 || validator.isEmpty(data.locale[lg].description + '')) {
