...
module.exports = function validateRuleField(data) {
    ...
    if ((data.hasOwnProperty('SubModuleID') && validator.isEmpty(data.SubModuleID + '', { ignore_whitespace: true })) || (data.hasOwnProperty('SubModuleID') && data.SubModuleID + '' <= 0)) {
    ...
    if ((data.hasOwnProperty('Visibility') && validator.isEmpty(data.Visibility + '', { ignore_whitespace: true })) || (data.hasOwnProperty('Visibility') && data.Visibility + '' <= 0)) {
