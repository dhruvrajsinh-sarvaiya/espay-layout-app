...
module.exports = function validatePasswordPolicy(data) {
    ...
    //PwdExpiretime...
    if (data.hasOwnProperty('PwdExpiretime') && data.PwdExpiretime + "" !== '' && validator.isEmpty(data.PwdExpiretime + "", { ignore_whitespace: true })) {
        errors.PwdExpiretime = "my_account.err.fieldRequired"
    } else if (data.hasOwnProperty('PwdExpiretime') && data.PwdExpiretime + "" !== '' && !validator.isEmpty(data.PwdExpiretime + "")) {
    ...
    //MaxfppwdDay...
    if (data.hasOwnProperty('MaxfppwdDay') && data.MaxfppwdDay + "" !== '' && validator.isEmpty(data.MaxfppwdDay + "", { ignore_whitespace: true })) {
        errors.MaxfppwdDay = "my_account.err.fieldRequired"
    } else if (data.hasOwnProperty('MaxfppwdDay') && data.MaxfppwdDay + "" !== '' && !validator.isEmpty(data.MaxfppwdDay + "")) {
    ...
    //MaxfppwdMonth...
    if (data.hasOwnProperty('MaxfppwdMonth') && data.MaxfppwdMonth + "" !== '' && validator.isEmpty(data.MaxfppwdMonth + "", { ignore_whitespace: true })) {
        errors.MaxfppwdMonth = "my_account.err.fieldRequired"
    } else if (data.hasOwnProperty('MaxfppwdMonth') && data.MaxfppwdMonth + "" !== '' && !validator.isEmpty(data.MaxfppwdMonth + "")) {
    ...
    //LinkExpiryTime...
    if (data.hasOwnProperty('LinkExpiryTime') && data.LinkExpiryTime + "" !== '' && validator.isEmpty(data.LinkExpiryTime + "", { ignore_whitespace: true })) {
        errors.LinkExpiryTime = "my_account.err.fieldRequired"
    } else if (data.hasOwnProperty('LinkExpiryTime') && data.LinkExpiryTime + "" !== '' && !validator.isEmpty(data.LinkExpiryTime + "")) {
    ...
    //OTPExpiryTime...
    if (data.hasOwnProperty('OTPExpiryTime') && data.OTPExpiryTime + "" !== '' && validator.isEmpty(data.OTPExpiryTime + "", { ignore_whitespace: true })) {
        errors.OTPExpiryTime = "my_account.err.fieldRequired"
    } else if (data.hasOwnProperty('OTPExpiryTime') && data.OTPExpiryTime + "" !== '' && !validator.isEmpty(data.OTPExpiryTime + "")) {
