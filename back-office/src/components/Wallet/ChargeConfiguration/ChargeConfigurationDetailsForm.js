...
class ChargeConfigurationDetailForm extends Component {
                        ...
                        <div className="page-title-wrap">
                            {Form ? (
                                <h2>
                                    <span>
                                        {intl.formatMessage({
                                            id: "lable.EditChargeConfigurationDetails"
                                        })}
                                    </span>
                                </h2>
                            ) : (
                                    <h2>
                                        <span>
                                            {intl.formatMessage({
                                                id: "lable.ChargeConfigurationDetails"
                                            })}
                                        </span>
                                    </h2>
                                )}
...
ChargeConfigurationDetailForm.defaultProps = {
    Form: false
};
...
)(injectIntl(ChargeConfigurationDetailForm));
