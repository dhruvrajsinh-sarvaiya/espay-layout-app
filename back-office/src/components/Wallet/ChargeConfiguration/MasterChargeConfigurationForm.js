...
class MasterChargeConfigurationForm extends Component {
                        ...
                        <div className="page-title-wrap">
                            {Form ? (
                                <h2>
                                    <span>
                                        {intl.formatMessage({
                                            id: "lable.EditChargeConfiguration"
                                        })}
                                    </span>
                                </h2>
                            ) : (
                                    <h2>
                                        <span>
                                            {intl.formatMessage({
                                                id: "lable.AddChargeConfiguration"
                                            })}
                                        </span>
                                    </h2>
                                )}
...
MasterChargeConfigurationForm.defaultProps = {
    Form: false
};

//map method
const mapStateToProps = ({ ChargeConfiguration, walletUsagePolicy, transactionPolicy, authTokenRdcer }) => {
    const {
        ChargeData,
        addChargeData,
        getChargeById,
...
)(injectIntl(MasterChargeConfigurationForm));
