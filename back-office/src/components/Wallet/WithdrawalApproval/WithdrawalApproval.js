...
const mapDispatchToProps = ({ authTokenRdcer, WithdrawalApprovalReducer, dipositReportReducer }) => {
    const { menuLoading, menu_rights } = authTokenRdcer;
    const { loading, WithdrawalRequest, AcceptRejectWithdeawal } = WithdrawalApprovalReducer;
