...
export default class ChargeTypeView extends Component {
    state = {
        open: false,
        componentName: ""
    }
        ...
        return (
            <div className="jbs-page-content">
                <div className="page-title d-flex justify-content-between align-items-center">
                    <h2><IntlMessages id="walletDeshbard.chargeTypes" /></h2>
                ...
                <div className="row">
                    <div className="col-sm-12 col-md-4 w-xs-full">
                        ...
                        >
                            <WalletFeedsWidget
                                feedsTitle={<IntlMessages id="sidebar.chargeCollected" />}
                                feedsCount={0}
                    ...
                    <div className="col-sm-12 col-md-4 w-xs-full">
                        <a
                            href="javascript:void(0)"
                            onClick={e => this.showComponent("PatternList")}
                            className="text-dark col-sm-full"
                        >
                            <WalletFeedsWidget
                                feedsTitle={<IntlMessages id="sidebar.feesAndLimitPatterns" />}
                                feedsCount={0}
