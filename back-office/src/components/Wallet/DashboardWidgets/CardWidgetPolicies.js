                ...
                <JbsCardContent customClasses="">
                    <ExpansionPanel expanded={expanded === 'panel1'} onChange={this.handleChange('panel1')} className="my-0">
                        ...
                        <ExpansionPanelDetails>
                            ...
                            {this.props.recentCharges.hasOwnProperty("ChargePolicyList") && this.props.recentCharges.ChargePolicyList.length > 0 && <ul className="list-unstyled m-0 w-100">
                    ...
                    <ExpansionPanel expanded={expanded === 'panel2'} onChange={this.handleChange('panel2')} className="my-0">
                        ...
                        <ExpansionPanelDetails>
                            ...
                            {this.props.recentUsages.hasOwnProperty("UsageList") && this.props.recentUsages.UsageList.length > 0 && <ul className="list-unstyled m-0 w-100">
                    ...
                    <ExpansionPanel expanded={expanded === 'panel3'} onChange={this.handleChange('panel3')} className="my-0">
                        ...
                        <ExpansionPanelDetails>
                            ...
                            {this.props.recentCommissions.hasOwnProperty("CommissionPolicyList") && this.props.recentCommissions.CommissionPolicyList.length > 0 && <ul className="list-unstyled m-0 w-100">
