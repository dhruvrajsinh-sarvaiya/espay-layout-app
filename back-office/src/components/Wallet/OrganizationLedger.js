/* 
    ...
    Date : 06-02-2019
    File Comment : Organization ledger component
*/
...
class OrganizationLedger extends Component {
    constructor(props) {
        super(props);
    ...
    componentWillMount() {
        this.props.getMenuPermissionByID('983A4733-0DF5-7A4D-6569-868864306313'); // get wallet menu permission
    }
    ...
    render() {
        /* check menu permission */
        var menuPermissionDetail = this.checkAndGetMenuAccessDetail('F0F5F897-9193-567B-73CA-816202F060D0'); //F0F5F897-9193-567B-73CA-816202F060D0
        ...
        return (
            <div className="jbs-page-content drawer-data">
                ...
                <WalletPageTitle title={<IntlMessages id="wallet.titleOrgLedger" />} breadCrumbData={BreadCrumbData} drawerClose={this.props.drawerClose} closeAll={this.props.closeAll} />
                        ...
                        <div className="top-filter">
                            <Form className="tradefrm row">
                                ...
                                <FormGroup className="col-md-2 col-sm-4 r_sel_20">
                                    ...
                                    <Select
                                        options={this.props.organizationWallets.map((wallet, i) => ({
                ...
                {this.props.walletLedger.length !== 0 && this.state.showReset === true && <div className="StackingHistory">
                    {this.props.loading && <JbsSectionLoader />}
                    <MUIDataTable
...
const mapStateToProps = ({ OrgWalletLedgerReducer, walletUsagePolicy, authTokenRdcer }) => {
    ...
    return { loading, organizationWallets, walletLedger, walletType, totalCount, ledgerResponse, menuLoading, menu_rights };
};
