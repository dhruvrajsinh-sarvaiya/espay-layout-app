                                            ...
                                            <Form className="tradefrm row">
                                                ...
                                                <FormGroup className="col-md-2 col-sm-4">
                                                    ...
                                                    <Input type="select" name="pair" id="pair" value={this.state.pair} onChange={this.handleChange}>
                                                        ...
                                                        {this.props.pairList.length > 0 && this.props.pairList.map((item, key) => (
...
const mapStateToProps = ({ openPositionReportRdcer, tradeRecon, actvHstrRdcer, authTokenRdcer }) => {
    const { loading, Report } = openPositionReportRdcer;
