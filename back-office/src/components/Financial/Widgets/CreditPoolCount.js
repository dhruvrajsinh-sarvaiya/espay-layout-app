        ...
        return (
            <Fragment>
                ...
                <div className="row">
                    ...
                    <div className="col-sm-12 col-md-4 w-xs-full">
                        <a href="javascript:void(0)" onClick={(e) => this.showComponent('BalanceRaisedBy196', true)} className="text-dark col-sm-full">
                            <CountCard
                    ...
                    <div className="col-sm-12 col-md-4 w-xs-full">
                        <a href="javascript:void(0)" onClick={(e) => this.showComponent('InvestedBy196', true)} className="text-dark col-sm-full">
                            <CountCard
