...
import TotalOrders from './../Reports/TotalOrders';
import TotalProduct from './../Reports/TotalProduct';
import ServiceProviderList from './../Reports/ServiceProviderList';
            ...
            <Fragment>
                <div className="row">
                    <div className="col-sm-12 col-md-4 w-xs-full">
                        <a href="javascript:void(0)" onClick={(e) => this.showComponent('TotalOrders', true/* (checkAndGetMenuAccessDetail('9F248B4B-9B99-6573-6D84-BD2A3F694EA0')).HasChild */)} className="text-dark col-sm-full">
                            <CountCard
                    ...
                    <div className="col-sm-12 col-md-4 w-xs-full">
                        <a href="javascript:void(0)" onClick={(e) => this.showComponent('ServiceProviderList', true/* (checkAndGetMenuAccessDetail('9F248B4B-9B99-6573-6D84-BD2A3F694EA0')).HasChild */)} className="text-dark col-sm-full">
                            <CountCard
                                title={<IntlMessages id="sidebar.listOfServiceProvider" />}
                                count={4567}
                                icon="fa fa-address-book"                    
                            />
                        </a>
                    ...
                    <div className="col-sm-12 col-md-4 w-xs-full">
                        <a href="javascript:void(0)" onClick={(e) => this.showComponent('TotalProduct', true/* (checkAndGetMenuAccessDetail('9F248B4B-9B99-6573-6D84-BD2A3F694EA0')).HasChild */)} className="text-dark col-sm-full">
                            <CountCard
