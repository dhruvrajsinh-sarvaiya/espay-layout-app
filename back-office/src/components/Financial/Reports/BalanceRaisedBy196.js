/* 
    ...
    Description : List of balance raised by 196
*/
...
class BalanceRaisedBy196 extends Component {
		...
		return (
			<Fragment>
				<div className="jbs-page-content">
					...
					<WalletPageTitle title={<IntlMessages id="sidebar.balanceRaisedBy196" />} breadCrumbData={BreadCrumbData} drawerClose={drawerClose} closeAll={this.closeAll} />
...
export default withRouter(connect(mapStateToProps, {})(BalanceRaisedBy196));