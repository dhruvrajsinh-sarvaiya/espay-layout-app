/* 
    ...
    Description : List of funding stage
*/
...
class FundingStages extends Component {
		...
		return (
			<Fragment>
				<div className="jbs-page-content">
					...
					<WalletPageTitle title={<IntlMessages id="sidebar.fundingStages" />} breadCrumbData={BreadCrumbData} drawerClose={drawerClose} closeAll={this.closeAll} />
					...
					<div className="responsive-table-wrapper">
						...
						<JbsCollapsibleCard fullBlock>
							<MUIDataTable
								title={<IntlMessages id="sidebar.fundingStages" />}
								data={startUpDetailList.length > 0 && startUpDetailList.map(startUp => {
									return [
										startUp.UserName,
										startUp.StartUpName,
										startUp.NoOfEquity,
...
export default withRouter(connect(mapStateToProps, {})(FundingStages));