/* 
    ...
    Description : List of invested by 196
*/
...
class InvestedBy196 extends Component {
		...
		return (
			<Fragment>
				<div className="jbs-page-content">
					...
					<WalletPageTitle title={<IntlMessages id="sidebar.investedBy196" />} breadCrumbData={BreadCrumbData} drawerClose={drawerClose} closeAll={this.closeAll} />
...
export default withRouter(connect(mapStateToProps, {})(InvestedBy196));