...
import { getStakingHistoryList } from "Actions/StakingHistoryReport";
...
const mapStateToProps = ({ StakingHistoryReportReducer, drawerclose, actvHstrRdcer, authTokenRdcer }) => {
    // breadcrumb 
    ...
    const { loading, StakingHistoryList, TotalCount } = StakingHistoryReportReducer;
