...
class ListRuleSubModule extends Component {
    ...
    showComponent = (componentName, menuDetail, moduleID = '') => {
    ...
    render() {
        const { componentName, open, subModuleList, totalCount, pagedata } = this.state;
                                ...
                                return [
                                    ...
                                    <div className="list-action">
                                        {menuPermissionDetail.CrudOption.indexOf('0BB7ACAC') !== -1 && // check edit curd operation */}
                                            <a href="javascript:void(0)" onClick={(e) => this.showComponent('AddEditRuleSubModule', this.checkAndGetMenuAccessDetail('A358B02C-45B8-A59B-6352-2E7DFCCBA73C'), item.SubModuleID)} className="ml-3"><i className="ti-pencil" /></a>
                                        }
                                    </div>
                                ];
                            })}
