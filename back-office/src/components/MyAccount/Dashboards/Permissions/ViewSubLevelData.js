...
//import component
import DisplayMoreData from './DisplayData';
                                        ...
                                        {selectedObject.childs.Modules.map((smdlList, smIndex) => (
                                            <tr key={smIndex}>
                                                ...
                                                {(
                                                    ...
                                                    <td className="text-center"><Checkbox color="primary" name="View" checked={smdlList.View} onChange={(e) => this.moduleChangeData('subModule', e.target.checked, e.target.name, smIndex, smIndex)} /></td>
                                                }
                                                {smdlList.Type === '3425D53F' ?
...
const mapStateToProps = ({ GetMenuAccessReducer, drawerclose }) => {
    ...
    const { loading, menuList, getListBit, updData } = GetMenuAccessReducer;
