            ...
            <div className="jbs-page-content">
                ...
                <JbsCollapsibleCard>
                    <Fragment>
                        ...
                        {/* Transaction Limit */}
                        {Object.keys(menuDetail).length > 0 && this.state.errors.selectTransLimit && (
                        ...
                        {/* Withdrawl Limit */}
                        {Object.keys(menuDetail).length > 0 && this.state.errors.selectWithLimit && (
                            <FormGroup className="d-flex mb-0">
                                            ...
                                            <div className="lmt_box">
                                                <FormGroup>
                                                    ...
                                                    <Input type="select"
                                                        ...
                                                        <IntlMessages id="sidebar.pleaseSelect">{(selectOption) => <option value="">{selectOption}</option>}</IntlMessages>
                                                        {getWalletTypeData &&
                                                            getWalletTypeData.map((list, keys) => (
                                                                <option key={keys} value={list.Id}>
                                                                    {list.CoinName}
                                                                </option>
                                                            ))}
                                                    </Input>
