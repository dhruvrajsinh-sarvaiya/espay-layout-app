...
class AffiliateInviteFriendChart extends Component {
    ...
    render() {
        ...
        const optionChart = {
            ...
            title: {
                text: intl.formatMessage({ id: "sidebar.inviteFriend" })
            },
            tooltip: {
            ...
            series: [{
                ...
                colorByPoint: true,
                data: [
                    { name: intl.formatMessage({ id: "sidebar.signUp" }), y: AffiliateLink, sliced: true, selected: true },
...
const mapStateToProps = ({ AffiliateRdcer }) => {
    const { chart, loading } = AffiliateRdcer;
