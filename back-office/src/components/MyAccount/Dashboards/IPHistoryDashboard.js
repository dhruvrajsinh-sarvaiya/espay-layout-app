...
class IPHistoryDashboard extends Component {
	...
	componentWillReceiveProps(nextProps) {
		...
		} else if (Object.keys(nextProps.IPHistoryDashData).length > 0 && ((nextProps.IPHistoryDashData.IpHistoryList) !== 'undefined' &&  nextProps.IPHistoryDashData.IpHistoryList.length > 0)) {
			this.setState({
