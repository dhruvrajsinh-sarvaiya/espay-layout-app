...
class ListKYCVerifyWdgt extends Component {
    ...
    render() {
        const { componentName, open, kycList, pagedata, totalCount, errors,datalist } = this.state;
        ...
        return (
            <div className="jbs-page-content">
                ...
                <Drawer
                    ...
                    height="100%"
                >
                    {componentName !== "" && <DynamicLoadComponent drawerClose={this.onClick} closeAll={this.closeAll} componentName={componentName} pagedata={pagedata} props={this.props} menuDetail={datalist} />}
                </Drawer>
            </div>
        );
    }
