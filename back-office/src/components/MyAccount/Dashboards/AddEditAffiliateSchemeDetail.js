...
class AddEditAffiliateSchemeDetail extends Component {
    ...
    render() {
        ...
        const { MinimumValue, Status, MaximumValue, CommissionValue, SchemeMasterId, SchemeMappingId, TrnWalletTypeName, CommissionType, Level, DistributionType, CreditWalletTypeName } = this.state.data;
