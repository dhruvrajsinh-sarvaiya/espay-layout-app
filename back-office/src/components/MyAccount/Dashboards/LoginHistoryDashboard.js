...
class LoginHistoryDashboard extends Component {
    ...
    componentWillReceiveProps(nextProps) {
        ...
        } else if (Object.keys(nextProps.LoginHistoryDashData).length > 0 && (nextProps.LoginHistoryDashData.LoginHistoryLis !== undefined || nextProps.LoginHistoryDashData.LoginHistoryList.length > 0)) {
