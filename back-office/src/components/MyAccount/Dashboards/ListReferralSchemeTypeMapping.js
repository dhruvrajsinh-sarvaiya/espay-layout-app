...
class ListReferralSchemeTypeMapping extends Component {
    ...
    render() {
        const { componentName, open, SchemetypemappingList, totalCount, pagedata,Data,PaytypeData} = this.state;
                                ...
                                return [
                                    ...
                                    <div className="list-action">
                                         {menuPermissionDetail.CrudOption.indexOf('0BB7ACAC') !== -1 && // check for edit permission */}
                                             <a href="javascript:void(0)" onClick={(e) => this.showComponent('AddEditReferralSchemeTypeMapping',this.checkAndGetMenuAccessDetail('A595279E-7D18-1D91-69DC-1499D7B46E36'), item.Id)} className="ml-3"><i className="ti-pencil" /></a>
                                        }
                                        {menuPermissionDetail.CrudOption.indexOf('0BB7ACAC') !== -1 && // check for edit permission
