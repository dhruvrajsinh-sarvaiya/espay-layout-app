...
import { changeBlockUserChatStatus } from 'Actions/ChatDashboard';
	...
	componentWillReceiveProps(nextProps) {
		...
		if ((!this.state.menudetail.length && nextProps.menu_rights.hasOwnProperty('ReturnCode') && this.state.Pflag)) {
			if (nextProps.menu_rights.ReturnCode === 0) {
				...
				if (this.props.chatUserlistData !== undefined && this.props.chatUserlistData !== '') {
		...
		if (nextProps.chatUserlistData !== undefined && nextProps.chatUserlistData !== '' && nextProps.statusChecker !== undefined && nextProps.statusChecker === 0) {
		...
		if (nextProps.statusupdatedData !== undefined && nextProps.statusupdatedData != null && nextProps.statusupdatedData != "" && nextProps.statusupdatedData.ReturnCode === 0) {
		...
		} else if (nextProps.errors !== undefined && nextProps.errors.ReturnCode === 9) { //on from API error
...
const mapStateToProps = ({ chatUserList, authTokenRdcer }) => {
	...
	if (chatUserList.chatUserStatus !== undefined && chatUserList.chatUserStatus !== null && chatUserList.chatUserStatus != "") {
