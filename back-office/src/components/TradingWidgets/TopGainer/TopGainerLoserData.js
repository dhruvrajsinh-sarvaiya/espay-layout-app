...
class AllDetail extends Component {
    ...
    componentWillReceiveProps(nextprops) {
        ...
        if (nextprops.topGainersLosers.length !== 0 && nextprops.error.length === 0) {
            this.setState({ topGainersLosers: nextprops.topGainersLosers })
        }
    ...
    render() {
        ...
        var menuPermissionDetail = this.checkAndGetMenuAccessDetail(this.state.marginTradingBit === 1 ? (this.props.topGainerLoser ? '18EF8BDA-7061-9443-64BE-D20954DB59B1' : '8068ACAA-45C4-035B-47ED-F8EB4B9A4E3B') : (this.props.topGainerLoser ? '6A32294E-78EB-75BA-0507-537851461ABD' : '10BCFD68-34DD-1B93-4B2D-7F32E4C3A00B')); //3EA5320A-531C-07B9-1C3D-E4FCDD59131E  && margin_GUID 3C655E15-6A4C-7B41-50C4-4D03E2AB5A85        
