                        ...
                        <FormGroup row>
                            ...
                            <div className="col-md-8 col-sm-9 col-xs-12">
                                ...
                                >
                                    ...
                                    {this.state.pairList.length > 0 && this.state.pairList.map((item, key) => (
                                        <option
                                            value={item.PairId}
                                            key={key}
                                        >
                        ...
                        <FormGroup row>
                            ...
                            <div className="col-md-8 col-sm-9 col-xs-12">
                                ...
                                >
                                    ...
                                    {this.state.orderTypeList.length > 0 && this.state.orderTypeList.map((item, key) => (
                                        <option
                                            value={item.ID}
                                            key={key}
                                        >
                        ...
                        <FormGroup row>
                            ...
                            <div className="col-md-8 col-sm-9 col-xs-12">
                                ...
                                >
                                    ...
                                    {this.state.routeList.length > 0 && this.state.routeList.map((item, key) => (
                                        <option
                                            value={item.Id}
                                            key={key}
                                        >
