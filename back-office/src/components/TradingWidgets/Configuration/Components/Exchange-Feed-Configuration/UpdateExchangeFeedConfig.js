...
class UpdateExchangeFeedConfig extends Component {
    ...
    closeAll = () => {
        this.props.closeAll();
        this.setState({ open: false, isUpdate: false });
    }
    ...
    componentWillReceiveProps(nextprops) {
        ...
        if (nextprops.socketMethods && nextprops.socketMethods.length > 0) {
            this.setState({ socketMethods: nextprops.socketMethods })
        }

        // set state for limit data
        if (nextprops.limitMethods && nextprops.limitMethods.length > 0) {
            this.setState({ limitMethods: nextprops.limitMethods })
        }
                        ...
                        <FormGroup row>
                            ...
                            <Col sm={8}>
                                ...
                                >
                                    ...
                                    {this.state.socketMethods.length > 0 && this.state.socketMethods.map((item, key) => (
                                        <option
                                            value={item.ID}
                                            key={key}
                                        >
                        ...
                        <FormGroup row>
                            ...
                            <Col sm={8}>
                                ...
                                >
                                    ...
                                    {this.state.limitMethods.length > 0 && this.state.limitMethods.map((item, key) => (
                                        <option
                                            value={item.ID}
                                            key={key}
                                        >
