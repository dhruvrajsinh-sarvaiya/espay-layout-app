// component for update liquidity manager list 
...
// class for update liquidity api manager
class UpdateLiquidityApiManager extends Component {
  ...
  // create request for update  and call api for update liquidity api manager record
                    ...
                    <Row>
                      ...
                      <Col sm={8}>
                        ...
                        >
                          ...
                          {providersList.length > 0 && providersList.map((item, key) => (
                            <option
                              value={item.Id}
                              key={key}
                            >
                    ...
                    <Row>
                      ...
                      <Col sm={8}>
                        ...
                        >
                          ...
                          {limitData.length > 0 && limitData.map((item, key) => (
                            <option
                              value={item.Id}
                              key={key}
                            >
                    ...
                    <Row>
                      ...
                      <Col sm={8}>
                        ...
                        >
                          ...
                          {daemonConfigList.length > 0 && daemonConfigList.map((item, key) => (
                            <option
                              value={item.Id}
                              key={key}
                            >
                    ...
                    <Row>
                      ...
                      <Col sm={8}>
                        ...
                        >
                          ...
                          {serviceConfiguration.length > 0 && serviceConfiguration.map((item, key) => (
                            <option
                              value={item.Id}
                              key={key}
                            >
                    ...
                    <Row>
                      ...
                      <Col sm={8}>
                        ...
                        >
                          ...
                          {providerType.length > 0 && providerType.map((item, key) => (
                            <option
                              value={item.Id}
                              key={key}
                            >
                    ...
                    <Row>
                      ...
                      <Col sm={8}>
                        ...
                        >
                          ...
                          {transactionTypeList.length > 0 && transactionTypeList.map((item, key) => (
                            <option
                              value={item.Id}
                              key={key}
