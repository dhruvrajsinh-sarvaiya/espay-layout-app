  ...
  render() {
    ...
    return (
      <div className="responsive-table-wrapper jbs-page-content">
        ...
        <WalletPageTitle title={<IntlMessages id={this.props.state &&this.props.state.title} />} breadCrumbData={this.props.state &&this.props.state.BreadCrumbData} drawerClose={drawerClose} closeAll={closeAll} />
