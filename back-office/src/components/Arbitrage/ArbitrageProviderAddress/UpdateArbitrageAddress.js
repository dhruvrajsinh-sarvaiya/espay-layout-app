            ...
            <div className="jbs-page-content">
                ...
                <div className="row">
                    <div className="col-sm-12 ">
                        {(menuDetail['867271A8-7F95-6074-4A93-AB55A71052BC'] && menuDetail['867271A8-7F95-6074-4A93-AB55A71052BC'].Visibility === "E925F86B") && //867271A8-7F95-6074-4A93-AB55A71052BC
                            <FormGroup className="col-sm-12">
                                ...
                                >
                                    ...
                                    {this.state.Data.length > 0 && this.state.Data.map((type, index) => (
                        ...
                        {(menuDetail['16090601-2E25-7AF9-5F4B-935F48513EAE'] && menuDetail['16090601-2E25-7AF9-5F4B-935F48513EAE'].Visibility === "E925F86B") && //16090601-2E25-7AF9-5F4B-935F48513EAE
                            <FormGroup className="col-sm-12">
                                ...
                                >
                                    ...
                                    {this.props.ArbitrageCurrencyList.length > 0 && this.props.ArbitrageCurrencyList.map((type, index) => (
                        ...
                        {Object.keys(menuDetail).length > 0 && !this.props.loading && <FormGroup row>
...
const mapStateToProps = ({ ArbitrageAddressReducer, ServiceProviderReducer, authTokenRdcer, ArbitrageCurrencyConfigurationReducer }) => {
    const {
        menuLoading,
        menu_rights
    } = authTokenRdcer;
