...
const mapStateToProps = ({ ExchangeBalanceReducer, ArbitrageCurrencyConfigurationReducer, drawerclose, authTokenRdcer, ServiceProviderReducer }) => {
	// breadcrumb
