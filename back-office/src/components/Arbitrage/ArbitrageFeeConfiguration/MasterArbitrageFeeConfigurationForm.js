                        ...
                        <div className="form-group row">
                            ...
                            <div className="col-md-8">
                                ...
                                >
                                    ...
                                    {this.props.walletTransactionType.length > 0  &&
...
//map method
const mapStateToProps = ({ FeeConfigurationReducer, tradeRecon, walletUsagePolicy, transactionPolicy, authTokenRdcer, liquidityManager, ArbitrageCurrencyConfigurationReducer }) => {
    const {
