...
class AddExchangeConfiguration extends Component {
  ...
  addAPIProviderData = () => {
    ...
    const {
      selectedArbitrageProvider, selectedArbitrageServiceProvider, selectedArbitrageProviderConfig,
      selectedArbitrageProviderType,
                    ...
                    <Row>
                      ...
                      <Col sm={8}>
                        ...
                        >
                          ...
                          {arbitrageProvidersList.length > 0 && arbitrageProvidersList.map((item, key) => (
                            <option
                              value={item.Id}
                              key={key}
                            >
                    ...
                    <Row>
                      ...
                      <Col sm={8}>
                        ...
                        >
                          ...
                          {arbitrageServiceProvider.length > 0 && arbitrageServiceProvider.map((item, key) => (
                            <option
                              value={item.Id}
                              key={key}
                            >
                    ...
                    <Row>
                      ...
                      <Col sm={8}>
                        ...
                        >
                          ...
                          {arbitrageServiceConfiguration.length > 0 && arbitrageServiceConfiguration.map((item, key) => (
                            <option
                              value={item.Id}
                              key={key}
                            >
                    ...
                    <Row>
                      ...
                      <Col sm={8}>
                        ...
                        >
                          ...
                          {arbitrageProviderType.length > 0 && arbitrageProviderType.map((item, key) => (
                    ...
                    <Row>
                      ...
                      <Col sm={8}>
                        ...
                        >
                          ...
                          {arbitrageTransactionTypeList.length > 0 && arbitrageTransactionTypeList.map((item, key) => (
                            <option
                              value={item.Id}
                              key={key}
                            >
