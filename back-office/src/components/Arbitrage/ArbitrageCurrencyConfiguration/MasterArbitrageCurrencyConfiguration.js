/* 
    ...
    Date : 18-03-2019
    File Comment : Master Arbitrage Currency Configuration
*/
...
import MasterArbitrageCurrencyConfigurationForm from './MasterArbitrageCurrencyConfigurationForm';
//added for display carge configuration detail records
import ArbitrageCurrencyConfiguration from "./ArbitrageCurrencyConfiguration";
...
//components names
const components = {
    ArbitrageCurrencyConfiguration: ArbitrageCurrencyConfiguration,
    MasterArbitrageCurrencyConfigurationForm: MasterArbitrageCurrencyConfigurationForm
};
...
class MasterArbitrageCurrencyConfiguration extends Component {
    constructor(props) {
        super(props);
    ...
    onEditChargeConfig(ChargeConfiguration, menuDetail) {
        // check permission go on next page or not
        if (menuDetail) {
            this.setState({
                componentName: "MasterArbitrageCurrencyConfigurationForm",
                open: true,
                Form: true,
                // menuDetail:menuDetail
            });
            this.props.getChargeConfigurationById({
                MasterId: ChargeConfiguration
            });
        } else {
            NotificationManager.error(<IntlMessages id={"error.permission"} />);
        }
    ...
    ListChargeConfigurationDtails(item, menuDetail) {
        ...
        if (menuDetail) {
            ...
            this.setState({
                open: true,
                componentName: "ArbitrageCurrencyConfiguration",
                MasterId: item.Id,
    ...
    render() {
                ...
                if (menuPermissionDetail.CrudOption.indexOf('04F44CE0') !== -1) { // check add curd operation
                    return (
                        <Button
                            ...
                            onClick={() => this.showComponent("MasterArbitrageCurrencyConfigurationForm", (this.checkAndGetMenuAccessDetail('B5CC5A29-382B-03DE-7D5F-6D026CB26AD9').HasChild)  //BEE7C897-231A-0D98-85FF-CB2ED9A10D07
                            )}
                        >
        ...
        return (
            <div className="jbs-page-content">
                ...
                <WalletPageTitle title={intl.formatMessage({ id: "lable.ArbitrageCurrencyConfiguration" })} breadCrumbData={BreadCrumbData} drawerClose={drawerClose} closeAll={this.closeAll} />
                ...
                <Drawer
                    width={
                        this.state.componentName === "ArbitrageCurrencyConfiguration"
                            ? "100%"
                            : "50%"
                    }
                    handler={false}
...
//map method
const mapStateToProps = ({ ChargeConfiguration, drawerclose, authTokenRdcer, ArbitrageCurrencyConfigurationReducer }) => {
...
)(injectIntl(MasterArbitrageCurrencyConfiguration));
