...
import { getArbitrageAddressList, } from "Actions/Arbitrage/ArbitrageProviderAddress";
//Action methods..
                        ...
                        <FormGroup row>
                            ...
                            <Col sm={8}>
                                ...
                                >
                                    ...
                                    {this.state.FromProviderList.length > 0 &&
                        ...
                        <FormGroup row>
                            ...
                            <Col sm={8}>
                                <Select
                                    ...
                                    options={ArbitrageCurrencyList.map((type) => ({
                                        label: type.CoinName,
                                        value: type.Id,
                                    }))}
                    ...
                    {(menuDetail['298351AF-8615-2B18-2D54-E0E002AB093A'] && menuDetail['298351AF-8615-2B18-2D54-E0E002AB093A'].Visibility === "E925F86B") && //298351AF-8615-2B18-2D54-E0E002AB093A
                        <FormGroup row>
                            ...
                            <Col sm={8}>
                                ...
                                >
                                    <option value="">{intl.formatMessage({ id: "sidebar.pleaseSelect" })}</option>
                                    {this.props.arbitrageAddressList.length > 0 &&
...
const mapToProps = ({ authTokenRdcer, dipositReportReducer, TopupHistoryReducer, ArbitrageCurrencyConfigurationReducer, ServiceProviderReducer, ArbitrageAddressReducer }) => {
    const { menuLoading, menu_rights } = authTokenRdcer;
    const { reconResponse, response2fa, errors, error2fa } = dipositReportReducer;
    const { TopupRequest, loading } = TopupHistoryReducer;
