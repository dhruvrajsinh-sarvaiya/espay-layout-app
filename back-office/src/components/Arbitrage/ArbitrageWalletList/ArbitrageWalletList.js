...
class ArbitrageProviderWallet extends Component {
    ...
    clearFilter() {
        ...
        this.setState(newObj, () => this.props.getArbitrageWalletList({}));
    }
...
const mapStateToProps = ({ ProviderWalletReducer, authTokenRdcer, ArbitrageCurrencyConfigurationReducer, ServiceProviderReducer }) => {
    const {
        menuLoading,
        menu_rights
    } = authTokenRdcer;
