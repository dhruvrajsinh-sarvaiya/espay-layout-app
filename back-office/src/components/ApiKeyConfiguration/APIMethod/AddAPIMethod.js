...
class AddAPIMethod extends Component {
    ...
    componentWillReceiveProps(nextProps) {
        if (nextProps.resetMethodListData.ReturnCode === 0 &&  nextProps.resetMethodListData !== 'undefined') {
            this.setState({
                resetMethodList: nextProps.resetMethodListData.Response
            })
        }
        if (nextProps.socketMethodListData.ReturnCode === 0 &&  nextProps.socketMethodListData !== 'undefined') {
            this.setState({
