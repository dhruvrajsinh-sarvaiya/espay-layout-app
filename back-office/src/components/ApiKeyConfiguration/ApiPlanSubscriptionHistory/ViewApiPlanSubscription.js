                        ...
                        <Row>
                            <Col md={6} sm={6} xs={12}>
                                ...
                                <Row>
                                    ...
                                    <Label for="planname" sm={6} xs={6}
                                        className={this.state.viewData && this.state.viewData.IsPlanRecursive === 1 ? "text-primary d-inline font-weight-bold" :
                                            "text-warning d-inline font-weight-bold"}>
                                        {this.state.viewData && this.state.viewData.IsPlanRecursive === 1 ? <IntlMessages id="button.yes" /> : <IntlMessages id="sidebar.no" />}
                                    </Label>
                                </Row>
                                ...
                                <Row>
                                    ...
                                    <Label for="planname" sm={6} xs={6}
                                        className={classnames(this.state.viewData && this.state.viewData.Status === 1 ? "text-success" :this.state.viewData &&  this.state.viewData.Status === 0 ? "text-warning" : this.state.viewData && this.state.viewData.Status === 9 ? "text-danger" : "", "d-inline font-weight-bold")}>
                                        {this.state.viewData && this.state.viewData.Status === 1 ? <IntlMessages id="sidebar.active" /> :
                                         this.state.viewData &&  this.state.viewData.Status === 9 ? <IntlMessages id="apiplanconfiguration.title.expire" /> :
                                         this.state.viewData &&   this.state.viewData.Status === 0 ? <IntlMessages id="apiplanconfiguration.title.inprocess" /> : "-"
                                        }
                                ...
                                <Row>
                                    ...
                                    <Label for="price" sm={6} xs={6}>
                                        ...
                                        {this.state.viewData &&  this.state.viewData.ActivationDate ?
                            ...
                            <Col md={6} sm={6} xs={12}>
                                ...
                                <Row>
                                    ...
                                    <Label for="price" sm={6} xs={6}>
                                        {this.state.viewData &&  this.state.viewData.ExpiryDate ?
                                ...
                                <Row>
                                    ...
                                    <Label for="price" sm={6} xs={6}>
                                        {this.state.viewData &&  this.state.viewData.RequestedDate ?
...
export default connect(mapStateToProps, { getMenuPermissionByID })(ViewApiPlanSubscription);
