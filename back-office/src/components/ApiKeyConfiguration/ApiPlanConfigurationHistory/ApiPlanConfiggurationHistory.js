...
class PlanConfigurationHistory extends Component {
    ...
    onChangeSelectUser = (event) => {
        this.setState({ userId: ((event.value) === undefined ? "" : event.value) });
    }
                        ...
                        <Col md={12} className="api-subscription">
                            ...
                            <div className="tbl_overflow_auto">
                                <MUIDataTable
                                    ...
                                    data={this.state.apiPlanConfigurationHistory.length != 0 && this.state.apiPlanConfigurationHistory.map((item, key) => {
                                        ...
                                        return [
                                            item.PlanName,
                                            <Fragment>{item.PlanValidity}   {type}</Fragment>,
                                            item.Priority,
                                            item.Price,
                                            item.Charge,
