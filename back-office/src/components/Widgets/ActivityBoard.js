	...
	render() {
		...
		return (
			<div className="activity-board-wrapper">
				...
				<Scrollbars className="jbs-scroll" autoHeight autoHeightMin={100} autoHeightMax={600} autoHide>
					<ul className="mb-0 list-unstyled">
						<li className="border-bottom">
							<div className="activity-heading d-flex p-4 border-bottom">
								<h3 className="mb-0">MERN Redesign</h3>
							</div>
							<div className="activity-description p-4">
                              ...
                              quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
								...
								<h4 className="mb-4">MERN Redesign Assets</h4>
				...
				<JbsCardFooter className="bg-light">
