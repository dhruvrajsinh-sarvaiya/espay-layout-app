...
export default class TopHeadlines extends Component{
   render(){
      return (
         <Fragment>
            <Scrollbars className="jbs-scroll" autoHeight autoHeightMin={100} autoHeightMax={571} autoHide>
               <ul className="top-headlines-widget list-unstyled mb-0">
                  {headlinesData.length > 0 && headlinesData.map((headline, key) =>
            ...
            <JbsCardFooter customClasses="d-flex justify-content-between align-items-center rounded-bottom">
