...
//jbs card component
import { JbsCardFooter } from "Components/JbsCard";
...
export default class PersonalSchedule extends Component {
    ...
    render() {
        ...
        return (
            <Fragment>
                {sectionReload && <JbsSectionLoader />}
                <div className="personal-schedule-wrap">
                    <div className="jbs-block-title border-0 d-flex justify-content-between align-items-center">
                    ...
                    <Scrollbars className="jbs-scroll" autoHeight autoHeightMin={100} autoHeightMax={320} autoHide >
                    ...
                    <JbsCardFooter customClasses="d-flex border-0 justify-content-between bg-light-yellow rounded-bottom align-items-center">
