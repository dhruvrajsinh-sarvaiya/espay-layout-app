...
import validateForm from '../../../validation/EmailTemplates/EmailTemplates';
...
class EditEmailTemplate extends Component {
  ...
  render() {
    const { err_alert, errors, templatedetail, loading, paramDetails, selectedParameters } = this.state;
    return (
      <div className="jbs-page-content">
        ...
        <Form className="tradefrm">
          <FormGroup>
            ...
            {errors && errors.CommServiceTypeID && <span className="text-danger"><IntlMessages id={errors.CommServiceTypeID} /></span>}
          </FormGroup>
          <FormGroup>
            ...
            {errors && errors.templateType && <span className="text-danger"><IntlMessages id={errors.templateType} /></span>}
          </FormGroup>
          <FormGroup>
            ...
            />
            {errors && errors.templateName && <span className="text-danger"><IntlMessages id={errors.templateName} /></span>}
          </FormGroup>
          <FormGroup>
            ...
            />
            {errors && errors.AdditionalInfo && <span className="text-danger"><IntlMessages id={errors.AdditionalInfo} /></span>}
          </FormGroup>
          <FormGroup>
