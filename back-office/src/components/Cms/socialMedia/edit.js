...
class EditSocialMedia extends Component {
	...
	componentWillReceiveProps(nextProps) {
		...
		if (nextProps.SocialMediadata !== undefined && nextProps.SocialMediadata != '') {
			...
			this.setState({
				socialMediadetail: {
					...this.state.socialMediadetail,
					_id: nextProps.SocialMediadata._id,
					status: nextProps.SocialMediadata.status + "",
					name: nextProps.SocialMediadata.name,
					details: nextProps.SocialMediadata.details,
					social_media_type: nextProps.SocialMediadata.social_media_type,
				}
			});
		}
	...
	render() {
		...
		const { err_alert, errors, socialMediadetail, loading, btn_disabled } = this.state;
				...
				<Form>
					...
					{(menudetail["B6B2D4FD-61B0-6245-589D-66A2D7067154"] && menudetail["B6B2D4FD-61B0-6245-589D-66A2D7067154"].Visibility === "E925F86B") && //B6B2D4FD-61B0-6245-589D-66A2D7067154
						<FormGroup>
							...
							{errors && errors.status && <span className="text-danger"><IntlMessages id={errors.status} /></span>}
						</FormGroup>}
