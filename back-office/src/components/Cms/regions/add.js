...
class AddRegion extends Component {
	...
	render() {
		...
		const { err_alert, language, errors, addNewRegionDetail, loading, btn_disabled } = this.state; // Added By Megha Kariya (08/02/2019) : add btn_disabled
...
const mapStateToProps = ({ languages, regions, authTokenRdcer }) => {
	...
	if (regions.localebit !== undefined && regions.localebit != '') {
