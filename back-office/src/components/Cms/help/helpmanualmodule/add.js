...
class AddHelpModule extends Component {
	...
	componentWillReceiveProps(nextProps) {
		...
		if (typeof nextProps.localebit != 'undefined' && nextProps.localebit != '' && nextProps.localebit == 1 && (nextProps.data.responseCode != 9 && nextProps.data.responseCode != 1)) {
			...
			var newObj = Object.assign({}, this.state.addNewHelpModuleDetail);
			newObj['locale'] = locale;
		   this.setState({addNewHelpModuleDetail:newObj})
		}
	...
	render() {
		...
		const { err_alert, language, errors, addNewHelpModuleDetail, loading, btn_disabled } = this.state; // Added By Megha Kariya (08/02/2019) : add btn_disabled
		return (
