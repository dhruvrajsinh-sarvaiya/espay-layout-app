...
class EditNews extends Component {
    ...
    if (typeof nextProps.newsdata != 'undefined' && typeof nextProps.newsdata.locale != 'undefined' && nextProps.newsdata != '') {
      ...
      this.setState({
        newsdetail: {
          ...this.state.newsdetail,
          locale: newlocale,
          _id: nextProps.newsdata._id,
          newsid: nextProps.newsdata.newsid,
          sort_order: nextProps.newsdata.sort_order,
          //Added by Meghaben 29-01-2019
          status: nextProps.newsdata.status + '',
          type: nextProps.newsdata.type ? nextProps.newsdata.type : this.state.newsdetail.type,
          from_date: nextProps.newsdata.from_date,
          to_date: nextProps.newsdata.to_date,
        }
      });
    }
  ...
  render() {
    ...
    const { err_alert, language, errors, newsdetail, loading, btn_disabled } = this.state; // Added By Megha Kariya (08/02/2019) : add btn_disabled
