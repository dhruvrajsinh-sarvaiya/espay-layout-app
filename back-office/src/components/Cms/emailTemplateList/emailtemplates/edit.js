...
class EditEmailTemplate extends Component {
  ...
  render() {
    ...
    const { err_alert, errors, templatedetail, loading, paramDetails, selectedParameters, btn_disabled } = this.state; // Added By Megha Kariya (08/02/2019) : add btn_disabled
    return (
        ...
        <Form className="tradefrm">
          ...
          {(menudetail["569DFB33-8DD0-A502-0303-80C43B152522"] && menudetail["569DFB33-8DD0-A502-0303-80C43B152522"].Visibility === "E925F86B") && //569DFB33-8DD0-A502-0303-80C43B152522
            <FormGroup>
              ...
              />
              {errors.Content && <span className="text-danger"><IntlMessages id={errors.Content} /></span>}
            </FormGroup>}
