/* 
    ...
    Date : 20-02-2019
    Description : View page of CMS Email API manager
*/
...
export default class ViewEmailAPIDetail extends Component {
    ...
    componentWillReceiveProps(nextProps) {
        this.setState({ EmailApiDetail: nextProps.EmailApiDetail });
    }

    componentWillMount() {
        this.setState({ EmailApiDetail: this.props.EmailApiDetail });
    }
