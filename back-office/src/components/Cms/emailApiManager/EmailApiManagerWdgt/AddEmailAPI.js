...
class AddEmailAPI extends Component {
    ...
    componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.AddResponse &&  nextProps.AddResponse !== 'undefined' && nextProps.AddResponse.ReturnCode == 0 && this.state.isAPICall == true) {
                                ...
                                {(this.state.ServiceTypeID === 2
                                    ...
                                    <Col md={4}>
                                        ...
                                        <Input
                                            ...
                                            <IntlMessages id="emailAPIManager.label.ParsingDataID">
                                                {(ParsingData) =>
                                                    <option value="">{ParsingData}</option>
                                                }
                                            </IntlMessages>
                                ...
                                {(this.state.ServiceTypeID === 2
                                    ...
                                    <Col md={4}>
                                        ...
                                        <Input
                                            ...
                                            type="select" name="Status" value={this.state.Status} id="Select-2" onChange={this.handleChange}>
                                            <IntlMessages id="emailAPIManager.label.Status">
                                                {(Status) =>
