...
class FollowerProfileWdgt extends Component {
	...
	render() {
		...
		const { Can_Copy_Trade, Can_Mirror_Trade, Maximum_Number_of_Leaders_to_Allow_Follow, Can_Add_Leader_to_Watchlist, Max_Number_of_Leader_to_Allow_in_Watchlist } = this.state.data;
			...
			<div className="FollowerForm">
				<Form className="tradefrm">
					<Fragment>
						...
						<Fragment>
							<Form>
								{Object.keys(menuDetail).length > 0 && this.props.topButton &&
