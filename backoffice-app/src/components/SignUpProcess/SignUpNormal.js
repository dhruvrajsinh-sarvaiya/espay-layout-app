...
class SignUpNormal extends Component {
                    ...
                    <View style={{ flex: 1 }}>
                        ...
                        <View style={{ flex: 1, justifyContent: 'space-between' }}>
                            ...
                            <View style={this.styles().input_container}>
                                ...
                                <View style={{ paddingTop: R.dimens.widgetMargin, paddingBottom: R.dimens.margin_left_right, flexDirection: 'row', justifyContent: 'center', }}>
                                    <Text style={{ color: R.colors.textPrimary, fontSize: R.dimens.smallestText, fontFamily: Fonts.HindmaduraiBold }}>{R.strings.eagerToJoin}</Text>
    ...
    styles = () => {
        return {
            ...
            button_text_style: {
                color: R.colors.buttonBackground,
...
export default connect()(SignUpNormal)