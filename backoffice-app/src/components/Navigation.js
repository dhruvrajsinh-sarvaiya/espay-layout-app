...
class ReduxNavigation extends PureComponent {
    ...
    componentDidMount = () => {
        ...
        Dimensions.addEventListener('change', this.dimensionEventListener)
    ...
    componentWillUnmount() {
        ...
        Dimensions.removeEventListener("change", this.dimensionEventListener);
...
function navigateReset(routeName, params = {}) {
    ...
    // if params is not passed as object then convert it in object
