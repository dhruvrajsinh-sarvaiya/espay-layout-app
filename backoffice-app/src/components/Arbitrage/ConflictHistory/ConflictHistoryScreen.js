	...
	static getDerivedStateFromProps(props, state) {
		...
		if (isCurrentScreen(props)) {
			...
			if (ConflictHistoryList) {
				try {
					if (state.ConflictHistoryListState == null || (state.ConflictHistoryListState !== null && ConflictHistoryList !== state.ConflictHistoryListState)) {
							...
							(ConflictHistoryLoading && !this.state.refreshing) ?
								...
								<FlatList
									...
									renderItem={({ item, index }) => <ConflictHistoryItem
										...
										onDetailPress={() => this.props.navigation.navigate('ConflictHistoryDetailScreen', { item, titleScreen: this.state.titleScreen })}
										onRecon={() =>
