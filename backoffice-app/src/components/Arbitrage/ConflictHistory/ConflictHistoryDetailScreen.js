                ...
                <SafeView style={{ flex: 1 }}>
                    ...
                    <ScrollView
                        ...
                        <CardView style={{
                            ...
                            {/* For providerBalance */}
                            {this.state.screenType == 2 &&
                                < RowItem
                                    title={R.strings.providerBalance}
                                    value={(parseFloatVal(item.TPBalance).toFixed(8) !== 'NaN' ? (parseFloatVal(item.TPBalance).toFixed(8)) : '-')}
                                />
                            }
                            ...
                            {this.state.screenType == 2 &&
                                < RowItem
                                    title={R.strings.sytemBalance}
                                    value={(parseFloatVal(item.SystemBalance).toFixed(8) !== 'NaN' ? (parseFloatVal(item.SystemBalance).toFixed(8)) : '-')}
                                />
                            }
