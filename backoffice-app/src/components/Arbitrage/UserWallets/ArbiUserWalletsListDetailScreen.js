...
export class ArbiUserWalletsListDetailScreen extends Component {
    constructor(props) {
        super(props);
    ...
    render() {
        ...
        else if (item.Status == 2 || item.Status == 5 || item.Status == 6 || item.Status == 9) { color = R.colors.failRed }

        return (
            <LinearGradient 
            style={{ flex: 1, }} locations={[0, 1]} start={{ x: 0, y: 0 }} end={{ x: 0, y: 1 }}
                ...
                <SafeView style={{ flex: 1 }}>
                    ...
                    <ScrollView contentContainerStyle={{ flexGrow: 1, paddingBottom: R.dimens.margin_top_bottom }} showsVerticalScrollIndicator={false} keyboardShouldPersistTaps={'always'}>
                        ...
                        <View style={{ marginLeft: (R.dimens.margin_top_bottom * 2), marginRight: R.dimens.margin_top_bottom, marginTop: R.dimens.margin }}>
                            ...
                            <Text style={{
                                fontWeight: 'bold', fontSize: R.dimens.mediumText,
                                color: R.colors.white,
                                textAlign: 'left',
...
export default ArbiUserWalletsListDetailScreen
