    ...
    static getDerivedStateFromProps(props, state) {
        ...
        if (isCurrentScreen(props)) {
            ...
            if (ArbitrageCurrencyList) {
                try {
                    ...
                    if (state.ArbitrageCurrencyListState == null ||
                        (state.ArbitrageCurrencyListState !== null && ArbitrageCurrencyList !== state.ArbitrageCurrencyListState)) {
            ...
            if (ProviderAddressList) {
                try {
                    if (state.ProviderAddressListState == null || (state.ProviderAddressListState !== null && ProviderAddressList !== state.ProviderAddressListState)) {
