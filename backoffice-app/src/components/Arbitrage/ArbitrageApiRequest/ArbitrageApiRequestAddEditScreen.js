        ...
        if (isCurrentScreen(props)) {
            ...
            if (AppTypeList) {
                try {
                    ...
                    if (state.AppTypeListState == null || (state.AppTypeListState !== null && AppTypeList !== state.AppTypeListState)) {
            ...
            if (ThirdpartyResponseList) {
                try {
                    ...
                    if (state.parseIdListState == null || (state.parseIdListState !== null && ThirdpartyResponseList !== state.parseIdListState)) {
