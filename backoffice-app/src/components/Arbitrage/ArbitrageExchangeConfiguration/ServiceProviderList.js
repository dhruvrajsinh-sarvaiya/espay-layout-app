        ...
        if (isCurrentScreen(props)) {
            ...
            if (ServiceProviderdata) {
                try {
                    ...
                    if (state.ServiceProviderList == null || (ServiceProviderdata !== state.ServiceProviderList)) {
            ...
            if (UpdateServiceProviderdata) {
                ...
                try {
                    ...
                    if (state.UpdateServiceProviderListState == null || (UpdateServiceProviderdata !== state.UpdateServiceProviderListState)) {
                ...
                <View style={{
                    ...
                    <CardView style={{
                        ...
                        <View style={{ flex: 1, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                            <Text style={{ flex: 1, color: R.colors.textPrimary, fontSize: R.dimens.smallText, fontFamily: Fonts.MontserratSemiBold, }}>{item.ProviderName ? item.ProviderName : '-'}</Text>
