        ...
        if (id == 1)
            this.props.navigation.navigate('CommonDashboard', {
                response: [
                    ...
                    // { title: R.strings.conflictHistory, icon: R.images.IC_CHART, id: 3, type: 1, navigate: 'ConflictHistoryScreen' },
                    { title: R.strings.providerLedger, icon: R.images.IC_CHART, id: 4, type: 1, navigate: 'ProviderLedgerScreen' },
