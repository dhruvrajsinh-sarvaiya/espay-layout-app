    ...
    constructor(props) {
        ...
        this.state = {
            ...
            data: [
                ...
                { title: R.strings.countries, screenname: 'CountriesScreen', icon: R.images.IC_ARROW_RIGHT_BOLD, category: Constants.Category.Localization },
                { title: R.strings.states, screenname: '', icon: R.images.IC_ARROW_RIGHT_BOLD, category: Constants.Category.Localization },
                { title: R.strings.cities, screenname: '', icon: R.images.IC_ARROW_RIGHT_BOLD, category: Constants.Category.Localization },
                { title: R.strings.zipCodes, screenname: '', icon: R.images.IC_ARROW_RIGHT_BOLD, category: Constants.Category.Localization },
            ],
        }
    }
