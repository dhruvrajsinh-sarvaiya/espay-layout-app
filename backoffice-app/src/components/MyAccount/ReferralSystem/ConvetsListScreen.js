                ...
                <View style={{
                    ...
                    <CardView style={{
                        ...
                        <View style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center', }}>
                            ...
                            {/* for show user icon */}
                            <ImageTextButton
                                style={{ justifyContent: 'center', alignSelf: 'flex-start', width: R.dimens.SignUpButtonHeight, height: R.dimens.SignUpButtonHeight, margin: 0, backgroundColor: R.colors.accent, borderRadius: R.dimens.ButtonHeight }}
