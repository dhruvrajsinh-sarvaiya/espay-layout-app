...
import { changeTheme, parseArray, addPages, showAlert, createOptions, createActions, getDeviceID, getIPAddress, logger } from '../../../controllers/CommonUtils';
...
export class UsersListScreen extends Component {
	...
	componentDidMount = () => {
		...
		changeTheme()
		// Call user List Api
		this.CallUsersListApi()
	};

	CallUsersListApi = async () => {
