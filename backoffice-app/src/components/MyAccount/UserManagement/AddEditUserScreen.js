...
export class AddEditUserScreen extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            userTypes: [
                { code: 0, value: R.strings.frontUser },
                { code: 1, value: R.strings.backofficeUser },
            ],
            selectedUserType: item !== undefined ? (item.IsAdmin == 1 ? R.strings.backofficeUser : R.strings.frontUser) : R.strings.frontUser,
