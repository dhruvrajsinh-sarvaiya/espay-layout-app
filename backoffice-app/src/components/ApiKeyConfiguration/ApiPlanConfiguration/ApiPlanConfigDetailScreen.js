							...
							<View style={{ flex: 1, paddingLeft: R.dimens.activity_margin, paddingRight: R.dimens.activity_margin, paddingBottom: R.dimens.padding_top_bottom_margin, paddingTop: R.dimens.padding_top_bottom_margin, }}>
								<View style={{ flexDirection: 'row',
								 alignItems: 'center', justifyContent: 'space-between' }}>
									<TextViewMR style={{ 
										color: R.colors.textPrimary, fontSize: R.dimens.mediumText, }}>{item.PlanName}</TextViewMR>
									<TextViewHML style={{ color: item.Status == 1 
										? R.colors.successGreen : 
										R.colors.failRed, fontSize: R.dimens.smallText, }}>{item.Status == 1 ? R.strings.active : R.strings.inActive}</TextViewHML>
								</View>

								{/* Price and PlanValidity */}
								<View style={{ alignItems: 'center', flexDirection: 'row', 
								marginTop: R.dimens.margin, }}>
									<TextViewMR style={{ fontSize: R.dimens.mediumText,
										 color: R.colors.textPrimary, }}>{parseIntVal(item.Price)}</TextViewMR>
									<TextViewMR style={{ 
										 marginLeft: R.dimens.widgetMargin,
										 color: R.colors.textSecondary, fontSize: R.dimens.mediumText, }}>USD</TextViewMR>
