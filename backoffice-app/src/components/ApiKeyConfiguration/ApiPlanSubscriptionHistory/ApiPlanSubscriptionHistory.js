	...
	static getDerivedStateFromProps(props, state) {
		...
		if (isCurrentScreen(props)) {
			...
			if (ApiPlanSubscriptionHistoryData) {
				try {
					if (state.ApiPlanSubscriptionHistoryState == null || (state.ApiPlanSubscriptionHistoryState !== null && ApiPlanSubscriptionHistory !== state.ApiPlanSubscriptionHistoryState)) {
