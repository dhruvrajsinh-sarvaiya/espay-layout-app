...
export class AuthUserAndWalletLedgerListScreen extends Component {
	...
	static getDerivedStateFromProps(props, state) {
		...
		if (isCurrentScreen(props)) {
			...
			if (AuthUserList) {
				try {
					if (state.AuthUserList == null || (state.AuthUserList !== null && AuthUserList !== state.AuthUserList)) {
			...
			if (WalletLedgerList) {
				try {
					if (state.WalletLedgerList == null || (state.WalletLedgerList !== null && WalletLedgerList !== state.WalletLedgerList)) {
						//succcess response fill the list 
