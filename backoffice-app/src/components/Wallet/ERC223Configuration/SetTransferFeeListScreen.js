                ...
                <View
                    ...
                    >
                        ...
                        <View style={{ flex: 1, flexDirection: 'row' }}>
                            ...
                            <View style={{ flex: 1, marginLeft: R.dimens.widgetMargin, }}>
                                ...
                                <View style={{ flexDirection: 'row' }}>
                                    ...
                                    <TextViewHML style={{ fontSize: R.dimens.smallestText, color: R.colors.textPrimary, }}>{validateValue(item.ContractAddress)}</TextViewHML>
                                </View>
                        ...
                        <View
                            ...
                            />
                            <TextViewHML style={{ color: R.colors.textSecondary, 
                                fontSize: R.dimens.smallestText, }}>{convertDateTime(item.ActionDate, 'YYYY-MM-DD HH:mm:ss', false)}</TextViewHML>
                        </View>
                    </CardView>
