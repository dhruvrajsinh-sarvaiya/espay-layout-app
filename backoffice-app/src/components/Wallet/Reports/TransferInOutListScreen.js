...
export class TransferInOutListScreen extends Component {
	...
	static getDerivedStateFromProps(props, state) {
		...
		if (isCurrentScreen(props)) {
			...
			if (TransferInList) {
				try {
					if (state.TransferInList == null || (state.TransferInList !== null && TransferInList !== state.TransferInList)) {
			...
			if (TransferOutList) {
				try {
					if (state.TransferOutList == null || (state.TransferOutList !== null && TransferOutList !== state.TransferOutList)) {
						//succcess response fill the list 
						if (validateResponseNew({
