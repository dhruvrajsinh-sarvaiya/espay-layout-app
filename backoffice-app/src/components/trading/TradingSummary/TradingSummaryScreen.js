                        ...
                        <View style={{ flex: 1 }}>
                            <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                                ...
                                <View style={{ flexDirection: 'row', alignItems: 'center', alignContent: 'center' }}>
                                    ...
                                    <TextViewMR style={{ color: TrnType.toLowerCase().includes('BUY'.toLowerCase()) ? R.colors.buyerGreen : R.colors.sellerPink, fontSize: R.dimens.smallText, marginLeft: R.dimens.widgetMargin }}>{TrnType ? TrnType : '-'}</TextViewMR>
                                    <TextViewMR style={{ fontSize: R.dimens.smallestText, color: TrnType.toLowerCase().includes('BUY'.toLowerCase()) ? R.colors.buyerGreen : R.colors.sellerPink }}>{' - '}{OrderType ? OrderType : '-'}</TextViewMR>
                                </View>
                                <ImageTextButton
