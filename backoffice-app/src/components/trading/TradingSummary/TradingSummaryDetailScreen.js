...
class TradingSummaryDetailScreen extends Component {
    ...
    render() {
        ...
        let fColor = this.state.item.TrnType.toLowerCase().includes(R.strings.buy.toLowerCase()) ? R.colors.buyerGreen : R.colors.sellerPink;
                                ...
                                <View>
                                    ...
                                    <View style={{ flexDirection: 'row', margin: R.dimens.widgetMargin, }}>
                                        ...
                                        <View style={{ flex: 1, paddingLeft: R.dimens.WidgetPadding, flexDirection: 'column' }}>
                                            ...
                                            <TextViewMR style={{ color: fColor, fontSize: R.dimens.mediumText }}>{this.state.item.TrnType}</TextViewMR>
                                        </View>
                                    </View>
...
class TradingSummaryDetailItem extends Component {
    ...
    render() {
        ...
        let fColor = item.TrnType.toLowerCase().includes(R.strings.buy.toLowerCase()) ? R.colors.buyerGreen : R.colors.sellerPink;
