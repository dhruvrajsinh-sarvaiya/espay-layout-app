                    ...
                    <CardView style={{
                        ...
                        <View style={{
                            ...
                            <View>
                                ...
                                <View style={{width: R.dimens.signup_screen_logo_height,height: R.dimens.signup_screen_logo_height,
                            ...
                            <View style={{ flex: 1, paddingLeft: R.dimens.WidgetPadding }}>
                                <Text style={{ color: R.colors.textPrimary,
                                     fontSize: R.dimens.mediumText, fontFamily: Fonts.MontserratSemiBold, }}>{this.state.item.PairName ? this.state.item.PairName.replace('_', '/') : '-'} </Text>
