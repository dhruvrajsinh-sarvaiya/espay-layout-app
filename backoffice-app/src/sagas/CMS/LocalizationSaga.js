...
function* getCountryListApiData({ payload }) {
    try {
        ...
        if (payload.all)
            ...
            url = Method.listCountry + '/' + payload.PageIndex + '/' + payload.PageSize + '/' +  (payload.search && payload.search != '' ? payload.search : null) + '/' + 'countryName' + '/' + 1
...
function* getStateApiData({ payload }) {
    try {
        ...
        let url = Method.listState + '/' + payload.PageIndex + '/' + payload.PageSize + '/' +  (payload.search && payload.search != '' ? payload.search : null) + '/' + 'stateId' + '/' + 1
...
function* getCityListApiData({ payload }) {
    try {
        ...
        if (payload.all)
            ...
            url = Method.listCity + '/' + payload.PageIndex + '/' + payload.PageSize + '/' +  (payload.search && payload.search != '' ? payload.search : null) + '/' + 'cityId' + '/' + 1
...
function* getZipCodeListApiData({ payload }) {
    try {
        ...
        if (payload.all)
            ...
            url = Method.listZipcodes + '/' + payload.PageIndex + '/' + payload.PageSize + '/' + (payload.search && payload.search != '' ? payload.search : null) + '/' + 'zipcodesId' + '/' + 1
