...
export default class Dropdown extends PureComponent {
    ...
    componentWillReceiveProps({ data, value }) {
        ...
        // if old props and new props of data is different
        ...
        // if old props and new props of value is different
        if (value !== this.props.value) {
            ...
            if (data !== undefined && data.length > 0) {
                ...
                this.setState({ value, selectedIndex: selectedIndex > -1 ? selectedIndex : 0 });
            }
        }
    }
