...
/* const SurveyIndex = require('../webviews/surveyIndex.android.html') */
...
try {
  ...
  if (scriptURL.indexOf('file://') > -1) {
    ...
    const name = 'webviews/surveyIndex.android.html';
  ...
  render() {
    return (
      <WebViewBridge ref={cmp => this.webviewbridge = cmp}
        ...
        source={{ uri: Platform.OS === 'android' ? 'file:///android_asset/Survey/survey.html' : './external/widget/survey.html' }}
