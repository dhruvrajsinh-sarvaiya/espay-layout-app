...
class ArbitrageTransactionHistory extends Component {
	...
	componentWillReceiveProps(nextprops){		
		...
		if(this.state.getTransactionHistory && nextprops.transactionList.length ==0){
		...
		if(nextprops.transactionList.length !==0 && this.state.getTransactionHistory){
			this.setState({
...
const mapStateToProps = ({ transactionHistory,arbitrageOrderBook , settings }) => {
	...
	return { transactionList,arbitragePairList, loading , darkMode,errorCode }
}

// export this component with action methods and props
export default connect(mapStateToProps, { transactionHistory, transactionHistoryRefresh,getArbitragePairList })(injectIntl(ArbitrageTransactionHistory));
