			...
			<div className="page-container">
				<div className="container">
					<div className="row statistics-widget">
						<div className="col">
							<a href="#" className="statistics-widget-link">
								<div className="statistics-widget-grid">
									<div className="content">
										<h5>BNB/BTC</h5>
										<h6><strong className="green-color">0.08735613</strong> $0.05</h6>
										<p>Volume : 2,290.87 BTC</p>
									</div>
									<span className="status green-color">1.68%</span>
									<div className="chart-bar">
										<svg version="1.1" className="highcharts-root" xmlns="http://www.w3.org/2000/svg">
						...
						<div className="col">
							<a href="#" className="statistics-widget-link">
								<div className="statistics-widget-grid">
									<div className="content">
										<h5>TRX/BTC</h5>
										<h6><strong>0.08735613</strong> $0.05</h6>
										<p>Volume : 2,290.87 BTC</p>
									</div>
									<span className="status red-color">-1.12%</span>
									<div className="chart-bar">
										<svg version="1.1" className="highcharts-root" xmlns="http://www.w3.org/2000/svg">
											<g transform="translate(0.5,0.5)">
						...
						<div className="col">
							<a href="#" className="statistics-widget-link">
								<div className="statistics-widget-grid">
									<div className="content">
										<h5>RPX/BTC</h5>
										<h6><strong className="red-color">0.08735613</strong> $0.05</h6>
										<p>Volume : 2,290.87 BTC</p>
									</div>
									<span className="status green-color">1.89%</span>
									<div className="chart-bar">
										<svg version="1.1" className="highcharts-root" xmlns="http://www.w3.org/2000/svg">
											<g transform="translate(0.5,0.5)">
						...
						<div className="col">
							<a href="#" className="statistics-widget-link">
								<div className="statistics-widget-grid">
									...
									<span className="status red-color">-2.68%</span>
									<div className="chart-bar">
										<svg version="1.1" className="highcharts-root" xmlns="http://www.w3.org/2000/svg">
											<g transform="translate(0.5,0.5)">
							...
							<a href="#" className="statistics-widget-link">
								<div className="statistics-widget-grid">
									...
									<div className="chart-bar">
										<svg version="1.1" className="highcharts-root" xmlns="http://www.w3.org/2000/svg">
											<g transform="translate(0.5,0.5)">
												<path id="NEOBTC" stroke="rgba(244,220,174,1)" fill="none" stroke-width="1" d="M0 16 L10 23 L20 22 L30 26 L40 33 L50 32 L60 34 L70 35 L80 39 L90 39 L100 40 L110 40 L120 31 L130 25 L140 25 L150 28 L160 25 L170 23 L180 14 L190 16 L200 11 L210 14 L220 21 L230 0"></path>
												<path id="NEOBTCfill" fill="rgba(254,251,245,1)" stroke="none" d="M0 40 L0 16 L10 23 L20 22 L30 26 L40 33 L50 32 L60 34 L70 35 L80 39 L90 39 L100 40 L110 40 L120 31 L130 25 L140 25 L150 28 L160 25 L170 23 L180 14 L190 16 L200 11 L210 14 L220 21 L230 0 L230 40"></path>
											</g>
										</svg>
									</div>
								</div>
