...
import { Table, Input, Nav, NavItem, NavLink } from "reactstrap";
...
class FavouriteList extends React.Component {
    ...
    render() {
        ...
        return (
            <div className="jbs-block col-sm-12 col-md-12 col-lg-12 d-sm-half d-md-full p-5">
                ...
                <div
                    className="table-responsive-design p-5"
                    style={{ width: "100%" }}
                >
