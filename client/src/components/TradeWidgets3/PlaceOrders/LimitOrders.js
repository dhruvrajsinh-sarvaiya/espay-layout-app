...
class LimitOrder extends React.Component {
    state = {
        ...
        priceBuy: this.props.currentPrice.LastPrice
            ? parseFloat(this.props.currentPrice.LastPrice).toFixed(8)
            : parseFloat(0).toFixed(8),
        amountBuy: "",
        totalBuy: "",

        priceSell: this.props.currentPrice.LastPrice
            ? parseFloat(this.props.currentPrice.LastPrice).toFixed(8)
            : parseFloat(0).toFixed(8),
        amountSell: "",
        totalSell: "",
    ...
    componentWillReceiveProps(nextprops) {
        if (
            ...
            this.setState({
                priceBuy: parseFloat(nextprops.currentPrice.LastPrice).toFixed(
                    8
                ),
                priceSell: parseFloat(nextprops.currentPrice.LastPrice).toFixed(
                    8
                ),
        ...
        if (
            ...
            if (
                nextprops.bulkBuyOrder.Price !==
                this.props.bulkBuyOrder.Price &&
                nextprops.bulkBuyOrder.Amount !==
                this.props.bulkBuyOrder.Amount &&
                nextprops.bulkBuyOrder.Total !== this.props.bulkBuyOrder.Total
            ) {
                this.setState({
                    priceBuy: parseFloat(nextprops.bulkBuyOrder.Price).toFixed(
                        8
                    ),
        ...
        if (
            ...
            if (
                nextprops.bulkSellOrder.Price !==
                this.props.bulkSellOrder.Price &&
                nextprops.bulkSellOrder.Amount !==
                this.props.bulkSellOrder.Amount &&
    ...
    doSellOrder = (event) => {
        ...
        if (
            ...
            NotificationManager.error(
                <IntlMessages id="error.trading.transaction.4607" />
            );
        } else if (
            this.state.amountSell === "" ||
    ...
    render() {
        ...
        return (
            <div className="p-0 d-flex pb-30">
