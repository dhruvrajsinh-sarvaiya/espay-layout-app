                    ...
                    value.PairList.map((newPairItem, indexValue) => {
                        ...
                        if (this.state.searchText !== '') {
                            if (newPairItem.Abbrevation.toLowerCase().indexOf(this.state.searchText) != -1
                                ...
                                var findIndexValuePriceSearchPair = oldPairLists.findIndex(oldPairItem => oldPairItem.CurrentRate === newPairItem.CurrentRate);
                                var lastPrice = 0;
                                ...
                                if (findIndexValuePriceSearchPair !== -1) {
                                    lastPrice = oldPairLists[findIndexValuePriceSearchPair].CurrentRate;
                                }
