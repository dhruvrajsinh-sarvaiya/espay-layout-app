...
import { affiliateShareOnFacebookReport } from 'Actions/MyAccount';
        ...
        const options = {
            ...
            onTableChange: (action, tableState) => {
                if (action === 'changeRowsPerPage' || action === 'changePage') {
                    this.getFacebookShareList(tableState.page, tableState.rowsPerPage);
                }
            },
            downloadOptions: {
        ...
        return (
            <Fragment>
                ...
                <div className="StackingHistory">
                    <MUIDataTable
                        // title={<IntlMessages id="sidebar.facebookShareReport" />}
                        columns={columns}
                        options={options}
