...
exports.validateFaqQuestionInput = function (data) {
  ...
  if (data === undefined) {
    ...
    Object.keys(data.locale).forEach((lg, index) => {
      ...
      if ((data.locale[lg].question) === undefined || !(data.locale[lg].question) || (data.locale[lg].question) == "" || data.locale[lg].question.length == 0 || validator.isEmpty(data.locale[lg].question.trim() + '')) {
        errors[lg].question = 'faq.questionform.error.question';
        localeerror = true;
      }

      if ((data.locale[lg].answer) === undefined || !(data.locale[lg].answer) || (data.locale[lg].answer) == "" || data.locale[lg].answer.length == 0 || validator.isEmpty(data.locale[lg].answer.trim() + '')) {
    ...
    if ((data.category_id) !== undefined && validator.isEmpty(data.category_id)) {
...
exports.validateGetFaqQuestionByIdInput = function (data) {
  ...
  if (data.faqquestionId == undefined || !data.faqquestionId || data.faqquestionId == "" || data.faqquestionId.length == 0 || validator.isEmpty(data.faqquestionId + '')) {
...
exports.validateDeleteFaqQuestionInput = function (data) {
  ...
  if (data.faqquestionId == undefined || !data.faqquestionId || data.faqquestionId == "" || data.faqquestionId.length == 0) {
    errors.message = 'faq.questionform.error.questionidrequired';
