...
exports.validateCoinListRequestFormInput = function (requestdata, coinListFields) {
    ...
    if (typeof requestdata.coinListdata == 'undefined' || typeof requestdata.coinListdata.coinFields == 'undefined') {
        ...
        if (coinListFields.findIndex(coinListformField => (coinListformField.key === "coin_name")) != -1 && coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "coin_name"))].status == 1) {
            ...
            if (coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "coin_name"))].Isrequired == 1 && (data.coin_name == undefined || data.coin_name == "" || data.coin_name.length == 0 || Validator.isEmpty(data.coin_name.trim() + ''))) {
        ...
        if (coinListFields.findIndex(coinListformField => (coinListformField.key === "coin_ticker")) != -1 && coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "coin_ticker"))].status == 1) {
            ...
            if (coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "coin_ticker"))].Isrequired == 1 && (data.coin_ticker == undefined || data.coin_ticker == "" || data.coin_ticker.length == 0 || Validator.isEmpty(data.coin_ticker.trim() + ''))) {
        ...
        if (coinListFields.findIndex(coinListformField => (coinListformField.key === "date_of_issuance")) != -1 && coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "date_of_issuance"))].status == 1) {
            if (coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "date_of_issuance"))].Isrequired == 1 && (data.date_of_issuance == undefined || data.date_of_issuance == "" || data.date_of_issuance.length == 0 || Validator.isEmpty(data.date_of_issuance.trim() + ''))) {
        ...
        if (coinListFields.findIndex(coinListformField => (coinListformField.key === "coin_logo")) != -1 && coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "coin_logo"))].status == 1) {
            ...
            if (coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "coin_logo"))].Isrequired == 1 && (data.coin_logo == undefined || data.coin_logo == "" || data.coin_logo.length == 0 || Validator.isEmpty(data.coin_logo.trim() + ''))) {
        ...
        if (coinListFields.findIndex(coinListformField => (coinListformField.key === "coin_website")) != -1 && coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "coin_website"))].status == 1) {
            if (coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "coin_website"))].Isrequired == 1 && (data.coin_website == undefined || data.coin_website == "" || data.coin_website.length == 0 || Validator.isEmpty(data.coin_website.trim() + ''))) {
        ...
        if (coinListFields.findIndex(coinListformField => (coinListformField.key === "website_faq")) != -1 && coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "website_faq"))].status == 1) {
            if (coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "website_faq"))].Isrequired == 1 && (data.website_faq == undefined || data.website_faq == "" || data.website_faq.length == 0 || Validator.isEmpty(data.website_faq.trim() + ''))) {
        ...
        if (coinListFields.findIndex(coinListformField => (coinListformField.key === "coin_forum")) != -1 && coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "coin_forum"))].status == 1) {
            if (coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "coin_forum"))].Isrequired == 1 && (data.coin_forum == undefined || data.coin_forum == "" || data.coin_forum.length == 0 || Validator.isEmpty(data.coin_forum.trim() + ''))) {
        ...
        if (coinListFields.findIndex(coinListformField => (coinListformField.key === "bitcoin_talk")) != -1 && coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "bitcoin_talk"))].status == 1) {
            if (coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "bitcoin_talk"))].Isrequired == 1 && (data.bitcoin_talk == undefined || data.bitcoin_talk == "" || data.bitcoin_talk.length == 0 || Validator.isEmpty(data.bitcoin_talk.trim() + ''))) {
        ...
        if (coinListFields.findIndex(coinListformField => (coinListformField.key === "whitepaper_business")) != -1 && coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "whitepaper_business"))].status == 1) {
            if (coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "whitepaper_business"))].Isrequired == 1 && (data.whitepaper_business == undefined || data.whitepaper_business == "" || data.whitepaper_business.length == 0 || Validator.isEmpty(data.whitepaper_business.trim() + ''))) {
        ...
        if (coinListFields.findIndex(coinListformField => (coinListformField.key === "whitepaper_technical")) != -1 && coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "whitepaper_technical"))].status == 1) {
            if (coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "whitepaper_technical"))].Isrequired == 1 && (data.whitepaper_technical == undefined || data.whitepaper_technical == "" || data.whitepaper_technical.length == 0 || Validator.isEmpty(data.whitepaper_technical.trim() + ''))) {
        ...
        if (coinListFields.findIndex(coinListformField => (coinListformField.key === "stack_channel")) != -1 && coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "stack_channel"))].status == 1) {
            if (coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "stack_channel"))].Isrequired == 1 && (data.stack_channel == undefined || data.stack_channel == "" || data.stack_channel.length == 0 || Validator.isEmpty(data.stack_channel.trim() + ''))) {
        ...
        if (coinListFields.findIndex(coinListformField => (coinListformField.key === "official_gitHub_repository_link")) != -1 && coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "official_gitHub_repository_link"))].status == 1) {
            if (coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "official_gitHub_repository_link"))].Isrequired == 1 && (data.official_gitHub_repository_link == undefined || data.official_gitHub_repository_link == "" || data.official_gitHub_repository_link.length == 0 || Validator.isEmpty(data.official_gitHub_repository_link.trim() + ''))) {
        ...
        if (coinListFields.findIndex(coinListformField => (coinListformField.key === "team_contact")) != -1 && coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "team_contact"))].status == 1) {
            if (coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "team_contact"))].Isrequired == 1 && (data.team_contact == undefined || data.team_contact == "" || data.team_contact.length == 0 || Validator.isEmpty(data.team_contact.trim() + ''))) {
        ...
        if (coinListFields.findIndex(coinListformField => (coinListformField.key === "team_bio")) != -1 && coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "team_bio"))].status == 1) {
            if (coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "team_bio"))].Isrequired == 1 && (data.team_bio == undefined || data.team_bio == "" || data.team_bio.length == 0 || Validator.isEmpty(data.team_bio.trim() + ''))) {
        ...
        if (coinListFields.findIndex(coinListformField => (coinListformField.key === "wallet_source_code")) != -1 && coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "wallet_source_code"))].status == 1) {
            if (coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "wallet_source_code"))].Isrequired == 1 && (data.wallet_source_code == undefined || data.wallet_source_code == "" || data.wallet_source_code.length == 0 || Validator.isEmpty(data.wallet_source_code.trim() + ''))) {
        ...
        if (coinListFields.findIndex(coinListformField => (coinListformField.key === "node_source_code")) != -1 && coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "node_source_code"))].status == 1) {
            if (coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "node_source_code"))].Isrequired == 1 && (data.node_source_code == undefined || data.node_source_code == "" || data.node_source_code.length == 0 || Validator.isEmpty(data.node_source_code.trim() + ''))) {
        ...
        if (coinListFields.findIndex(coinListformField => (coinListformField.key === "official_blockchain_explorer_link")) != -1 && coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "official_blockchain_explorer_link"))].status == 1) {
            if (coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "official_blockchain_explorer_link"))].Isrequired == 1 && (data.official_blockchain_explorer_link == undefined || data.official_blockchain_explorer_link == "" || data.official_blockchain_explorer_link.length == 0 || Validator.isEmpty(data.official_blockchain_explorer_link.trim() + ''))) {
        ...
        if (coinListFields.findIndex(coinListformField => (coinListformField.key === "max_coin_supply")) != -1 && coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "max_coin_supply"))].status == 1) {
            if (coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "max_coin_supply"))].Isrequired == 1 && (data.max_coin_supply == undefined || data.max_coin_supply == "" || data.max_coin_supply.length == 0 || Validator.isEmpty(data.max_coin_supply.trim() + ''))) {
        ...
        if (coinListFields.findIndex(coinListformField => (coinListformField.key === "tx_Fee_for_transaction")) != -1 && coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "tx_Fee_for_transaction"))].status == 1) {
            if (coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "tx_Fee_for_transaction"))].Isrequired == 1 && (data.tx_Fee_for_transaction == undefined || data.tx_Fee_for_transaction == "" || data.tx_Fee_for_transaction.length == 0 || Validator.isEmpty(data.tx_Fee_for_transaction.trim() + ''))) {
        ...
        if (coinListFields.findIndex(coinListformField => (coinListformField.key === "social_media_links")) != -1 && coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "social_media_links"))].status == 1) {
            if (coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "social_media_links"))].Isrequired == 1 && (data.social_media_links == undefined || data.social_media_links == "" || Validator.isEmpty(data.social_media_links.trim() + ''))) {
        ...
        if (coinListFields.findIndex(coinListformField => (coinListformField.key === "deployment_process")) != -1 && coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "deployment_process"))].status == 1) {
            if (coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "deployment_process"))].Isrequired == 1 && (data.deployment_process == undefined || data.deployment_process == "" || data.deployment_process.length == 0 || Validator.isEmpty(data.deployment_process.trim() + ''))) {
        ...
        if (coinListFields.findIndex(coinListformField => (coinListformField.key === "premined_coin_amount")) != -1 && coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "premined_coin_amount"))].status == 1) {
            if (coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "premined_coin_amount"))].Isrequired == 1 && (data.premined_coin_amount == undefined || data.premined_coin_amount == "" || data.premined_coin_amount.length == 0 || Validator.isEmpty(data.premined_coin_amount.trim() + ''))) {
        ...
        if (coinListFields.findIndex(coinListformField => (coinListformField.key === "premined_coin_in_escrow")) != -1 && coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "premined_coin_in_escrow"))].status == 1) {
            if (coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "premined_coin_in_escrow"))].Isrequired == 1 && (data.premined_coin_in_escrow == undefined || data.premined_coin_in_escrow == "" || data.premined_coin_in_escrow.length == 0 || Validator.isEmpty(data.premined_coin_in_escrow.trim() + ''))) {
        ...
        if (coinListFields.findIndex(coinListformField => (coinListformField.key === "number_of_addresses_coins_were_distributed")) != -1 && coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "number_of_addresses_coins_were_distributed"))].status == 1) {
            ...
            if (coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "number_of_addresses_coins_were_distributed"))].Isrequired == 1 && (data.number_of_addresses_coins_were_distributed == undefined || data.number_of_addresses_coins_were_distributed == "" || data.number_of_addresses_coins_were_distributed.length == 0 || Validator.isEmpty(data.number_of_addresses_coins_were_distributed.trim() + ''))) {
        ...
        if (coinListFields.findIndex(coinListformField => (coinListformField.key === "segwit_exhibition")) != -1 && coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "segwit_exhibition"))].status == 1) {
            if (coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "segwit_exhibition"))].Isrequired == 1 && (data.segwit_exhibition == undefined || data.segwit_exhibition == "" || data.segwit_exhibition.length == 0 || Validator.isEmpty(data.segwit_exhibition.trim() + ''))) {
        ...
        if (coinListFields.findIndex(coinListformField => (coinListformField.key === "blockspeed")) != -1 && coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "blockspeed"))].status == 1) {
            if (coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "blockspeed"))].Isrequired == 1 && (data.blockspeed == undefined || data.blockspeed == "" || data.blockspeed.length == 0 || Validator.isEmpty(data.blockspeed.trim() + ''))) {
        ...
        if (coinListFields.findIndex(coinListformField => (coinListformField.key === "core_algorithm")) != -1 && coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "core_algorithm"))].status == 1) {
            if (coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "core_algorithm"))].Isrequired == 1 && (data.core_algorithm == undefined || data.core_algorithm == "" || data.core_algorithm.length == 0 || Validator.isEmpty(data.core_algorithm.trim() + ''))) {
        ...
        if ((coinListFields.findIndex(coinListformField => (coinListformField.key === "amount_raised_during_pre_ico")) != -1 && coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "amount_raised_during_pre_ico"))].status == 1)) {
            if (coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "core_algorithm"))].Isrequired == 1 && (data.amount_raised_during_pre_ico == undefined || data.amount_raised_during_pre_ico == "" || data.amount_raised_during_pre_ico == null)) {
        ...
        if (coinListFields.findIndex(coinListformField => (coinListformField.key === "Advisory")) != -1 && coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "Advisory"))].status == 1) {
            if (coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "Advisory"))].Isrequired == 1 && (data.advisory == undefined || data.advisory == "" || data.advisory.length == 0 || Validator.isEmpty(data.advisory.trim() + ''))) {
        ...
        if (coinListFields.findIndex(coinListformField => (coinListformField.key === "number_of_blocks_mined")) != -1 && coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "number_of_blocks_mined"))].status == 1) {
            if (coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "number_of_blocks_mined"))].Isrequired == 1 && (data.number_of_blocks_mined == undefined || data.number_of_blocks_mined == "" || data.number_of_blocks_mined.length == 0 || Validator.isEmpty(data.number_of_blocks_mined.trim() + ''))) {
        ...
        if (coinListFields.findIndex(coinListformField => (coinListformField.key === "dev_language")) != -1 && coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "dev_language"))].status == 1) {
            if (coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "dev_language"))].Isrequired == 1 && (data.dev_language == undefined || data.dev_language == "" || data.dev_language.length == 0 || Validator.isEmpty(data.dev_language.trim() + ''))) {
        ...
        if (coinListFields.findIndex(coinListformField => (coinListformField.key === "erc_20_compliant")) != -1 && coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "erc_20_compliant"))].status == 1) {
            if (coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "erc_20_compliant"))].Isrequired == 1 && (data.erc_20_compliant == undefined || data.erc_20_compliant == "" || data.erc_20_compliant.length == 0 || Validator.isEmpty(data.erc_20_compliant.trim() + ''))) {
        ...
        if (coinListFields.findIndex(coinListformField => (coinListformField.key === "difficulty")) != -1 && coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "difficulty"))].status == 1) {
            if (coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "difficulty"))].Isrequired == 1 && (data.difficulty == undefined || data.difficulty == "" || data.difficulty.length == 0 || Validator.isEmpty(data.difficulty.trim() + ''))) {
        ...
        if (coinListFields.findIndex(coinListformField => (coinListformField.key === "wallet")) != -1 && coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "wallet"))].status == 1) {
            if (coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "wallet"))].Isrequired == 1 && (data.wallet == undefined || data.wallet == "" || data.wallet.length == 0 || Validator.isEmpty(data.wallet.trim() + ''))) {
        ...
        if (coinListFields.findIndex(coinListformField => (coinListformField.key === "usual_cost")) != -1 && coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "usual_cost"))].status == 1) {
            if (coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "usual_cost"))].Isrequired == 1 && (data.usual_cost == undefined || data.usual_cost == "" || data.usual_cost.length == 0 || Validator.isEmpty(data.usual_cost.trim() + ''))) {
        ...
        if (coinListFields.findIndex(coinListformField => (coinListformField.key === "if_this_coin_is_a_security")) != -1 && coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "if_this_coin_is_a_security"))].status == 1) {
            if (coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "if_this_coin_is_a_security"))].Isrequired == 1 && (data.if_this_coin_is_a_security == undefined || data.if_this_coin_is_a_security == "" || data.if_this_coin_is_a_security.length == 0 || Validator.isEmpty(data.if_this_coin_is_a_security.trim() + ''))) {
        ...
        if (coinListFields.findIndex(coinListformField => (coinListformField.key === "coin_type")) != -1 && coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "coin_type"))].status == 1) {
            if (coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "coin_type"))].Isrequired == 1 && (data.coin_type == undefined || data.coin_type == "" || data.coin_type.length == 0 || Validator.isEmpty(data.coin_type.trim() + ''))) {
        ...
        if (coinListFields.findIndex(coinListformField => (coinListformField.key === "coin_description")) != -1 && coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "coin_description"))].status == 1) {
            if (coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "coin_description"))].Isrequired == 1 && (data.coin_description == undefined || data.coin_description == "" || data.coin_description.length == 0 || Validator.isEmpty(data.coin_description.trim() + ''))) {
        ...
        if (coinListFields.findIndex(coinListformField => (coinListformField.key === "coin_short_name")) != -1 && coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "coin_short_name"))].status == 1) {
            if (coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "coin_short_name"))].Isrequired == 1 && (data.coin_short_name == undefined || data.coin_short_name == "" || data.coin_short_name.length == 0 || Validator.isEmpty(data.coin_short_name.trim() + ''))) {
        ...
        if (coinListFields.findIndex(coinListformField => (coinListformField.key === "coin_address")) != -1 && coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "coin_address"))].status == 1) {
            if (coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "coin_address"))].Isrequired == 1 && (data.coin_address == undefined || data.coin_address == "" || data.coin_address.length == 0 || Validator.isEmpty(data.coin_address.trim() + ''))) {
        ...
        if (coinListFields.findIndex(coinListformField => (coinListformField.key === "decimal")) != -1 && coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "decimal"))].status == 1) {
            if (coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "decimal"))].Isrequired == 1 && (data.decimal == undefined || data.decimal == "" || data.decimal.length == 0 || Validator.isEmpty(data.decimal.trim() + ''))) {
        ...
        if (coinListFields.findIndex(coinListformField => (coinListformField.key === "total_supply")) != -1 && coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "total_supply"))].status == 1) {
            if (coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "total_supply"))].Isrequired == 1 && (data.total_supply == undefined || data.total_supply == "" || data.total_supply.length == 0 || Validator.isEmpty(data.total_supply.trim() + ''))) {
        ...
        if (coinListFields.findIndex(coinListformField => (coinListformField.key === "circulating_supply")) != -1 && coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "circulating_supply"))].status == 1) {
            if (coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "circulating_supply"))].Isrequired == 1 && (data.circulating_supply == undefined || data.circulating_supply == "" || data.circulating_supply.length == 0 || Validator.isEmpty(data.circulating_supply.trim() + ''))) {
        ...
        if (coinListFields.findIndex(coinListformField => (coinListformField.key === "first_name")) != -1 && coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "first_name"))].status == 1) {
            if (coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "first_name"))].Isrequired == 1 && (data.first_name == undefined || data.first_name == "" || data.first_name.length == 0 || Validator.isEmpty(data.first_name.trim() + ''))) {
        ...
        if (coinListFields.findIndex(coinListformField => (coinListformField.key === "last_name")) != -1 && coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "last_name"))].status == 1) {
            if (coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "last_name"))].Isrequired == 1 && (data.last_name == undefined || data.last_name == "" || data.last_name.length == 0 || Validator.isEmpty(data.last_name.trim() + ''))) {
        ...
        if (coinListFields.findIndex(coinListformField => (coinListformField.key === "address")) != -1 && coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "address"))].status == 1) {
            if (coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "address"))].Isrequired == 1 && (data.address == undefined || data.address == "" || data.address.length == 0 || Validator.isEmpty(data.address.trim() + ''))) {
        ...
        if (coinListFields.findIndex(coinListformField => (coinListformField.key === "address_line_2")) != -1 && coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "address_line_2"))].status == 1) {
            if (coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "address_line_2"))].Isrequired == 1 && (data.address_line_2 == undefined || data.address_line_2 == "" || data.address_line_2.length == 0 || Validator.isEmpty(data.address_line_2.trim() + ''))) {
        ...
        if (coinListFields.findIndex(coinListformField => (coinListformField.key === "city")) != -1 && coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "city"))].status == 1) {
            if (coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "city"))].Isrequired == 1 && (data.city == undefined || data.city == "" || data.city.length == 0 || Validator.isEmpty(data.city.trim() + ''))) {
        ...
        if (coinListFields.findIndex(coinListformField => (coinListformField.key === "state")) != -1 && coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "state"))].status == 1) {
            if (coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "state"))].Isrequired == 1 && (data.state == undefined || data.state == "" || data.state.length == 0 || Validator.isEmpty(data.state.trim() + ''))) {
        ...
        if (coinListFields.findIndex(coinListformField => (coinListformField.key === "country")) != -1 && coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "country"))].status == 1) {
            if (coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "country"))].Isrequired == 1 && (data.country == undefined || data.country == "" || data.country.length == 0 || Validator.isEmpty(data.country.trim() + ''))) {
        ...
        if (coinListFields.findIndex(coinListformField => (coinListformField.key === "phone")) != -1 && coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "phone"))].status == 1) {
            if (coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "phone"))].Isrequired == 1 && (data.phone == undefined || data.phone == "" || data.phone == null)) {
        ...
        if (coinListFields.findIndex(coinListformField => (coinListformField.key === "email")) != -1 && coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "email"))].status == 1) {
            ...
            if (coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "email"))].Isrequired == 1 && (data.email == undefined || data.email == "" || data.email.length == 0 || Validator.isEmpty(data.email.trim() + ''))) {
        ...
        if (coinListFields.findIndex(coinListformField => (coinListformField.key === "project_name")) != -1 && coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "project_name"))].status == 1) {
            if (coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "project_name"))].Isrequired == 1 && (data.project_name == undefined || data.project_name == "" || data.project_name.length > 0 && Validator.isEmpty(data.project_name.trim() + ''))) {
        ...
        if (coinListFields.findIndex(coinListformField => (coinListformField.key === "project_website_link")) != -1 && coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "project_website_link"))].status == 1) {
            if (coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "project_website_link"))].Isrequired == 1 && (data.project_website_link == undefined || data.project_website_link == "" || data.project_website_link == null)) {
        ...
        if (coinListFields.findIndex(coinListformField => (coinListformField.key === "do_you_have_an_active_community")) != -1 && coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "do_you_have_an_active_community"))].status == 1) {
            if (coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "do_you_have_an_active_community"))].Isrequired == 1 && (data.do_you_have_an_active_community == undefined || data.do_you_have_an_active_community == "" || data.do_you_have_an_active_community.length == 0 || Validator.isEmpty(data.do_you_have_an_active_community.trim() + ''))) {
        ...
        if (coinListFields.findIndex(coinListformField => (coinListformField.key === "information_on_how_funds_were_raised")) != -1 && coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "information_on_how_funds_were_raised"))].status == 1) {
            if (coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "information_on_how_funds_were_raised"))].Isrequired == 1 && (data.information_on_how_funds_were_raised == undefined || data.information_on_how_funds_were_raised == "" || data.information_on_how_funds_were_raised.length == 0 || Validator.isEmpty(data.information_on_how_funds_were_raised.trim() + ''))) {
        ...
        if (coinListFields.findIndex(coinListformField => (coinListformField.key === "current_listing_on_other_exchanges")) != -1 && coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "current_listing_on_other_exchanges"))].status == 1) {
            if (coinListFields[coinListFields.findIndex(coinListformField => (coinListformField.key === "current_listing_on_other_exchanges"))].Isrequired == 1 && (data.current_listing_on_other_exchanges == undefined || data.current_listing_on_other_exchanges == "" || data.current_listing_on_other_exchanges.length == 0 || Validator.isEmpty(data.current_listing_on_other_exchanges.trim() + ''))) {
