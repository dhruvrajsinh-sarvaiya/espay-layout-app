...
exports.validateAddStateInput = function (data) {
	...
	if (typeof data == 'undefined') {
		...
		if (data.stateCode == undefined || data.stateCode == "" || data.stateCode.length == 0 || Validator.isEmpty(data.stateCode.trim() + '')) {
...
exports.validateUpdateStateInput = function (data) {
	...
	if (typeof data == 'undefined') {
		...
		if (data.status == undefined || data.status == "" || data.status.length == 0) {
			errors.status = 'states.stateform.error.statusReq';
