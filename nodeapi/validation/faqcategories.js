...
exports.validateFaqCategoryInput = function (data) {
  ...
  if (data === undefined) {
    ...
    Object.keys(data.locale).forEach((lg, index) => {
      ...
      if ((data.locale[lg].category_name) === undefined || !(data.locale[lg].category_name) || (data.locale[lg].category_name) == "" || data.locale[lg].category_name.length == 0 || validator.isEmpty(data.locale[lg].category_name + '')) {
...
exports.validateGetFaqcategoryByIdInput = function (data) {
  ...
  if (data.faqcategoryId == undefined || !data.faqcategoryId || data.faqcategoryId == "" || data.faqcategoryId.length == 0 || validator.isEmpty(data.faqcategoryId + '')) {
