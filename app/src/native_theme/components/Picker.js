        ...
        if (props.searchable !== undefined && props.searchable) {
            ...
            return (
                <Dropdown
                    ...
                    itemColor={props.isolateSelection !== undefined && props.isolateSelection ? R.colors.textSecondary : R.colors.textPrimary}
                    ...
                    renderBase={props.renderBase == null ? () => <MainRenderItem isGradient={props.isGradient} arrowStyle={props.arrowStyle} title={props.value ? props.value : ''} displayArrow={props.displayArrow} style={props.renderItemStyle} textStyle={props.renderItemTextStyle} /> : props.renderBase}
                    containerStyle={{ width: props.width }}
                    dropDownTextStyle={{ fontSize: R.dimens.smallText, fontFamily: Fonts.HindmaduraiLight }}
                />
            );
        }
    }
