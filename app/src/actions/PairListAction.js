...
export function getCurrencyListFailure(error) { return action(GET_CURRENCY_LIST_FAILURE, { error }); }
...
export function getWalletsFailure(error) {
  return action(FETCH_WALLET_LIST_FAILURE, { error })
}
