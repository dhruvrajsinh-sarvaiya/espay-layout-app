...
export function getReferralChannelUserCountFailure() {
	return action(GET_REFERRAL_CHANNEL_USER_COUNT_FAILURE)
}
...
export function getReferralUrlFailure() {
	return action(GET_REFERRAL_URL_FAILURE)
}
...
export function getReferralDescriptionDataFailure() {
	return action(GET_REFERRAL_SERVICE_DESCRIPTION_FAILURE)
}
...
export function getReferralCodeFailure() {
	return action(GET_REFERRAL_CODE_FAILURE)
}
...
export function getReferralEmailDataFailure() {
	return action(REFERRAL_EMAIL_SEND_FAILURE)
}
...
export function getReferralSmsDataFailure() {
	return action(REFERRAL_SMS_SEND_FAILURE)
}
