const esES = {
    ...
    invalidAuthenticationLink: 'Enlace de autorización no válido',
    invalidUserLink: 'Este enlace autorizado que utiliza el usuario no es válido.',
    successAuthMessage: 'Has autorizado con éxito un nuevo dispositivo. Por favor, intente iniciar sesión con él de nuevo. Puede iniciar sesión en su Centro de usuarios en el cliente móvil para eliminar en cualquier momento a través de la Administración de dispositivos',
};
