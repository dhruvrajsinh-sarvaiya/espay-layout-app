const ptPT = {
    ...
    invalidAuthenticationLink: 'Link de autorização inválido',
    invalidUserLink: 'Este link autorizado usando o usuário não é válido.',
    successAuthMessage: 'Você autorizou com sucesso um novo dispositivo. Por favor, tente fazer o login novamente. Você pode acessar sua Central de usuários no cliente móvel para excluir a qualquer momento através do Gerenciamento de dispositivos',
};
