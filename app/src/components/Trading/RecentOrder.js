...
class RecentOrder extends Component {
	...
	static getDerivedStateFromProps(props, state) {
		...
		if (RecentOrder.oldProps !== props) {
			RecentOrder.oldProps = props;
		} else {
			return null;
		}
	...
	onBottomMorePress() {
		this.props.navigation.navigate('RecentOrder', { PairName: this.state.PairName, ScreenName: 'RecentOrder' })
	}
...
export default connect(mapStatToProps, mapDispatchToProps)(RecentOrder);