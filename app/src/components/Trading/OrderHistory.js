...
class OrderHistory extends Component {
    constructor(props) {
        ...
        this.PairName = props.navigation.state.params.PairName && props.navigation.state.params.PairName
        ...
        if (typeof props.navigation.state.params.isMargin === 'undefined') {
            this.isMargin = getData(ServiceUtilConstant.KEY_IsMargin);
        } else {
            this.isMargin = props.navigation.state.params.isMargin;
        }
        ...
        this.state = {
            from: props.navigation.state.params.from ? props.navigation.state.params.from : 0,
            response: [],
            refreshing: false,
