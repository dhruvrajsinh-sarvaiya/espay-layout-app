...
class Deposit extends Component {
    ...
    constructor(props) {
        ...
        this.onSaveQRCode = this.onSaveQRCode.bind(this);
        //----------
                            ...
                            {this.state.Address ?
                                <CardView style={{ marginTop: R.dimens.padding_top_bottom_margin, flex: 1, alignItems: 'center' }} cardRadius={0}>
                                    <View style={{ alignItems: 'center', justifyContent: 'center', flexDirection: 'column', paddingBottom: R.dimens.margin_top_bottom, paddingTop: R.dimens.margin_top_bottom, paddingLeft: R.dimens.margin, paddingRight: R.dimens.margin }}>
                                        ...
                                        <TextViewHML style={{ fontSize: R.dimens.smallestText, color: R.colors.textPrimary, marginTop: R.dimens.widget_top_bottom_margin, textAlign: 'center' }}>{this.state.Address ? this.state.Address : '-'}</TextViewHML>
                                        {/* For Copy button */}
                                        <CustomButton
                                            isCopyButton={true}
                                            image={false}
