                ...
                <View style={{
                    ...
                    <CardView style={{
                        ...
                        <View style={{ flex: 1, flexDirection: 'row', }}>
                            ...
                            {/* Currency Image */}
                            <ImageViewWidget width={R.dimens.IconWidthHeight} height={R.dimens.IconWidthHeight} url={item.CoinName ? item.CoinName : ''} />
                        ...
                        {item.TrnId ?
                            <View style={{ flex: 1, marginTop: R.dimens.widgetMargin, }}>
                                ...
                                <TextViewHML style={{ marginLeft: R.dimens.widget_left_right_margin, fontSize: R.dimens.smallestText, color: R.colors.textPrimary, }}>{item.TrnId}</TextViewHML>
                            </View> : null
                        }
