						...
						<CardView
							...
							<View style={[{ flex: 1, margin: R.dimens.margin }, this.props.mainviewstyle]}>
								{type == 1 ?
									...
									<View style={[{ flex: 1, justifyContent: 'center', flexDirection: 'column', padding: R.dimens.CardViewElivation, alignItems: 'center', }, (this.props.viewHeight == 0 ? '' : { height: this.props.viewHeight })]}
										onLayout={({ nativeEvent: { layout: { height } } }) => {
