                ...
                try {
                    ...
                    if (validateResponseNew({ response: emaildata, isList: true })) {
                        ...
                        if (ErrorCode == 4036) {
                            ...
                            showAlert(R.strings.failure + '!', stmsg, 1, () => {
                                //reducer data
                                this.props.signUpWithMobileEmailClear();
                            })
                        }
        ...
        return (
            <View style={{ flex: 1, backgroundColor: R.colors.background }}>
                ...
                <InputScrollView keyboardShouldPersistTaps='always' showsVerticalScrollIndicator={false} >
                    ...
                    <View style={{ justifyContent: 'center', flex: 1, paddingLeft: R.dimens.activity_margin, paddingRight: R.dimens.activity_margin, paddingTop: R.dimens.margin_top_bottom }}>
