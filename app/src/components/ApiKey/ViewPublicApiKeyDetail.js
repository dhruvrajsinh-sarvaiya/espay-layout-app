                ...
                try {
                    if (validateResponseNew({ response: apiKeyListByID })) {
                        ...
                        if (state.showSecretKey) {
                            return {
                                ...state, showInfo: true, keyTitle: R.strings.secretKey, showMessage: res.SecretKey
                            }
                        } else {
                            return {
                                ...state, keyTitle: R.strings.apiKey, showInfo: true, showMessage: res.APIKey
                            }
                        }
                    } else {
                        //clear reducer 
                        ...
                        //Set State For Api response 
                        return {
                            ...state, showInfo: false, showMessage: '', keyTitle: '',
                        }
                    }
                } catch (e) {
                    //Set State For Api response 
                    return {
                        ...state, showInfo: false, keyTitle: '', showMessage: ''
                    }
                }
            }
        }
...
class RenderDeleteDialogBox extends Component {
    constructor(props) {
        super(props);
    }
    ...
    render() {
        return (
            <AlertDialog
                ...
                negativeButton={{
                    title: R.strings.cancel, onPress: this.props.onPress
                }}
                positiveButton={{
                    title: R.strings.OK,
                    progressive: false,
                ...
                <View>
                    ...
                    <View style={{ padding: R.dimens.widgetMargin, }}>
                        <View style={{ flexDirection: 'row', }}>
                            <TextViewHML style={{ flex: 1, textAlign: 'left', color: R.colors.textPrimary, fontSize: R.dimens.smallestText, }}> {R.strings.aliasName}</TextViewHML>
                            <TextViewHML style={{ flex: 1, textAlign: 'right', color: R.colors.textPrimary, fontSize: R.dimens.smallestText, }}> {this.props.AliasName}</TextViewHML>
                        </View>
                        <View style={{ flexDirection: 'row', }}>
                            <TextViewHML style={{ flex: 1, textAlign: 'left', color: R.colors.textPrimary, fontSize: R.dimens.smallestText, }}> {R.strings.createdDate}</TextViewHML>
                            <TextViewHML style={{ flex: 1, textAlign: 'right', color: R.colors.textPrimary, fontSize: R.dimens.smallestText, }}> {this.props.CreatedDate}</TextViewHML>
                        </View>
                        <View style={{ flexDirection: 'row', }}>
                            <TextViewHML style={{ flex: 1, textAlign: 'left', color: R.colors.textPrimary, fontSize: R.dimens.smallestText, }}> {R.strings.allowedAccess}</TextViewHML>
                            <TextViewHML style={{ flex: 1, textAlign: 'right', color: R.colors.textPrimary, fontSize: R.dimens.smallestText, }}> {this.props.APIAccess === 1 ? R.strings.admin_rights : R.strings.view_rights}</TextViewHML>
                        </View>
                    </View>
                    <Separator style={{ marginLeft: 0, marginRight: 0, }} />
                    <TextViewHML style={{ marginTop: R.dimens.widgetMargin, fontSize: R.dimens.smallestText, textAlign: 'left', color: R.colors.yellow }}> {R.strings.apiKeyDeleteNote}</TextViewHML>
                </View>
            </AlertDialog>
        )
    }
...
class KeyDialogBox extends Component {
    constructor(props) {
        super(props);
    }
