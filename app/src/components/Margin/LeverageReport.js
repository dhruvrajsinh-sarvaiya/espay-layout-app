...
class LeverageReport extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            isFirstTime: true,
            currencyItem: [],
            drawerOpen: false, // First Time Drawer is Closed
        };
        ...
        //To Bind All Method
        this.onBackPressFromDrawer = this.onBackPressFromDrawer.bind(this);

        // for call previous screen method
        this.props.navigation.setParams({ onBackPress: this.onBackPressFromDrawer });
            ...
            <Drawer
                ...
                <SafeView style={{ flex: 1, backgroundColor: R.colors.background }}>
                    ...
                    <CustomToolbar
                        ...
                        isBack={true}
                        onBackPress={this.onBackPressFromDrawer}
