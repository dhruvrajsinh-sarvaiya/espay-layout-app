...
class MarginWalletLedgerDetails extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            refreshing: false,
            isFirstTime: true,
            drawerIsOpen: false, // First Time Drawer is Closed
        ...
        // Bind all methods
        this.backKeyPress = this.backKeyPress.bind(this);
        this.props.navigation.setParams({ onBackPress: this.backKeyPress });
