...
class MarginBuySellWidget extends Component {
    ...
    shouldComponentUpdate(nextProps, nextState) {
        ...
        if (this.props.preference.theme !== nextProps.preference.theme || this.props.preference.locale !== nextProps.preference.locale || this.state.module != nextState.module) {
            return true;
        } else {
                    ...
                    {/* for show Up-Down Arrow */}
                    {
                        ...
                        <View style={{ flexDirection: 'column' }}>
                            <ImageButton
                                ...
                                iconStyle={{ tintColor: props.onIncrement !== undefined ? R.colors.accent : 'transparent', height: R.dimens.dashboardMenuIcon, width: R.dimens.dashboardMenuIcon }}
                                style={{ margin: 0 }}
                                resizeMode={'contain'}
                                onPress={props.onIncrement !== undefined ? props.onIncrement : null} />

                            <ImageButton
                                icon={R.images.IC_FILL_SMALL_DOWN_ARROW}
                                iconStyle={{ tintColor: props.onDecrement !== undefined ? R.colors.accent : 'transparent', height: R.dimens.dashboardMenuIcon, width: R.dimens.dashboardMenuIcon }}
                                style={{ margin: 0 }}
                                resizeMode={'stretch'}
                                onPress={props.onDecrement !== undefined ? props.onDecrement : null} />
                        </View>
                    }
                </View>
            </CardView>
 ...
 */
function findBalance(props, pair, module) {
