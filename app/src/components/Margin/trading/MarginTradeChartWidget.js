...
class MarginTradeChartWidget extends Component {
...
function mapDispatchToProps(dispatch) {
    return {
        // Perform GraphDetail Action
        getGraphDetails: (params) => dispatch(getGraphDetails(params)),
    }
}

export default connect(mapStateToProps, mapDispatchToProps)(MarginTradeChartWidget);