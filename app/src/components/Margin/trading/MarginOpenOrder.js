        ...
        if (dialogShowCount == 0) {
            ...
            if (OrderType != 0) {
                ...
                this.state.response.map((value) => {
                    ...
                    for (var orderTypesItem of orderTypes) {

                        // If Order Types are same in available records than store bit to true so that we can laters call api for it.
                        if (orderTypesItem.ID === OrderType.toString() && orderTypesItem.type === value.OrderType) {
                            isOrderType = true;
                        }
            ...
            if (this.state.response.length > 0 && isOrderType) {
                ...
                switch (i) {
                    ...
                    case 1: message = R.strings.formatString(R.strings.cancelMessage, { type: R.strings.limit }); break;
                    case 2: message = R.strings.formatString(R.strings.cancelMessage, { type: R.strings.market }); break;
                    case 3: message = R.strings.formatString(R.strings.cancelMessage, { type: R.strings.stopLimit }); break;
                    default: message = R.strings.cancelAllMessage; break;
                }
