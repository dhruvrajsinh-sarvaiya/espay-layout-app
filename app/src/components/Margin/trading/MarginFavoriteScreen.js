...
class MarginFavoriteScreen extends Component {
    ...
    static getDerivedStateFromProps(props, state) {
        ...
        if (MarginFavoriteScreen.oldProps !== props) {
            MarginFavoriteScreen.oldProps = props;
        } else {
            return null;
        }
        ...
        if (isCurrentScreen(props)) {
            try {
                ...
                let { favourites: { marginFavouriteList } } = props;
...
export default connect(mapStatToProps, mapDispatchToProps)(MarginFavoriteScreen);