	...
	shouldComponentUpdate(nextProps, nextState) {
		...
		if (this.props.preference.theme !== nextProps.preference.theme || this.props.preference.locale !== nextProps.preference.locale) {
			...
			// stop twice api call 
				...
				this.props.buyerBook.buyerBookData !== nextProps.buyerBook.buyerBookData || this.props.buyerBook.isFetchingBuyerBook !== nextProps.buyerBook.isFetchingBuyerBook ||
				this.props.sellerBook.sellerBookData !== nextProps.sellerBook.sellerBookData || this.props.sellerBook.isFetchingSellerBook !== nextProps.sellerBook.isFetchingSellerBook ||
				...
				<TouchableWithoutFeedback onPress={onPress}>
					<View>
						...
						<View style={[{
							...
							width: highDepth >= 100 && highDepth ? '100%' : highDepth + "%",
