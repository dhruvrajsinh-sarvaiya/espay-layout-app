...
class MarginGlobalMarketTradeWidget extends Component {
                        ...
                        isFetchingMarketTrade ?
                            ...
                            <FlatList
                                ...
                                renderItem={({ index, item }) => {
                                    if (this.state.routeName === 'MarginMarketPairDetail') {
                                        if (index > 9) {
                                            return null
                                        }
                                    }
...
export default connect(mapStatToProps, mapDispatchToProps)(MarginGlobalMarketTradeWidget);