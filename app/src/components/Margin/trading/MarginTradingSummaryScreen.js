...
class MarginTradingSummaryScreen extends Component {
    ...
    static getDerivedStateFromProps(props, state) {
        ...
        if (MarginTradingSummaryScreen.oldProps !== props) {
            MarginTradingSummaryScreen.oldProps = props;
        } else {
            return null;
        }
                            ...
                            <FlatList
                                ...
                                renderItem={({ item, index }) => {
                                    return <FlatListItem
                                        ...
                                        onPress={() => this.props.navigation.navigate('MarginTradingSummaryDetailScreen', { item })} />
                                }}
...
export default connect(mapStatToProps, mapDispatchToProps)(MarginTradingSummaryScreen);