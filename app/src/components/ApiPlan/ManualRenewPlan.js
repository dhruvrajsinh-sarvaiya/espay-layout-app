			...
			<SafeView style={this.styles().container}>
				...
				<AlertDialog
					...
					<TextViewHML style={{
						...
						textAlign: 'center'
					}}>{R.strings.formatString(R.strings.areYouSureToRenewPlanWorth, { PlanName: UserActivePlan.PlanName, NetTotal: (apiPlanList.Price + apiPlanList.Charge) + ' USD' })}</TextViewHML>
				</AlertDialog>
			</SafeView>
		);
	}
