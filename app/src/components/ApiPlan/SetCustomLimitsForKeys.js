								...
								<View style={{ flex: 1, justifyContent: 'space-between' }}>
									...
									<ScrollView showsVerticalScrollIndicator={false}>
										<CardView style={this.styles().cardviewStyle}>
											...
											{
												item[0].ReadOnlyAPI != null && Object.values(item[0].ReadOnlyAPI).length > 0 &&
												<View style={{ marginTop: R.dimens.margin }}>
													...
													{
														Object.values(item[0].ReadOnlyAPI).map((itemReadOnly, index) =>
											...
											{
												item[0].FullAccessAPI != null && Object.values(item[0].FullAccessAPI).length > 0 &&
												<View style={{ marginTop: R.dimens.margin }}>
													...
													{
														Object.values(item[0].FullAccessAPI).map((itemFullAccess, index) =>
															<View style={{ flexDirection: 'row', marginTop: R.dimens.widgetMargin }} key={index.toString()}>
