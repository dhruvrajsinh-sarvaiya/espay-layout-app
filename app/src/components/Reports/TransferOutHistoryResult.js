                            ...
                            </View>
                            {
                                (trnOutHistoryItem.TrnID && trnOutHistoryItem.ExplorerLink) ?
                                    <TouchableOpacity onPress={this.props.onTrnIdPress}>
                                        <TextViewHML style={{ marginLeft: R.dimens.widget_left_right_margin, fontSize: R.dimens.smallestText, color: R.colors.accent, }}>{trnOutHistoryItem.TrnID}</TextViewHML>
                                    </TouchableOpacity> :
                                    <TextViewHML style={{ marginLeft: R.dimens.widget_left_right_margin, fontSize: R.dimens.smallestText, color: R.colors.textPrimary, }}>{trnOutHistoryItem.TrnID}</TextViewHML>
                            }
                        </View>
