    ...
    render() {
        return (
            <LinearGradient
                ...
                <SafeView style={{ flex: 1, }} isDetail={true} >
                    ...
                    <ScrollView contentContainerStyle={{ flexGrow: 1, paddingBottom: R.dimens.margin_top_bottom, }} keyboardShouldPersistTaps={'always'} showsVerticalScrollIndicator={false}>

                        {/* Amount and CoinName is Merged With Toolbar using below design */}
                        <View style={{ marginLeft: (R.dimens.margin_top_bottom * 2), marginTop: R.dimens.margin, marginRight: R.dimens.margin_top_bottom, }}>
                            <TextViewMR style={[
