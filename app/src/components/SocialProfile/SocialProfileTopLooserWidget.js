...
export class SocialProfileTopLooserWidget extends Component {
    ...
    static getDerivedStateFromProps(props, state) {
        ...
        if (SocialProfileTopLooserWidget.oldProps !== props) {
            SocialProfileTopLooserWidget.oldProps = props;
        } else {
            return null;
        }
...
export class FlatListItem extends Component {
    ...
    shouldComponentUpdate(nextProps) {
        ...
        if (this.props.looseritem === nextProps.looseritem)
            return false
        return true
    }

    render() {
        let item = this.props.looseritem
        let color, icon;
