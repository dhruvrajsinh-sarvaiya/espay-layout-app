          ...
          <div className="page-title-wrap">
            ...
            <CloseButton className="btn-info text-white mr-10 mb-10" style={buttonSizeSmall} variant="fab" mini onClick={this.props.closeAll}><i className="zmdi zmdi-home"></i></CloseButton>
				...
				<div className="charts-widgets-wrapper">
					{/* <PageTitleBar title={<IntlMessages id="sidebar.settledOrders.list" />} match={this.props.match} /> */}
								...
								<div className="col-md-12">
									<div className="top-filter clearfix">
										<Form name="frm_search" className="row mb-10">
											...
											<Label for="user">Rate Range</Label>
											<Input type="text" name="Range" id="Range" placeholder="Rate Range" />
										</div>
										<div className="col-md-3">
...
const mapStateToProps = ({ settledOrders, tradeRecon }) => {
	const { settledOrdersList, loading, error } = settledOrders;
	const { pairList } = tradeRecon;
	return { settledOrdersList, loading, error, pairList }
}

// export this component with action methods and props
export default connect(mapStateToProps, { settledOrders, getTradePairs, settledOrdersRefresh })(SettledOrders);
