...
import ListMarginWallets from "Components/MarginTrading/WalletList/ListMarginWallets";
        ...
        return (
            <div className="wallet-dashboard-wrapper">
                ...
                <Row>
                    ...
                    {/* {this.checkAndGetMenuAccessDetail('7FF12560-279A-8BA4-72B4-1E65E986070C') && //margin 7FF12560-279A-8BA4-72B4-1E65E986070C
                        <div className="col-md-3 col-sm-6 col-xs-12">
                            <a href="javascript:void(0)" onClick={(e) => this.showComponent('ReportsData', (this.checkAndGetMenuAccessDetail('7FF12560-279A-8BA4-72B4-1E65E986070C')).HasChild)} className="text-dark col-sm-full">
