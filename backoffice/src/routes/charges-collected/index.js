...
// import ChargeCollectedComponent from "Components/ChargesCollected/ChargesCollected";
  ...
  render() {
    ...
    return (
      <JbsCollapsibleCard>
        ...
        {/* <ChargeCollectedComponent data={this.props.chargeCollectedData} /> */}
      </JbsCollapsibleCard>
    );
  }
}

/* const mapStateToProps = ({ chargeCollected }) => {
  const { chargeCollectedData } = chargeCollected;
  return { chargeCollectedData };
};
