...
function* getLeaderTradingPolicyAPI() {
    ...
    // console.log('Res Get Leader :',response);
    try {
...
function* editLeaderTradingPolicyAPI({ payload }) {
    ...
    // console.log('Req Leader :',payload);
    // console.log('Res Leader :',response);
    try {
        if (response.ReturnCode === 0) {
...
function* getFollowerTradingPolicyAPI() {
    ...
    // console.log('Res Get Follower :',response);
    try {
        if (response.ReturnCode === 0) {
...
function* editFollowerTradingPolicyAPI({ payload }) {
    ...
    // console.log('Req Follower :',payload);
