...
import { swaggerPostAPI, swaggerGetAPI, statusErrCodeList, staticResponse, loginErrCode } from 'Helpers/helpers';
...
function* getLedgerCurrencyListAPI({ payload }) {
    ...
    try {
        ...
        var IsMargin = '';
        var ActiveOnly = '';
        let URL = 'api/TransactionConfiguration/ListCurrency';
