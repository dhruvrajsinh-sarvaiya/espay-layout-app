...
function* editEmailApiRequestSaga({payload}){
    const response = yield call(swaggerPostAPI, 'api/MasterConfiguration/UpdateCommunicationServiceConfig/UpdateCommunicationServiceConfig', payload.emailRequest, 1);
...
function* addEmailApiRequestSaga({payload}){
    const response = yield call(swaggerPostAPI, 'api/MasterConfiguration/AddCommunicationServiceConfig/AddCommunicationServiceConfig', payload.emailRequest, 1);
...
function* displayEmailApiListSaga({payload}) {
    ...
    var response= yield call(swaggerGetAPI,api,{});
