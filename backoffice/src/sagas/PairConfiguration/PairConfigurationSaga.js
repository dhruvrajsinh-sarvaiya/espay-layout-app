...
function* pairConfigurationListRequest({ payload }) {
  ...
  try {
    ...
    //const response = yield call(swaggerGetAPI, 'api/TransactionConfiguration/GetAllPairConfiguration' + IsMargin, payload, headers);
...
function* submitPairConfiguration({ payload }) {
  //console.log("addpairconfiguration", payload)
  try {
    ...
    //const response = yield call(swaggerGetAPI,'api/TransactionConfiguration/AddPairConfiguration',{},{});
    //const response = yield call(swaggerPostAPI, 'api/TransactionConfiguration/AddPairConfiguration', payload, {}, headers)
    // console.log(response)
    if (response && response != null && response.ReturnCode === 0) {
...
function* editPairConfiguration({ payload }) {
   //console.log("editpairsaga",payload)
  try {
    ...
    //const response = yield call(swaggerPostAPI, 'api/TransactionConfiguration/UpdatePairConfiguration', payload, {}, headers)
    // console.log(response)
    if (response && response != null && response.ReturnCode === 0) {
