...
function* addPatternsAssignmentsData({ payload }) {
  const addPatternsAssignmentsData = payload;
  try {
    yield put(addPatternsAssignmentsSuccess(addPatternsAssignmentsData));
  } catch (error) {
...
function* editPatternsAssignmentsData({ payload }) {
  const editPatternsAssignmentsData = payload;

  try {
    yield put(editPatternsAssignmentsSuccess(editPatternsAssignmentsData));
  } catch (error) {
