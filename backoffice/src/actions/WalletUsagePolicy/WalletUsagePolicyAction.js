...
export const getWalletUsagePolicySuccess = getWalletUsagePolicy => ({
    type: GET_WALLET_USAGE_POLICY_SUCCESS,
    payload: getWalletUsagePolicy
});
...
export const getWalletTypeSuccess = getWalletType => ({
    type: GET_WALLET_TYPE_SUCCESS,
    payload: getWalletType
});
