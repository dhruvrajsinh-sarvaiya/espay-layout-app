 ...
 *   Date : 06-06-2019
 *   Component: Arbitrage Currency Configuration Action
 */
import {
    ...
    GET_ARBITRAGE_CURRENCY_SUCCESS,
    GET_ARBITRAGE_CURRENCY_FAILURE,
} from "Actions/types";
...
export const getChargeConfigurationByIdSuccess = getChargeConfigurationById => ({
...
//List Arbitrage Wallet ListCurrency Action
export const ListArbitrageCurrency = request => ({
    type: GET_ARBITRAGE_CURRENCY,
    request: request
});
export const ListArbitrageCurrencySuccess = response => ({
    type: GET_ARBITRAGE_CURRENCY_SUCCESS,
    payload: response
});
export const ListArbitrageCurrencyFailure = error => ({
    type: GET_ARBITRAGE_CURRENCY_FAILURE,
    payload: error
});