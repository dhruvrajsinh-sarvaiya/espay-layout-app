...
export const getWalletTypeMasterSuccess = getWalletTypeMaster => ({
    type: GET_WALLET_TYPE_MASTERL_SUCCESS,
    payload: getWalletTypeMaster
});
...
export const getWalletTypeMasterByIdSuccess = getWalletTypeMasterById => ({
    type: GET_WALLET_TYPE_MASTER_BY_ID_SUCCESS,
    payload: getWalletTypeMasterById
});
...
export const deleteWalletTypeMasterSuccess = deleteWalletTypeMaster => ({
    type: DELETE_WALLET_TYPE_MASTER_SUCCESS,
    payload: deleteWalletTypeMaster
});
