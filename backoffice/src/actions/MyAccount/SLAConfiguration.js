...
/**
 * Redux Action To Get SLA Configuration By Id
 */
export const getSLAConfigurationById = id => ({
  type: GET_SLA_BY_ID,
  payload: id
});

/**
 * Redux Action Get SLA Configuration By Id Success
 */
export const getSLAConfigurationByIdSuccess = data => ({
  type: GET_SLA_BY_ID_SUCCESS,
  payload: data
});

/**
 * Redux Action Get SLA Configuration By Id Failure
 */
export const getSLAConfigurationByIdFailure = error => ({
  type: GET_SLA_BY_ID_FAILURE,
  payload: error
});
