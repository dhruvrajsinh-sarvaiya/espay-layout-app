                                        ...
                                        <FormGroup className="col-md-2 col-sm-4">
                                            ...
                                            <Input type="select" name="RoleId" id="RoleId" value={this.state.RoleId} onChange={(e) => this.onChangeHandler(e, 'RoleId')}>
                                                ...
                                                {this.props.roleDetails.hasOwnProperty("Roles") &&
                                                    this.props.roleDetails.Roles.length &&
...
const mapDispatchToProps = ({ TrnTypeRoleWise, transactionPolicy ,authTokenRdcer}) => {
    const {
        menuLoading,
        menu_rights
    } = authTokenRdcer;
    const { TrnTypeRoleWiseData, updateStatus, addTrnTypeRoleWiseData, loading } = TrnTypeRoleWise;
