...
class WalletList extends Component {
    ...
    showComponent = (componentName, walletID = "", menuDetail) => {
                                    ...
                                    <div className="list-action">
                                        {menuPermissionDetail.CrudOption.indexOf('6AF64827') !== -1 && // check for view permission
                                            <a
                                                ...
                                                onClick={e => this.showComponent("WalletView", wallet.AccWalletID, this.checkAndGetMenuAccessDetail(this.props.menuDetail ? 'DB060E19-0938-841B-316C-D5C91910100F' : '85AF8731-2B77-40C2-574D-EC1F4F4A2A87').HasChild)} // 85AF8731-2B77-40C2-574D-EC1F4F4A2A87
                                            >
                                                <i className="ti-eye" />
                                            </a>
                                        }
