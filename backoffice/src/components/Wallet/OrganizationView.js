...
class OrganizationView extends Component {
	...
	render() {
		...
		/* let walletTrnData = [];
		if (this.props.walletTrnTypes.hasOwnProperty("Data")) {
			walletTrnData = this.props.walletTrnTypes.Data;
		} */
			...
			<div className="jbs-page-content">
				...
				<div className="row">
					<div className="col-sm-12 col-md-4 w-xs-full">
						{/* <a
							...
							onClick={e => this.showComponent("OrganizationUsersList")}
				...
				<div className="row">
					...
					<div className="col-sm-12 col-md-4 w-xs-full">
						{/* <a
							href="javascript:void(0)"
							onClick={e => this.showComponent("ChargeTypeView")}
							className="text-dark col-sm-full"
						> */}
						<CardWidgetType7
				...
				<div className="row">
					...
					{/* <div className="col-sm-12 col-md-4 w-xs-full">
                        <CardWidgetType3
                            title={<IntlMessages id="walletDeshbard.serviceProviders" />}
                            count1={"06"}
                            count2={"140"}
                            count3={"236"}
                            count4={"104"}
                            title1={<IntlMessages id="walletDeshbard.web" />}
                            title2={<IntlMessages id="walletDeshbard.app" />}
                            title3={<IntlMessages id="walletDeshbard.api" />}
                            title4={<IntlMessages id="walletDeshbard.internal" />}
                            clickEvent={this.onClick} />
                    </div> */}
				</div>
				<Drawer
