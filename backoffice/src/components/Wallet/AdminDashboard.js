...
import BlockUnblockUserAddress from 'Components/Wallet/BlockUnblockUserAddress/BlockUnblockUserAddress';
...
const components = {
    ...
    BlockUnblockUserAddress: BlockUnblockUserAddress,
            ...
            <React.Fragment>
                    ...
                    {this.checkAndGetMenuAccessDetail('5DCACB91-1781-5CA1-8CE1-791861EE25FC') && //5DCACB91-1781-5CA1-8CE1-791861EE25FC
                        <div className="col-md-4 col-sm-4 col-xs-12">
                            ...
                            {!this.props.organizationDetails.loading &&
                                // <a href="javascript:void(0)" onClick={(e) => this.showComponent('OrganizationList')} className="text-dark col-sm-full">
                                <CardWidgetType1
                    ...
                    {this.checkAndGetMenuAccessDetail('0BBEBE62-2360-9A81-3347-41FAE9E2122A') && //0BBEBE62-2360-9A81-3347-41FAE9E2122A
                        <div className="col-md-4 col-sm-4 col-xs-12">
                            ...
                            {!this.props.usersDetails.loading &&
                                // <a href="javascript:void(0)" onClick={(e) => this.showComponent('UserList')} className="text-dark col-sm-full">
                                <CardWidgetType1
                ...
                {/* <div className="row">
                    <div className="col-sm-12 col-md-4 w-xs-full">
                        {this.props.roleDetails.loading && <PreloadWidget />}
                        {!this.props.roleDetails.loading && <a href="javascript:void(0)" onClick={(e) => this.showComponent('UserList')} className="text-dark col-sm-full">
                            <CardWidgetType3
                                title={<IntlMessages id="walletDeshbard.roles" />}
                                count1={(this.props.roleDetails.hasOwnProperty("Counter")) ? (typeof this.props.roleDetails.Counter[0] !== "undefined") ? this.props.roleDetails.Counter[0].Count : 0 : 0}
                                count2={(this.props.roleDetails.hasOwnProperty("Counter")) ? (typeof this.props.roleDetails.Counter[1] !== "undefined") ? this.props.roleDetails.Counter[1].Count : 0 : 0}
                                count3={(this.props.roleDetails.hasOwnProperty("Counter")) ? (typeof this.props.roleDetails.Counter[2] !== "undefined") ? this.props.roleDetails.Counter[2].Count : 0 : 0}
                                count4={(this.props.roleDetails.hasOwnProperty("Counter")) ? (typeof this.props.roleDetails.Counter[3] !== "undefined") ? this.props.roleDetails.Counter[3].Count : 0 : 0}
                                title1={<IntlMessages id="walletDeshbard.owner" />}
                                title2={<IntlMessages id="walletDeshbard.admin" />}
                                title3={<IntlMessages id="walletDeshbard.spender" />}
                                title4={<IntlMessages id="walletDeshbard.viewer" />}
                                clickEvent={this.toggleDrawer} />
                        </a>}
                    </div>
                </div> */}
                ...
                {/* <div className="row">
                    <div className="col-sm-12">
                        <h4><IntlMessages id="walletDeshbard.roles" /></h4>
                    </div>
                </div>
                <div className="row">
                    <div className="col-md-3 col-sm-6 col-xs-12">
                        {this.props.roleDetails.loading ?
                            <PreloadWidget /> :
                            <WalletFeedsWidget
                                feedsTitle={<IntlMessages id="walletDeshbard.owner" />}
                                feedsCount={(this.props.roleDetails.hasOwnProperty("Counter")) ? (typeof this.props.roleDetails.Counter[0] !== "undefined") ? this.props.roleDetails.Counter[0].Count : 0 : 0}
                    ...
                    <div className="col-md-3 col-sm-6 col-xs-12">
                        {this.props.roleDetails.loading ?
                            <PreloadWidget /> :
                            <WalletFeedsWidget
                                feedsTitle={<IntlMessages id="walletDeshbard.admin" />}
                                feedsCount={(this.props.roleDetails.hasOwnProperty("Counter")) ? (typeof this.props.roleDetails.Counter[1] !== "undefined") ? this.props.roleDetails.Counter[1].Count : 0 : 0}
                    ...
                    <div className="col-md-3 col-sm-6 col-xs-12">
                        {this.props.roleDetails.loading ?
                            <PreloadWidget /> :
                            <WalletFeedsWidget
                                feedsTitle={<IntlMessages id="walletDeshbard.spender" />}
                                feedsCount={(this.props.roleDetails.hasOwnProperty("Counter")) ? (typeof this.props.roleDetails.Counter[2] !== "undefined") ? this.props.roleDetails.Counter[2].Count : 0 : 0}
                                icon="zmdi zmdi-swap-vertical-circle"
                            />
                        }
                    </div>
                    <div className="col-md-3 col-sm-6 col-xs-12">
                        {this.props.roleDetails.loading ?
                            <PreloadWidget /> :
                            <WalletFeedsWidget
                                feedsTitle={<IntlMessages id="walletDeshbard.viewer" />}
                                feedsCount={(this.props.roleDetails.hasOwnProperty("Counter")) ? (typeof this.props.roleDetails.Counter[3] !== "undefined") ? this.props.roleDetails.Counter[3].Count : 0 : 0}
                                icon="zmdi zmdi-eye"
                            />
                        }
                    </div>
                ...
                <div className="row">
                    ...
                    {this.checkAndGetMenuAccessDetail('02F30558-639C-6C0F-7F2F-120E1EC37ECC') && //
                        <div className="col-md-3 col-sm-6 col-xs-12">
                            <a
                                href="javascript:void(0)"
                                onClick={e => this.showComponent("BlockUnblockUserAddress", (this.checkAndGetMenuAccessDetail('02F30558-639C-6C0F-7F2F-120E1EC37ECC')).HasChild)}
                                className="text-dark col-sm-full"
                            >
                                <SimpleCard
                ...
                <div className="row">
                    ...
                    {/* {this.checkAndGetMenuAccessDetail('AFC50DD2-2525-4E54-A0CA-E54BF55AF5A5') && //9DEEB30F-6398-042E-7769-8B9F285131A7
                        <div className="col-md-3 col-sm-6 col-xs-12">
                            <a
                                href="javascript:void(0)"
                                onClick={e => this.showComponent("ChargeTypeDetail", (this.checkAndGetMenuAccessDetail('AFC50DD2-2525-4E54-A0CA-E54BF55AF5A5')).HasChild)}
                                className="text-dark col-sm-full"
                            >
                                <SimpleCard
                                    title={<IntlMessages id="walletDashboard.ChargeTypeDetail" />}
                                    icon="zmdi zmdi-plus-circle-o-duplicate"
                                    bgClass="bg-dark"
                                />
                            </a>
                        </div>
                    } */}
                    {/* {this.checkAndGetMenuAccessDetail('AFC50DD2-2525-4E54-A0CA-E54BF55AF5A5') && //036AC5DE-2F73-6700-2837-F1CFD8055829
                        <div className="col-md-3 col-sm-6 col-xs-12">
                            <a
                                href="javascript:void(0)"
                                onClick={e => this.showComponent("CommisssionTypeDetail", (this.checkAndGetMenuAccessDetail('AFC50DD2-2525-4E54-A0CA-E54BF55AF5A5')).HasChild)}
                                className="text-dark col-sm-full"
                            >
                                <SimpleCard
