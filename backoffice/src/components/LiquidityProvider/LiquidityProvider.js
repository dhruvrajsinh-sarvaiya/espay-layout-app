...
class LiquidityProvider extends Component {
  ...
  handleChangeSpotMinAmount = event => {
    if (event.target.value !== "" && validateOnlyNumeric(event.target.value)) {
      this.setState({
  ...
  deleteUserPermanently() {
    ...
    // let users = this.state.employeePayroll;
  ...
  componentDidMount() {
    ...
    this.props.getProvidersList(), this.props.getCurrencyList();
  }
          ...
          >
            ...
            <ModalBody className="LiquidityProviderScroll">
              ...
              <FormGroup className="ml-20">
                ...
                {/* <FormGroup check className="mt-10">
                  <FormGroup row>
                    <Label sm={4} />
                    <Label check>
                      <Input
