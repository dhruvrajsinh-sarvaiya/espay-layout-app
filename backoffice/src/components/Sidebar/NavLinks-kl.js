  ...
  category1: [
    {
      ...
      child_routes: [
        ...
        {
          path: "/app/deposit-report",
          menu_title: "sidebar.depositMenu"
        }
      ]
    },
    {
      ...
      child_routes: [
        {
          menu_title: "sidebar.Faq-Categories",
          path: "/app/cms/faq/categories"
        }
      ]
    },
    {
      ...
      child_routes: [
        ...
        /*{
				...
				{
					"menu_title": "sidebar.signupReport",
					"path": "/app/my-account/signup-report",
				},*/
      ]
    },
    {
      ...
      child_routes: [
        ...
        {
          path: "/app/daemon-addresses",
          menu_title: "sidebar.daemonAddresses"
        },
        {
          path: "/app/asset-report",
          menu_title: "sidebar.adminAssetReport"
        },
        {
          path: "/app/withdraw-report",
          menu_title: "sidebar.withdrawalMenu"
        },
        {
          path: "/app/transfer-in-out",
          menu_title: "sidebar.transferInOut"
        },
        {
