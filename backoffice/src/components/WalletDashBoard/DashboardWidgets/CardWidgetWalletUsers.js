        ...
        return (
            <JbsCard colClasses="col-sm-full">
                ...
                <JbsCardContent>
                    ...
                    <ul className="list-group new-customer-list">
                        <li className="list-group-item d-flex justify-content-between">
                            ...
                            <div className="d-flex align-items-end">
                                <a href="javascript:void(0)" color="primary" onClick={() => console.log('info')}>
                    ...
                    <h2 className="w-100 text-center mb-0"><a href="javascript:void(0)" onClick={() => (console.log('clicked'))} >....</a></h2>
                </JbsCardContent>
            </JbsCard >
        )
    }
