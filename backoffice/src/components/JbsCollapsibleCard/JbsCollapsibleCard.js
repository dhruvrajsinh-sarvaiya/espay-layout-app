    ...
    render() {
        ...
        return (
            <div className={classnames(colClasses ? colClasses : '', { 'd-block': !collapse })}>
                <div className={classnames(`jbs-block ${customClasses ? customClasses : ''}`, { 'd-none': close })}>
                    {heading &&
                        <div className={`jbs-block-title ${headingCustomClasses ? headingCustomClasses : ''}`}>
                    ...
                    <Collapse isOpen={collapse}>
                        <div className={classnames(contentCustomClasses ? contentCustomClasses : '', { "jbs-block-content": !fullBlock, 'jbs-full-block': fullBlock })}>
                            {children}
                        </div>
                    </Collapse>
