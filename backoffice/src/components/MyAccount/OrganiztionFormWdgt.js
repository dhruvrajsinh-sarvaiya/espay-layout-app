...
import { Label, Form, FormGroup, Input, Alert, Button, Col, Row } from "reactstrap";
				...
				{loading
					...
					<Form>
						...
						<Col sm="12" md={{ size: 1, offset: 11 }} className="mt-15">
							...
							{/* <Button onClick={drawerClose} color="danger"><IntlMessages id="sidebar.btnCancel" /></Button> */}
						</Col>
					</Form>
				}
			</Fragment>
