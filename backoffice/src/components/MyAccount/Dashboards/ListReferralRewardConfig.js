                                ...
                                return [
                                    ...
                                    <Fragment>
                                        {/* {
                                            ...
                                            (lst.Status === 0
                                                ?
                                                <Badge color="danger" onClick={() => this.onEnableRewardConfig(lst.Id)} style={{ 'cursor': 'pointer' }}>
                                                    <IntlMessages id="sidebar.inactive" />
                                                </Badge>
                                                :
                                                <Badge color="success" onClick={() => this.onDisableRewardConfig(lst.Id)} style={{ 'cursor': 'pointer' }}>
...
const mapStateToProps = ({ ReferralRewardConfig, drawerclose,authTokenRdcer }) => {
    ...
    return { listReferrlaRewardConfigData, enableReferralRewardConfigData, disableReferralRewardConfigData, list_loading, drawerclose ,        menuLoading,
        menu_rights};
}
