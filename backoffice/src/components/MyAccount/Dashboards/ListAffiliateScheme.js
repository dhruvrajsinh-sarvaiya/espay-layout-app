...
class ListAffiliateScheme extends Component {
    ...
    render() {
        const { componentName, open, affSchemeList, pagedata, totalCount, menuDetail } = this.state;
                                ...
                                return [
                                    ...
                                    <div className="list-action">
                                        ...
                                        {/* {menuPermissionDetail.CrudOption.indexOf('0BB7ACAC') !== -1 && //check edit curd operation
                                            <a href="javascript:void(0)" onClick={(e) => this.showComponent('AddEditAffiliateScheme', item.SchemeMasterId)} className="text-dark mr-10"><i className="zmdi zmdi-edit zmdi-hc-2x" /></a>}
                                        {(menuPermissionDetail.CrudOption.indexOf('0BB7ACAC') !== -1 && (item.Status === 0 || item.Status === 9)) && <a href="javascript:void(0)" onClick={() => this.changeStatus(item.SchemeMasterId, 1)} className="text-dark mr-5"><i className="zmdi zmdi-check zmdi-hc-2x" /></a>}
                                        {(menuPermissionDetail.CrudOption.indexOf('0BB7ACAC') !== -1 && (item.Status === 1 || item.Status === 9)) && <a href="javascript:void(0)" onClick={() => this.changeStatus(item.SchemeMasterId, 0)} className="text-dark mr-10"><i className="zmdi zmdi-close zmdi-hc-2x" /></a>}
                                        {(menuPermissionDetail.CrudOption.indexOf('B873B896') !== -1 && (item.Status === 0 || item.Status === 1)) && <a href="javascript:void(0)" onClick={() => this.changeStatus(item.SchemeMasterId, 9)} className="text-dark mr-10"><i className="zmdi zmdi-delete zmdi-hc-2x" /></a>} */}
                                    </div>
                                ];
                            })}
                        />
