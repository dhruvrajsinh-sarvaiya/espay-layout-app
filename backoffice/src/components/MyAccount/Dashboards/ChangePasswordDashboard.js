								...
								<div className="col-md-8 col-sm-8 col-xs-12">
									<IntlMessages id="myaccount.enterCurrentPassword">
										{(placeholder) =>
											...
											<Input disabled={(menuDetail["404831fa-9ed2-505c-5c9d-01ffb403656d"].AccessRight === "11E6E7B0") ? true : false} type="password" name="currentPassword" value={currentPassword} placeholder={placeholder} id="oldPassword" onChange={this.handleChange} />*/
							...
							<FormGroup row>
								...
								<div className="col-md-8 col-sm-8 col-xs-12">
									<IntlMessages id="myaccount.enterNewPassword">
										{(placeholder) =>
											/*Added By Bharat Jograna
											<Input disabled={(menuDetail["3c3afc43-9085-4386-7261-3bf6b9245067"].AccessRight === "11E6E7B0") ? true : false} type="password" name="newPassword" value={newPassword} id="newPassword" placeholder={placeholder} onChange={this.handleChange} />*/
							...
							<FormGroup row>
								...
								<div className="col-md-8 col-sm-8 col-xs-12">
									<IntlMessages id="myaccount.enterConfirmPassword">
										{(placeholder) =>
											/*Added By Bharat Jograna
											<Input disabled={(menuDetail["75279f0b-9468-3b1b-24f1-84180e211422"].AccessRight === "11E6E7B0") ? true : false} type="password" name="confirmPassword" value={confirmPassword} id="confirmPassword" placeholder={placeholder} onChange={this.handleChange} />*/
