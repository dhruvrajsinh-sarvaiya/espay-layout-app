/* 
    ...
    Date : 23-11-2018
    File Comment : MyAccount List 2FA Authentication Dashboard Component
*/
...
// Component for MyAccount List 2FA Authentication Dashboard
class List2FAAuthDashboard extends Component {
    constructor(props) {
        super(props);
        this.state = {
            viewData: '',
    ...
    render() {
        ...
        return (
            <div className="jbs-page-content">
                <DashboardPageTitle title={<IntlMessages id="sidebar.list2FAAuthentication" />} drawerClose={drawerClose} closeAll={this.closeAll} />
                <div className="StackingHistory">
                    <MUIDataTable
                        title={<IntlMessages id="sidebar.list2FAAuthentication" />}
                        columns={columns}
                        data={
                            data.map((lst,key) => {
                                return [
                                    ...
                                    lst.updated_date,
                                    <Fragment>
                                        <a href="javascript:void(0)" onClick={(e) => this.showComponent('View2FAAuthDashboard',lst)} className="text-dark"><i className="zmdi zmdi-eye zmdi-hc-2x" /></a>
                                    </Fragment>
                                ]
                            })
                        }
