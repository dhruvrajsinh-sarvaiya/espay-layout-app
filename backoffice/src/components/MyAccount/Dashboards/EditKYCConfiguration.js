...
class EditKYCConfiguration extends Component {
    constructor(props) {
        super(props);
        this.state = {
            open: false,
    ...
    render() {
        ...
        return (
            <div className="jbs-page-content">
                <DashboardPageTitle title={<IntlMessages id="sidebar.EditKYCConfiguration" />} drawerClose={drawerClose} closeAll={this.closeAll} />
                <div className="jbs-page-content col-md-12 mx-auto">
                    ...
                    <Form>
                        ...
                        <FormGroup row className="mb-20 ">
                            ...
                            <div className="col-md-8">								
								<Input type="select" name="ResidentAddressProof" value={ResidentAddressProof} id="ResidentAddressProof" onChange={this.onChange}>
						...
						<FormGroup row className="mb-20 ">
                            ...
                            <div className="col-md-8">								
								<Input type="select" name="GovernmentIssuedIdentification" value={GovernmentIssuedIdentification} id="GovernmentIssuedIdentification" onChange={this.onChange}>
									<IntlMessages id="sidebar.pleaseSelect">{(selectOption) => <option value="">{selectOption}</option>}</IntlMessages>
									<option value="1">Passport</option>
                                    <option value="2">Pan Card</option>
                                    <option value="3">Aadhar Card</option>
                                    <option value="4">Ration Card</option>
                                    <option value="5">Driving Card</option>
								</Input>
...
export default EditKYCConfiguration;