...
class ListIPRangeDashboard extends Component {
    ...
    componentWillReceiveProps(nextProps) {
        ...
        } else if (Object.keys(nextProps.IPRangeData).length !== undefined && Object.keys(nextProps.IPRangeData).length > 0 && Object.keys(nextProps.IPRangeData.IPRangeGet).length > 0) {
