                                ...
                                return [
                                    ...
                                    <Fragment>
                                        {/* {
                                            ...
                                            (lst.Status === 0
                                                ?
                                                <Badge color="danger" onClick={() => this.onEnableServiceType(lst.Id)} style={{ 'cursor': 'pointer' }}>
                                                    <IntlMessages id="sidebar.inactive" />
                                                </Badge>
                                                :
                                                <Badge color="success" onClick={() => this.onDisableServiceType(lst.Id)} style={{ 'cursor': 'pointer' }}>
...
const mapStateToProps = ({ ReferralServiceTypeReducer, drawerclose,authTokenRdcer }) => {
    ...
    return { referralServiceTypeData, activeReferralServiceTypeData, inActiceReferralServiceTypeData, loading, drawerclose,        menuLoading,
        menu_rights };
}
