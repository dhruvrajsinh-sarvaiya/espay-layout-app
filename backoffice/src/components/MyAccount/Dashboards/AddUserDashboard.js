/* 
    ...
    Date : 30-11-2018
    File Comment : MyAccount Add User Dashboard Component
*/
...
// redux action
import { addUserData, getUserData } from "Actions/MyAccount";
//Validation
const validateAddUserDashboard = require("../../../validation/MyAccount/add_user_dashboard");

// Component for MyAccount Add User Dashboard
class AddUserDashboard extends Component {
    constructor(props) {
        super(props);
        this.state = {
            open: false,
    ...
    OnAddUser() {
        const { errors, isValid } = validateAddUserDashboard(this.state.data);
        this.setState({ errors: errors });
        if (isValid) {
            this.props.addUserData(this.state.data);
    ...
    render() {
        ...
        return (
            <div className="jbs-page-content">
                <DashboardPageTitle title={<IntlMessages id="my_account.addUser" />} drawerClose={drawerClose} closeAll={this.closeAll} />
                    ...
                    <Form className="tradefrm">
                        ...
                        <FormGroup row className="mb-20 ">
                            ...
                            <div className="col-md-2">
                                <MatButton variant="raised" className="btn-primary text-white" onClick={this.OnAddUser}><IntlMessages id="button.add" /></MatButton>
                            </div>
                            <div className="col-md-2">
...
const mapToProps = ({ custDashRdcer }) => {
    const { data, loading } = custDashRdcer;
    return { data, loading };
}
