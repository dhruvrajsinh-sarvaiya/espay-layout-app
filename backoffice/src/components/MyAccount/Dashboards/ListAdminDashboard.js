...
class ListAdminDashboard extends Component {
    constructor(props) {
        super(props);
        this.state = {
            viewData: '',
    ...
    render() {
        ...
        return (
            <div className="jbs-page-content">
                <DashboardPageTitle title={<IntlMessages id="sidebar.listAdmins" />} drawerClose={drawerClose} closeAll={this.closeAll} />
                <div className="StackingHistory">
                    <MUIDataTable
                        title={<IntlMessages id="sidebar.listAdmins" />}
                        columns={columns}
                        data={
                            data.map((lst,key) => {
                                return [
                                    ...
                                    lst.updated_date,
                                    <Fragment>
                                        <a href="javascript:void(0)" onClick={(e) => this.showComponent('ViewAdminDashboard',lst)} className="text-dark"><i className="zmdi zmdi-eye zmdi-hc-2x" /></a>
                                    </Fragment>
                                ]
                            })
                        }
