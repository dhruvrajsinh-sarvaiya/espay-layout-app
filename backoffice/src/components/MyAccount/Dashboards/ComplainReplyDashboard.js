...
class ComplainReplyDashboard extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            ListGUID:'',
            // ApiCallBit: this.props.menuDetail.menuDetails.GUID
            ApiCallBit: false
    ...
    componentWillReceiveProps(nextProps) {
        ...
        // if (this.state.ApiCallBit !== this.props.menuDetail.menuDetails.GUID) {
        //     this.setState({ ApiCallBit: this.props.menuDetail.menuDetails.GUID })
        //     this.props.getMenuPermissionByID(this.props.menuDetail.menuDetails.GUID);
        // }
    ...
    render() {
        const { errors, list, menudetail } = this.state;
    ...
    //   var menuDetail = this.checkAndGetMenuAccessDetail((menudetail.length) ? menudetail[0].GUID : '');
    //   if (!menuDetail) {
