/* 
    ...
    Date : 23-11-2018
    File Comment : MyAccount List Email Provider Dashboard Component
*/
...
// Component for MyAccount List Email Provider Dashboard
class ListEmailProviderDashboard extends Component {
    constructor(props) {
        super(props);
        this.state = {
            viewData: '',
    ...
    render() {
        ...
        return (
            <div className="jbs-page-content">
                <DashboardPageTitle title={<IntlMessages id="sidebar.listEmailProvider" />} drawerClose={drawerClose} closeAll={this.closeAll} />
                <div className="StackingHistory">
                    <MUIDataTable
                        title={<IntlMessages id="sidebar.listEmailProvider" />}
                        columns={columns}
                        data={
                            data.map((lst,key) => {
                                return [
                                    ...
                                    lst.updated_date,
                                    <Fragment>
                                        <a href="javascript:void(0)" onClick={(e) => this.showComponent('ViewEmailProviderDashboard',lst)} className="text-dark"><i className="zmdi zmdi-eye zmdi-hc-2x" /></a>
                                    </Fragment>
                                ]
                            })
                        }
...
export default ListEmailProviderDashboard;