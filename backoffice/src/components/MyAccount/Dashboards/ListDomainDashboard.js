...
import { listDomainData, activeDomain, inactiveDomain, getDomainData } from 'Actions/MyAccount';
...
class ListDomainDashboard extends Component {
    constructor(props) {
        super(props);
        this.state = {
            viewData: '',
    ...
    getListDomain() {
        ...
        this.props.listDomainData(reqObj);
    }
    componentWillReceiveProps(nextProps) {
        ...
        } else if (Object.keys(nextProps.data).length > 0 && nextProps.data.hasOwnProperty('GetTotalDomainList') && Object.keys(nextProps.data.GetTotalDomainList).length > 0) {
            this.setState({ data: nextProps.data.GetTotalDomainList, totalCount: nextProps.data.TotalCount });
        }
    }
    ...
    render() {
        ...
        return (
            <div className="jbs-page-content">
                <WalletPageTitle title={<IntlMessages id="sidebar.listDomains" />} breadCrumbData={BreadCrumbData} drawerClose={drawerClose} closeAll={this.closeAll} />
...
export default connect(mapPropsToState, {
    listDomainData, activeDomain, inactiveDomain, getDomainData
})(ListDomainDashboard);