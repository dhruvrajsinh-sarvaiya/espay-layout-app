...
class ListOpenComplainDashboard extends Component {
    constructor(props) {
        super(props);
        this.state = {
            open: false,
    ...
    render() {
        ...
        return (
            <div className="jbs-page-content">
                <DashboardPageTitle title={<IntlMessages id="sidebar.openComplain" />} drawerClose={drawerClose} closeAll={this.closeAll} />
                {
                    loading
                        ?
