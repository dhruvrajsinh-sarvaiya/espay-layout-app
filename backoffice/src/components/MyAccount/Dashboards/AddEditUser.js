...
class AddEditUser extends Component {
    ...
    resetData() {
        ...
        //newObj['RoleId'] = '';
        newObj['GroupID'] = '';
        this.setState({ data: newObj, isAddData: false, errors: "", isEdit: false, menudetail: this.state.menudetail });
    ...
    onAddUser(event) {
        ...
        //delete this.state.data.RoleId
        //delete this.state.data.GroupID
    ...
    onEditUser(event) {
        ...
        //newObj['RoleId'] = this.state.data.RoleId;
    ...
    render() {
        ...
        const { errors, roleList, groupData } = this.state;
        const { UserName, FirstName, LastName, Email, Password, Mobile, confirmPassword, Status, RoleId, GroupID } = this.state.data;
                        ...
                        <Form className="tradefrm">
                            ...
                            {((menuDetail["9C413C0E-2AF6-837C-4099-B7A442599630"] && menuDetail["9C413C0E-2AF6-837C-4099-B7A442599630"].Visibility === "E925F86B"))//A997E102-5D05-4237-72A2-6040A2683883----edit
                                ...
                                <FormGroup className="row">
                                    ...
                                    {/* <Label for="RoleID" className="control-label col"><IntlMessages id="sidebar.assignRole" /><span className="text-danger">*</span></Label> */}
                                    {/* <div className="col-md-8">
                                        <Input type="select" name="RoleId" value={RoleId} id="RoleId" onChange={(e) => this.onChange(e)}>
                                            <IntlMessages id="sidebar.selRoleId">{(RoleId) => <option value="">{RoleId}</option>}</IntlMessages>
                                            {roleList.map((mList, index) => (
                                                <option key={index} value={mList.RoleID}>{mList.RoleName}</option>
                                            ))}
                                        </Input>
                                ...
                                <FormGroup className="row">
                                    ...
                                    <div className="col-md-8">
                                        <IntlMessages id="sidebar.entrPassword">
                                            {(placeholder) =>
                                                /* <Input type="password" name="Password" value={Password} placeholder={placeholder} id="Password" onChange={(e) => this.onChange(e)} /> */
                                    ...
                                    <div className="col-md-8">
                                        <IntlMessages id="sidebar.entrConfirmPassword">
                                            {(placeholder) =>
                                                ...
                                                <Input type="password" name="confirmPassword" value={confirmPassword} placeholder={placeholder} id="confirmPassword" onChange={(e) => this.onChange(e)} />*/
