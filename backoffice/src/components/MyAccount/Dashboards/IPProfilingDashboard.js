/* 
    ...
    File Comment : MyAccount IP Profiling Dashboard Component
*/
...
//Component for MyAccount IP Profiling Dashboard
class IPProfilingDashboard extends Component {
    constructor(props) {
        super(props);
        this.state = {
            open: false,
    ...
    componentWillMount() {
        this.props.getMenuPermissionByID('2677C50D-1201-565C-9091-78020FA829A3'); // get myaccount menu permission
    ...
    render() {
        ...
        return (
            <div className="jbs-page-content">
                <WalletPageTitle title={<IntlMessages id="sidebar.ipProfiling" />} breadCrumbData={BreadCrumbData} drawerClose={drawerClose} closeAll={this.closeAll} />
                {(this.state.menuLoading || loading) && <JbsSectionLoader />}
                <div className="row">
                    {this.checkAndGetMenuAccessDetail('83F32458-1156-8CE5-38A8-F2298B3D61A4') && //83F32458-1156-8CE5-38A8-F2298B3D61A4
                        <div className="col-md-3 col-sm-6 col-xs-12">
                            <a href="javascript:void(0)" onClick={(e) => this.showComponent('ListIPRangeDashboard', this.checkAndGetMenuAccessDetail('83F32458-1156-8CE5-38A8-F2298B3D61A4'))} className="text-dark">
                                <SimpleCard
                    ...
                    {this.checkAndGetMenuAccessDetail('8BEDCE52-9C43-99B7-6A01-BAD136DD77A3') && //8BEDCE52-9C43-99B7-6A01-BAD136DD77A3
                        <div className="col-md-3 col-sm-6 col-xs-12">
                            <a href="javascript:void(0)" onClick={(e) => this.showComponent('AllowIPRangeDashboard', this.checkAndGetMenuAccessDetail('8BEDCE52-9C43-99B7-6A01-BAD136DD77A3'))} className="text-dark">
                                <SimpleCard
                                    title={<IntlMessages id="sidebar.allowIPRange" />}
                ...
                <Drawer
                    width={componentName === 'AllowIPRangeDashboard' ? '50%' : '100%'}
                    handler={false}
                    open={open}
                    placement="right"
                    className={componentName === 'AllowIPRangeDashboard' ? "drawer1 half_drawer" : "drawer1"}
                    level=".drawer0"
                    levelMove={100}
                    height="100%"
                >
