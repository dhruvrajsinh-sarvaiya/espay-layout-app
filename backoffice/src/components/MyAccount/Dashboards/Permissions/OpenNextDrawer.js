...
class OpenNextDrawer extends Component {
    ...
    updateModuleAccessRight = (event, type, index) => {
        ...
        if (this.state.reqObj !== null) {
            ...
            if (type === 'MainMenu') {
                ...
                this.state.selectedObject['childs']['Modules'].map((item, index) => {
    ...
    //Added by salim dt:07/05/2019...
    //Update Module Access Permission API Call
    moduleChangeData = (type, value, dataObj, curType = '', index) => {
                        ...
                        <table className="table">
                            ...
                            <tbody>
                                ...
                                {selectedObject.childs
                                    &&
                                    <Fragment>
                                        {selectedObject.childs && selectedObject.childs.Modules.map((smdlList, smIndex) => {
                                                    ...
                                                    smdlList.Type === '3425D53F' && smdlList.HasChild ?
                                                        <td className="text-center">
                                                            <Checkbox color="primary"
                                                                ...
                                                                onChange={(e) => this.moduleChangeData('list_form', e.target.checked, smdlList, '6AF64827', smIndex)} /></td>
                                                        :
                                                    ...
                                                    smdlList.Type === '3425D53F' && smdlList.HasChild ?
                                                        <td className="text-center">
                                                            <Checkbox color="primary"
                                                                ...
                                                                onChange={(e) => this.moduleChangeData('list_form', e.target.checked, smdlList, '04F44CE0', smIndex)} /></td>
                                                        :
                                                        <td className="text-center"><i className="fa fa-close text-danger" /></td>
                                                }
                                                {
                                                    smdlList.Type === '3425D53F' && smdlList.HasChild ?
                                                        <td className="text-center">
                                                            <Checkbox color="primary"
                                                                ...
                                                                onChange={(e) => this.moduleChangeData('list_form', e.target.checked, smdlList, '0BB7ACAC', smIndex)}
                                                            /></td>
                                                        :
                                                        <td className="text-center"><i className="fa fa-close text-danger" /></td>
                                                }
                                                    ...
                                                    smdlList.Type === '3425D53F' && smdlList.HasChild ?
                                                        <td className="text-center">
                                                            <Checkbox color="primary"
                                                                ...
                                                                onChange={(e) => this.moduleChangeData('list_form', e.target.checked, smdlList, 'B873B896', smIndex)}
                                                            /></td>
                                                        :
                                                        <td className="text-center"><i className="fa fa-close text-danger" /></td>
                                                }
...
const mapStateToProps = ({ getMenuAccess, drawerclose }) => {
    ...
    const { loading, menuList, getListBit, updData, menuListError } = getMenuAccess;
