...
class FieldModal extends Component {
    ...
    updateModuleAccessRight = (event, type, index) => {
        ...
        reqObj.Data = [];
        let data = []
        Utility && Utility.map((value1, index) => {
        ...
        return (
            <Fragment>
                ...
                <ModalBody>
                    ...
                    {this.state.selectedData.Type === '3425D53F' &&
                        this.state.selectedData.Utility
                        && typeof this.state.selectedData.Utility !== null
                        && typeof this.state.selectedData.Utility !== undefined
                        &&
                    ...
                    {this.state.selectedData.Type === '9AAD5A4E' &&
                        this.state.selectedData.Fields
                        && typeof this.state.selectedData.Fields !== null
                        && typeof this.state.selectedData.Fields !== undefined
                        &&
                        <Fragment>
...
const mapStateToProps = ({ getMenuAccess }) => {
