...
//import component
import DisplayMoreData from './DisplayDrawer3';
                ...
                >
                    ...
                    {this.state.componentName != '' &&
                        dynamicComponent(this.state.componentName,
                            this.props, this.toggleDrawer,
                            this.closeAll, this.state.cnfgMdlData,
...
const mapStateToProps = ({ getMenuAccess, drawerclose }) => {
    ...
    const { loading, menuList, getListBit } = getMenuAccess;
