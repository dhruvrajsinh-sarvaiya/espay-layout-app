...
class EditSurvey extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (typeof nextProps.localebit != 'undefined' && nextProps.localebit != '' && nextProps.localebit == 1) {
      ...
      this.state.surveydetail.locale = locale;
      this.setState({
    ...
    if (typeof nextProps.surveydetail != 'undefined' && typeof nextProps.surveydetail.locale != 'undefined' && nextProps.surveydetail != '') {
      ...
      this.state.surveydetail.locale = newlocale;
      this.state.surveydetail.surveyId = nextProps.surveydetail._id;
      this.state.surveydetail.surveyJson = nextProps.surveydetail.json;
      this.editor.text = nextProps.surveydetail.json;
      this.state.surveydetail.isDefault = nextProps.surveydetail.isDefault;
      this.state.surveydetail.category_id = nextProps.surveydetail.category_id;
      this.state.surveydetail.status = nextProps.surveydetail.status;
  ...
  render() {
    ...
    const { err_alert, err_msg, activeIndex, language, errors, surveydetail, loading, btn_disabled } = this.state; // Added By Megha Kariya (08/02/2019) : add btn_disabled
