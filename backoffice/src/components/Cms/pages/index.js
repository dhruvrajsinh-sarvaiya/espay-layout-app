...
import { getPages, getPageById } from "Actions/Pages"; // getPageById Added by Khushbu Badheka D:29/01/2019
...
class Pages extends Component {
    ...
    componentWillMount() {
        this.props.getMenuPermissionByID('5DBD47D4-1E19-2253-9CB6-76E2226D8452');
    }
    ...
    render() {
        var menudetail = this.checkAndGetMenuAccessDetail('BE62EB84-70A5-6CC1-8277-C0913BA98BB5');
        if (!menudetail) {
        ...
        return (
            <div className="jbs-page-content">
                <DashboardPageTitle title={<IntlMessages id="sidebar.pages" />} breadCrumbData={BreadCrumbData} drawerClose={drawerClose} closeAll={this.closeAll} />
                ...
                <div className="row">
                    {(menudetail.CrudOption.indexOf('04F44CE0') !== -1) &&
                        <div className="col-md-3 col-sm-6 col-xs-12">
                            <a href="javascript:void(0)" onClick={(e) => this.showComponent('AddPage', (this.checkAndGetMenuAccessDetail('BE62EB84-70A5-6CC1-8277-C0913BA98BB5')).HasChild)} className="text-dark">
                                <AddCard
                    ...
                    {this.checkAndGetMenuAccessDetail('BE62EB84-70A5-6CC1-8277-C0913BA98BB5') &&
                        (pageslist &&
                            pageslist.map((page, key) => (   //Added date_modified into card by Jayesh 22-01-2019
                                <div className="col-md-3 col-sm-6 col-xs-12" key={key}>
                                    <a href="javascript:void(0)" onClick={(e) => this.showComponent('EditPage', (this.checkAndGetMenuAccessDetail('BE62EB84-70A5-6CC1-8277-C0913BA98BB5')).HasChild, page)} className="text-dark">
                                        <SimpleCard
                ...
                <Drawer
                    ...
                    levelMove={100}
                >
                    {this.state.componentName != '' && dynamicComponent(this.state.componentName, this.props, this.onClick, this.closeAll, this.state.pagedata, this.reload, 'BE62EB84-70A5-6CC1-8277-C0913BA98BB5')}
                </Drawer>
            </div>
        );
    }
