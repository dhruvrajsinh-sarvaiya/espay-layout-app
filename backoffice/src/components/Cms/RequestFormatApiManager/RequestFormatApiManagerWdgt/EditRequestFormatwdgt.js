...
class EditRequestformatwdgt extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (
      nextProps.userlist &&
      typeof nextProps.userlist !== "undefined" &&
  ...
  onEditUser = () => {
    ...
    /* if (RequestName === "" || RequestName == null) {
      NotificationManager.error(
        <IntlMessages id="sidebar.requestformatapi.list.lable.enter.reqname" />
      );
    } else if (ContentType === "" || ContentType == null) {
      NotificationManager.error(
        <IntlMessages id="sidebar.requestformatapi.list.lable.enter.contype" />
      );
    } else if (MethodType === "" || MethodType == null) {
      NotificationManager.error(
        <IntlMessages id="sidebar.requestformatapi.list.lable.enter.methtype" />
      );
    } else if (RequestFormat === "" || RequestFormat == null) {
      NotificationManager.error(
        <IntlMessages id="sidebar.requestformatapi.list.lable.enter.reqformat" />
      );
    } else if (Status === "" || Status == null) {
      NotificationManager.error(
        <IntlMessages id="sidebar.requestformatapi.list.lable.enter.status" />
      );
    } else { */
