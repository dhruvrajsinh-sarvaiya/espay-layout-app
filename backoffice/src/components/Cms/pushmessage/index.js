...
class MessageWdgt extends Component {
  ...
  sendMessage() {
    ...
    const { userList, selectedUser, smsText, mobileNoList } = this.state;
  ...
  render() {
    ...
    const { selectedUser, userList, error, remainChar, btn_disabled, mobileNoList } = this.state; // Added By Megha Kariya (08/02/2019) : add btn_disabled
          ...
          <JbsCollapsibleCard>
            <Form>
              ...
              {this.state.userList === '0' &&
                ...
                <FormGroup>
                  {/* code comment by devang parekh (30-3-2019) for handle multi-select <MultiSelectComponent data={data} classes={classes} selectedUser={selectedUser} handleChangeMulti={this.handleChangeMulti} /> */}
                  <Select
