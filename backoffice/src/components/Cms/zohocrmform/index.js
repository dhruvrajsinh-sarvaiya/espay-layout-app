...
class AddCrmForm extends Component {
  ...
  clearAll() {
    ...
    this.state.addNewCrmFormDetail.firstName = "";
    this.state.addNewCrmFormDetail.lastName = "";
    this.state.addNewCrmFormDetail.company = "";
    this.state.addNewCrmFormDetail.phone = "";
    this.state.addNewCrmFormDetail.description = "";

    this.setState({
        addNewCrmFormDetail : this.state.addNewCrmFormDetail
    });
    ...
    addCrmFormDetail() {
     ...
     if(isValid) {           
          ...
          // this.resetData(); // Comment By Megha Kariya (26/02/2019) : its reset so error not display on page
      }
