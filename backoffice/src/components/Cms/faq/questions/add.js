...
class AddFaqQuestions extends Component {
	...
	componentWillReceiveProps(nextProps) {
		...
		if (typeof nextProps.localebit != 'undefined' && nextProps.localebit != '' && nextProps.localebit == 1) {
			...
			this.state.addNewFaqQuestionDetail.locale = locale;
			this.setState({
				addNewFaqQuestionDetail: this.state.addNewFaqQuestionDetail
			});
		}
	...
	render() {
		...
		const { err_alert, activeIndex, language, errors, addNewFaqQuestionDetail, loading, categorylist, btn_disabled } = this.state; // Added By Megha Kariya (08/02/2019) : add btn_disabled
