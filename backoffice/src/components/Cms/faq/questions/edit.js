...
class EditFaqQuestions extends Component {
	...
	componentWillReceiveProps(nextProps) {
		...
		if (typeof nextProps.localebit != 'undefined' && nextProps.localebit != '' && nextProps.localebit == 1) {
			...
			this.state.faqquestiondetail.locale = locale;
			this.setState({
				faqquestiondetail: this.state.faqquestiondetail
			});
		}
		...
		if (typeof nextProps.faqquestiondata != 'undefined' && typeof nextProps.faqquestiondata.locale != 'undefined' && nextProps.faqquestiondata != '') {
			...
			this.state.faqquestiondetail.locale = newlocale;
			this.state.faqquestiondetail._id = nextProps.faqquestiondata._id;
			this.state.faqquestiondetail.question_id = nextProps.faqquestiondata.question_id;
			this.state.faqquestiondetail.sort_order = nextProps.faqquestiondata.sort_order;
			//Added by Meghaben 29-01-2019
			this.state.faqquestiondetail.status = nextProps.faqquestiondata.status + '';
			this.state.faqquestiondetail.category_id = nextProps.faqquestiondata.category_id != null && typeof nextProps.faqquestiondata.category_id._id != 'undefined' ? nextProps.faqquestiondata.category_id._id : this.state.faqquestiondetail.category_id;
	...
	render() {
		...
		const { err_alert, err_msg, activeIndex, language, errors, faqquestiondetail, loading, categorylist, btn_disabled } = this.state; // Added By Megha Kariya (08/02/2019) : add btn_disabled
