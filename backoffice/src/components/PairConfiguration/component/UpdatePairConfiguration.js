...
class UpdatePairConfiguration extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      addNewPairDetails: {
        ...
        sellFees: this.props.selectedData.SellFees !== "" ? this.props.selectedData.
        SellFees : 0,
        feesCurrency: "", //this.props.selectedData.FeesCurrency ? this.props.selectedData.FeesCurrency : "",
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (nextProps.selectedData && this.state.editPairConfig == false) {

      /* this.setState({
        addNewPairDetails: {
          ...this.state.addNewPairDetails,
          marketName: nextProps.selectedData.MarketName,
          baseCurrencyId: nextProps.selectedData.BaseCurrencyId,
          secondaryCurrencyId: nextProps.selectedData.SecondaryCurrencyId,
          pairId: nextProps.selectedData.Id,
          marketCurrency: nextProps.selectedData.PairName.split("_")[1],
          pairCurrency: nextProps.selectedData.PairName.split("_")[0],
          defaultRate: nextProps.selectedData.CurrentRate,
          buyMinQuantity: nextProps.selectedData.BuyMinQty,
          buyMaxQuantity: nextProps.selectedData.BuyMaxQty,
          sellMaxQuantity: nextProps.selectedData.SellMaxQty,
          currencyPrice: nextProps.selectedData.CurrencyPrice,
          volume: nextProps.selectedData.Volume,
          sellMinQuantity: nextProps.selectedData.SellMinQty,
          buyMinPrice: nextProps.selectedData.BuyMinPrice,
          buyMaxPrice: nextProps.selectedData.BuyMaxPrice,
          sellMinPrice: nextProps.selectedData.SellMinPrice,
          sellMaxPrice: nextProps.selectedData.SellMaxPrice,
          trnChargeType: nextProps.selectedData.ChargeType,
          //trnCharge: nextProps.selectedData.trnCharge,
          buyPrice: nextProps.selectedData.BuyPrice,
          sellPrice: nextProps.selectedData.SellPrice,
          buyFees: nextProps.selectedData.BuyFees,
          sellFees: nextProps.selectedData.SellFees,
          feesCurrency: "",//nextProps.selectedData.FeesCurrency,
          openOrderExpiration: nextProps.selectedData.OpenOrderExpiration,
  ...
  editPairConfigurationForm = (event) => {
    ...
    //if(this.state.addNewPairDetails !== this.state.addNewPairDetails){
    ...
    /*  else if (addNewPairDetails.currencyPrice == null) {
    ...
    /*else if (addNewPairDetails.sellPrice == null || addNewPairDetails.buyPrice == null) {
      ...
      if (addNewPairDetails.buyMinQuantity > addNewPairDetails.buyMaxQuantity) {
        ...
        if (this.state.isUpdate) {
          const addRequest = {
            // Id:0,
            //MarketName: addNewPairDetails.marketName,
            //  PairName:addNewPairDetails.marketCurrency + "_" + addNewPairDetails.pairCurrency, // 'BCH_REP',
            ...
            FeesCurrency: "INR",// addNewPairDetails.feesCurrency, // addNewPairDetails.feesCurrency ? parseFloat(addNewPairDetails.feesCurrency) :parseFloat(0),
