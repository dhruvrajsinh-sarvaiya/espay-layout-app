...
class PairConfiguration extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    // console.log(nextProps.pairConfigurationList)
  ...
  submitPairConfigurationForm() {
    // console.log("this.state.addNewPairDetails",this.state.addNewPairDetails)
    ...
    const addRequest = {
      ...
      //  Status: addNewPairDetails.status ? parseFloat(addNewPairDetails.status) :parseFloat(0),
      // StatusText: '',
  ...
  deletePairConfiguration(deleteRecordDetail) {
    // console.log(deleteRecordDetail)
    this.setState({
                  ...
                  <div className="row">
                    <div className="col-sm-4">
                      ...
                      {/* <Input
                        ...
                        name="buyMinQuantity"
                        value={addNewPairDetails.buyMinQuantity}
                        placeholder = {<IntlMessages id="trading.pairconfig.placeholder.buyminqty">
                        { (placeholder) =>
                        {placeholder}
                        }
                     </IntlMessages>}
                    ...
                    <div className="col-sm-4">
                      ...
                      {/* <Input
                        ...
                        name="buyMaxQuantity"
                        value={addNewPairDetails.buyMaxQuantity}
                        placeholder = {<IntlMessages id="trading.pairconfig.placeholder.buymaxqty">
                        { (placeholder) =>
                        {placeholder}
                        }
                     </IntlMessages>}
                  ...
                  <div className="row">
                    <div className="col-sm-4">
                      ...
                      {/* <Input
                        ...
                        name="sellMinQuantity"
                        value={addNewPairDetails.sellMinQuantity}
                        placeholder = {<IntlMessages id="trading.pairconfig.placeholder.sellminqty">
                        { (placeholder) =>
                        {placeholder}
                        }
                     </IntlMessages>}
                    ...
                    <div className="col-sm-4">
                      ...
                      {/* <Input
                        ...
                        name="sellMaxQuantity"
                        value={addNewPairDetails.sellMaxQuantity}
                        placeholder = {<IntlMessages id="trading.pairconfig.placeholder.sellmaxqty">
                        { (placeholder) =>
                        {placeholder}
                        }
                     </IntlMessages>}
