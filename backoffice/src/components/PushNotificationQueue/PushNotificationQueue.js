...
class PushNotificationQueue extends Component {  
  ...
  onResend = (item) => {
      ...
      this.props.displayResendPushNotification(this.state.item);
...
// map state to props
const mapStateToProps = ({ displayPushNotification }) => {
  
  var response = {
    PushNotificationList: displayPushNotification.displayPushNotificationData,
    loading: displayPushNotification.loading,
    totalCount : displayPushNotification.TotalCount,
    totalPage : displayPushNotification.TotalPage,
    ReturnMsg : displayPushNotification.ReturnMsg,
    ReturnCode : displayPushNotification.ReturnCode,
  };
  return response;
};
