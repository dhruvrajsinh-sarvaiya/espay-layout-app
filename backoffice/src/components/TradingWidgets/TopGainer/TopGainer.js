        ...
        return (
            <Card className="mb-10">
                        ...
                        <tbody>
                            {topGainers.length !== 0 && topGainers.map((topGainer, key) =>
                                <tr key={key}>
                                    ...
                                    {/* <td>{parseFloat(topGainer.Volume).toFixed(8)}</td>
                                        <td>{parseFloat(topGainer.ChangeValue).toFixed(8)}</td> */}
                ...
                <div className="mt-5 topgainerloser" style={{ position: 'absolute' }}>
                    {/* 9270D368-503F-528B-6DA9-B07B846F18AF && margin_GUID 18EF8BDA-7061-9443-64BE-D20954DB59B1 */}
