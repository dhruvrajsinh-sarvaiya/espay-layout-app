...
class TradingLedger extends Component {
	...
	render() {
		...
		//const columns = ["TrnNo","Pair", "Type", "OrderType","Pre-Bal","Post-Bal","DateTime"];
		const columns = [
			{
...
const mapStateToProps = ({ tradingledger, tradeRecon }) => {
	const { tradingledgerList, loading, currencyList } = tradingledger;
