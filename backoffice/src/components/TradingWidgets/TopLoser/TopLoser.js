    ...
    render() {
        ...
        return (
            <Card className="mb-10">
                    ...
                    <Table responsive>
                        <thead>
                            <tr>
                                ...
                                {/* <th> <IntlMessages id="trade.summary.trade.volume" />      </th> */}
                                {/* <th><IntlMessages id="widgets.change" />  </th> */}
                        ...
                        <tbody>
                            {topLosers.length !== 0 && topLosers.map((topLoser, key) =>
                                <tr key={key}>
                                    ...
                                    {/* <td>{parseFloat(topLoser.Volume).toFixed(8)}</td>
                                    <td>{parseFloat(topLoser.ChangeValue).toFixed(8)}</td> */}
              ...
              data={this.state.topLoserList.length !== 0 && this.state.topLoserList.map((topLoser, key) => {
                return [                                    
                  topLoser.PairName,
                  topLoser.LTP,
                  topLoser.Volume,                  
            ...
            />           */}
                ...
                <div className="mt-5 topgainerloser" style={{ position: 'relative' }}>
                    {/* 10BCFD68-34DD-1B93-4B2D-7F32E4C3A00B && margin_GUID 8068ACAA-45C4-035B-47ED-F8EB4B9A4E3B */}
