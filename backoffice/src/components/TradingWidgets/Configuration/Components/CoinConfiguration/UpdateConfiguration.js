...
class UpdateCoin extends Component {
    ...
    constructor(props) {
        ...
        // var fieldList = {};
        // if (props.menuDetail.Fields && props.menuDetail.Fields.length) {
        //     props.menuDetail.Fields.forEach(function (item) {
    ...
    componentWillReceiveProps(nextprops) {
        //added by parth andhariya
        // if (nextprops.CurrencyLogo && nextprops.CurrencyLogo.ReturnCode === 0 && this.state.updateData) {
