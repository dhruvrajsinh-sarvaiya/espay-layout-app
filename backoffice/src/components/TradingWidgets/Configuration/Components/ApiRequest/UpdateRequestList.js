...
class UpdateRequestList extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            //apiKey: this.props.selectedData.APIName ? this.props.selectedData.APIName : "",
            apiRequestBody: this.props.selectedData.APIRequestBody ? this.props.selectedData.APIRequestBody : "",
            appTypeList: [],
            //apiSecret: this.props.selectedData.APIName ? this.props.selectedData.APIName : "",
    ...
    componentWillReceiveProps(nextprops) {
        ...
        if (nextprops.selectedData) {
            this.setState({
                ...
                //apiKey: nextprops.selectedData.APIName ? nextprops.selectedData.APIName : "",
                apiRequestBody: nextprops.selectedData.APIRequestBody ? nextprops.selectedData.APIRequestBody : "",
                appTypeList: [],
                //apiSecret: nextprops.selectedData.APIName ? nextprops.selectedData.APIName : "",
    ...
    // call api for get app type list
    // componentDidMount() {
    //     this.props.getAppTypeList({})
    //     this.props.getThirdPartyApiResponse({})
    // }
