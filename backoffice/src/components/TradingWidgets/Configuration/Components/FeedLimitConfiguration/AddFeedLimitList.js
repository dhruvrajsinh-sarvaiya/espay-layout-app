...
class AddFeedLimitList extends Component {
    ...
    addFeedLimitData = () => {
        ...
        } else if ((minSize !== "" || minSize !== null) && (maxSize !== "" || maxSize !== null) && parseFloat(minSize) > parseFloat(maxSize)) {

            NotificationManager.error(<IntlMessages id="exchangefeed.title.select.minSize" />);
        } else if ((minRecordCount !== "" || minRecordCount !== null) && (maxRecordCount !== "" || maxRecordCount !== null) && parseFloat(minRecordCount) > parseFloat(maxRecordCount)) {

            NotificationManager.error(<IntlMessages id="exchangefeed.title.select.minCount" />);
        } else if ((minLimit !== "" || minLimit !== null) && (maxLimit !== "" || maxLimit !== null) && parseFloat(minLimit) > parseFloat(maxLimit)) {
