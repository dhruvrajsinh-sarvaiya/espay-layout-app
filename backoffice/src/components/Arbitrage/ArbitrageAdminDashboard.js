...
//wallet widgets...
import { SimpleCard, WalletFeedsWidget } from 'Components/Wallet/DashboardWidgets';
//Action methods..
...
import { CountCard } from 'Components/MyAccount/Dashboards/Widgets';
...
//import ArbitrageDashboardChart from './ArbitrageDashboardChart';
...
class ArbitrageAdminDashboard extends Component {
    ...
    componentWillReceiveProps(nextProps) {
        console.log("nextprops", nextProps.userTradeCounts);
    ...
    render() {
        ...
        //console.log("uswrtrade", userTradeCount);
...
const mapStateToProps = ({ totalCount, drawerclose, authTokenRdcer, }) => {
    ...
    console.log("mapstatetoprops", userTradeCounts);
