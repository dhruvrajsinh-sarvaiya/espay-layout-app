...
const mapStateToProps = ({ ProviderLedger, authTokenRdcer, ArbitrageCurrencyConfiguration }) => {
    const { loading, ProviderLedgerList, totalCount, ledgerResponse,ProviderWallets } = ProviderLedger;
