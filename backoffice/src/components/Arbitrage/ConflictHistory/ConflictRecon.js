...
class ConflictRecon extends Component {
    ...
    componentWillReceiveProps(nextProps) {
        ...
        //handle add response
        console.log("nextProps.ConflictRecons", nextProps.ConflictRecons)
        if (nextProps.ConflictRecons !== "") {
            if (nextProps.ConflictRecons.ReturnCode === 0 && this.state.responseFlag) {
                ...
                console.log("ConflictRecons no response aviyo ")
    ...
    handleCancel = () => {
        console.log("bandh thay jaa chal chal ")
        this.props.drawerClose();
        this.setState({
            ProviderBalance: "",
            remarks: "",
                ...
                <form>
                    ...
                    <div className="offset-md-4 col-md-8 offset-sm-3 col-sm-9 col-xs-12">
                        <div className="btn_area">
                            ...
                            // disabled={(this.props.loading && this.state.ProviderBalance === "" && this.state.remarks === "") ? false : true}
                            >
...
//map method
const mapStateToProps = ({ authTokenRdcer, ConflictHistory, dipositReportReducer }) => {
    const {
        menuLoading,
        menu_rights
    } = authTokenRdcer;
    const { loading, ConflictRecons } = ConflictHistory;
