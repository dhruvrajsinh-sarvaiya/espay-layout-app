...
import ArbitrageCurrencyConfigurationForm from "./ArbitrageCurrencyConfigurationForm";
...
//components name
const components = {
    ArbitrageCurrencyConfigurationForm: ArbitrageCurrencyConfigurationForm,
};
...
class ArbitrageCurrencyConfiguration extends Component {
    ...
    onEditChargeConfig(item, menuDetail) {
        ...
        if (menuDetail) {
            this.setState({
                componentName: "ArbitrageCurrencyConfigurationForm",
                open: true,
                Form: true,
                // menuDetail:menuDetail
            });
                ...
                if (menuPermissionDetail.CrudOption.indexOf('04F44CE0') !== -1) { // check add curd operation
                    return (
                        <Button
                            ...
                            // style={{ float: "right" }}
                            onClick={() => this.showComponent("ArbitrageCurrencyConfigurationForm", (this.checkAndGetMenuAccessDetail('FAA37144-6DFF-7514-4273-A6C349C270DE').HasChild)  //24DC250B-A773-3FF0-5B86-8381F6906D59
                            )}
                        >
...
)(injectIntl(ArbitrageCurrencyConfiguration));
