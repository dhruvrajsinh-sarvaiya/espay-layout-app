...
class MasterArbitrageFeeConfiguration extends Component {
    ...
    onEditFeeConfig(ListFeeConfiguration, menuDetail) {
...
//map method
const mapStateToProps = ({ FeeConfigurationReducer, drawerclose, authTokenRdcer, ArbitrageCurrencyConfiguration }) => {
