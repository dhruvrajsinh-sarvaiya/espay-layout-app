...
// api for address generation by devang parekh
const AsyncApiConfAddGenComponent = Loadable({
    loader: () => import("Routes/apiconf-add-gen"),
    loading: () => <JbsPageLoader />
});
...
// MyAccount dashboard - added by salim deraiya
/* const AsyncMyAccountDashboardComponent = Loadable({
    loader: () => import("Routes/dashboard/my-account1"),
    loading: () => <JbsPageLoader />
}); */
...
export {
    ...
    // AsyncWalletListComponent,
    // AsyncWalletViewComponent,
