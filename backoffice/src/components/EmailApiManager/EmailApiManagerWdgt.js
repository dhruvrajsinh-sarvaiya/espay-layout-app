...
import EditEmailApi from './EmailApiManagerWdgt/edit';
import AddEmailAPI from './EmailApiManagerWdgt/add';
import ViewEmailAPIDetail from './EmailApiManagerWdgt/view';
//Columns Object
const columns = [
    {
        name: "APID",
            ...
            <div className="EmailAPIManagerList">
                <div className="m-20 page-title d-flex justify-content-between align-items-center">
                    <div className="page-title-wrap">
                        <h2><IntlMessages id={this.state.type === 2 ? "emailAPIManager.PageTitle" : "emailAPIManager.PageTitle"}/></h2>
                    </div>
                    <div className="page-title-wrap">
