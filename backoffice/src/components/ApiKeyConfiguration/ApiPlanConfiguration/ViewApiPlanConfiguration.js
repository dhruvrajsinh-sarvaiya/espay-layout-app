...
class ViewApiPlanConfigList extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            isAPICall: false,
            type: props.type,
            HtmlBODY: props.selectedData.PlanDesc ? props.selectedData.PlanDesc : "",
            __HTMLContent: "",
    ...
    drawerClose = () => {
        ...
        // if (this.props.selectedData.ReadOnlyAPI) {
        //     readOnly = Object.entries(this.props.selectedData.ReadOnlyAPI).map(([key, value]) => ({ key, value }));
        // }

        // if (this.props.selectedData.FullAccessAPI) {
        //     fullAccess = Object.entries(this.props.selectedData.FullAccessAPI).map(([key, value]) => ({ key, value }));
        // }

        // this.setState({
        //     loading: false,
        //     ApiPlanList: this.props.selectedData ? this.props.selectedData : {},
        //     validityType: this.props.selectedData.PlanValidityType === 1 ?
        //         <IntlMessages id="sidebar.day" />
        //         : this.props.selectedData.PlanValidityType === 2 ?
        //             <IntlMessages id="sidebar.month" /> :
        //             this.props.selectedData.PlanValidityType === 3 ?
        //                 <IntlMessages id="sidebar.year" /> : "",
        //     open: false,
        //     ReadOnlyAPI: readOnly,
        //     fullAccessApi: fullAccess,
        ...
        //     HtmlBODY: this.props.selectedData.PlanDesc ? this.props.selectedData.PlanDesc : "",
        //     __HTMLContent: "",
        //     notificationFlag: true,
        //     menudetail: [],
        // })
    ...
    render() {
        ...
        //const data = this.state.ApiPlanList ? this.state.ApiPlanList
        return (
            <div>
                <JbsCollapsibleCard>
                    <div className="m-20 page-title d-flex justify-content-between align-items-center">
                        <div className="page-title-wrap">
                            {/* <h2><IntlMessages id="sidebar.APIPlanConfiguration.view" /></h2> */}
                        ...
                        <Row>
                                ...
                                <JbsCollapsibleCard>
                                    ...
                                    <Row>
                                        ...
                                        <Label for="priority" sm={6} xs={6}>
                                            {this.state.ApiPlanList.Whitelistendpoints ? this.state.ApiPlanList.Whitelistendpoints : 0}
                                        </Label>

                                    </Row>

                                    {typeof this.state.ApiPlanList.CreatedDate !== 'undefined' ?
                                        <Row>
                                            ...
                                            <Label for="priority" sm={6} xs={6}>
                                                {this.state.ApiPlanList ? this.state.ApiPlanList.CreatedDate.replace('T', ' ').split('.')[0] : ""}
                                            </Label>
                                    ...
                                    <Row>
                                        ...
                                        <Label for="status" sm={6} xs={6} className={this.state.ApiPlanList.Status === 1 ? "text-success" : "text-danger"}>
                                            {this.state.ApiPlanList.Status === 1 ? <IntlMessages id="sidebar.active" /> : <IntlMessages id="sidebar.inactive" />}
                                        </Label>
                                    </Row>
                            ...
                            <Col md={6}>
                                ...
                                <JbsCollapsibleCard>
                                    ...
                                    {this.state.ApiPlanList.CreatedDate ?
                                        <Row>
                                            <Label for="date" sm={6} xs={6}>
                                    ...
                                    <Row>
                                        ...
                                        <Label for="planrecursive" sm={6} xs={6}>
                                            {this.state.ApiPlanList.IsPlanRecursive === 1 ? <IntlMessages id="button.yes" /> : <IntlMessages id="sidebar.no" />}
                                        </Label>
