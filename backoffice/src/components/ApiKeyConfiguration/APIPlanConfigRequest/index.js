...
class APIPlanConfiguration extends Component {
    ...
    componentWillReceiveProps(nextProps) {
        if (nextProps.APIPlanRequestData.ReturnCode === 0 && typeof nextProps.APIPlanRequestData !== "undefined") {
            this.setState({
        ...
        if (nextProps.FrequentUseData.ReturnCode === 0 && typeof nextProps.FrequentUseData !== "undefined") {
            this.setState({
                FrequentUse: nextProps.FrequentUseData.Response
            })
        }
        if (nextProps.MostActiveIpAddressData.ReturnCode === 0 && typeof nextProps.MostActiveIpAddressData !== "undefined") {
            this.setState({
