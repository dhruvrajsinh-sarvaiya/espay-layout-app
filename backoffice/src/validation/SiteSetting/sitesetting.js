...
module.exports = function validateSiteSettingPageInput(data,lang) {
  ...
  else if (typeof data.seo == 'undefined')
  {
    ...
    // if(validator.isEmpty(data.general.sitename)) {
    //   errors.sitename = 'sitesetting.form.error.sitename';
    // }
    // if(validator.isEmpty(data.seo.meta_title)) {
    //   errors.metatitle = 'sitesetting.form.error.metatitle';
    // }
    // if(validator.isEmpty(data.general.copyrights)) {
    //   errors.copyrights = 'sitesetting.form.error.copyrights';
    // }
