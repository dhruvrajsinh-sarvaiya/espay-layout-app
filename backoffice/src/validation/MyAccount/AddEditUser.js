...
module.exports = function validateUser(data) {
    ...
    //check FirstName...    
    if (data.hasOwnProperty('FirstName') && validator.isEmpty(data.FirstName + '')) {
    ...
    if (data.hasOwnProperty('Username') && validator.isEmpty(data.username + '')) {
        ...
        if (isScriptTag(data.Username)) {
            ...
            errors.UserName = "my_account.err.fieldAlphaNum";
    ...
    //Check LastName...
    if (data.hasOwnProperty('LastName') && validator.isEmpty(data.LastName + '')) {
