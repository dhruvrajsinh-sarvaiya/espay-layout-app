...
module.exports = function validateNewsInput(data) {
  ...
  Object.keys(data.locale).forEach((lg, index) => {
    ...
    else if((data.locale[lg].title) && typeof (data.locale[lg].title) !== 'undefined' && (data.locale[lg].title) !== "" && data.locale[lg].title.length > 200) { // Added By Megha Kariya (14/02/2019)
