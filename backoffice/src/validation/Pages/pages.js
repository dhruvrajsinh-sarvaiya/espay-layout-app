...
module.exports = function validateCmsPageInput(data) {
  let errors = {};
  // console.log("edata",Object.keys(data.locale));
  // console.log("edata",Object.keys(data.locale).length);
  ...
  Object.keys(data.locale).forEach((lg, index) => {
    ...
    else if((data.locale[lg].title) && typeof (data.locale[lg].title) !== 'undefined' && (data.locale[lg].title) !== "" && data.locale[lg].title.length > 30) {  // Added By Megha Kariya (14/02/2019)
    ...
    console.log("data.locale[lg].content",data)

console.log("errors[lg].content",errors[lg].content)
    ...
    else if((data.locale[lg].meta_title) && typeof (data.locale[lg].meta_title) !== 'undefined' && (data.locale[lg].meta_title) !== "" && data.locale[lg].meta_title.length > 60) {  // Added By Megha Kariya (14/02/2019)
      errors[lg].metatitle = 'cmspage.pageform.error.metatitleLength';
      localeerror=true;
    }
     // Added By Megha Kariya (14/02/2019)
    if((data.locale[lg].meta_description) && typeof (data.locale[lg].meta_description) !== 'undefined' && (data.locale[lg].meta_description) !== "" && data.locale[lg].meta_description.length > 160) {
